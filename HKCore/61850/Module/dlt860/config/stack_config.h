...
#define DEBUG_SOCKET 1  //zhouhj 20220531  用于调试
#define DEBUG_COTP 1   //zhouhj 20220531  用于调试
...
#define CONFIG_MMS_MAXIMUM_APDU_SIZE 65004
#define CONFIG_MMS_MAXIMUM_ASDU_SIZE 65000
...
#define CONFIG_DLT860_CONTROL_SERVICE 1
...
#define CONFIG_DLT860_REPORT_SERVICE 1
...
#define CONFIG_REPORTING_DEFAULT_REPORT_BUFFER_SIZE 100

/* include support for setting groups */
#define CONFIG_DLT860_SETTING_GROUPS 1

/* default reservation time of a setting group control block in s */
#define CONFIG_DLT860_SG_RESVTMS 300

/* include support for IEC 61850 log services */
#define CONFIG_DLT860_LOG_SERVICE 1

/* allow user to control read access by callback */
#define CONFIG_DLT860_SUPPORT_USER_READ_ACCESS_CONTROL 1
