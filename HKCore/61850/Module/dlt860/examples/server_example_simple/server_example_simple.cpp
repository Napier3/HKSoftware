...
int main(int argc, char** argv) {
    ...
    GspMmsValue *t;
    while (running) {
        val = GspMmsValue_newBoolean(flag);
        try
        {

            value = GspMmsValue_new();
            value->present = Data_PR_structure;
            q = GspMmsValue_new();
            q->present = Data_PR_bit_string;
            GspMmsValue_setBitStringFromInteger(q, 0);
            q->present = Data_PR_quality;
            t = GspMmsValue_newUtcTimeByMsTime(GSP_Hal_getTimeInMs());
            ASN_SEQUENCE_ADD(&value->choice.structure.list, val);
            ASN_SEQUENCE_ADD(&value->choice.structure.list, q);
            ASN_SEQUENCE_ADD(&value->choice.structure.list, t);
            //    GspIedServer_updateReferValue(iedServer, "RMV2201ALD0/SCPU1.Alm", "ST", value);
            //    GspIedServer_updateReferValue(iedServer, "RMV2201ARCD6/RDRE1.RcdTrg", "ST", value);
            //    GspIedServer_updateReferValue(iedServer, "RMV2201ARCD5/RDRE1.RcdTrg", "ST", value);
            //    GspIedServer_updateReferValue(iedServer, "RMV2201ARCD4/RDRE1.RcdTrg", "ST", value);
            //    GspIedServer_updateReferValue(iedServer, "RMV2201ARCD3/RDRE1.RcdTrg", "ST", value);
            //    GspIedServer_updateReferValue(iedServer, "RMV2201ARCD2/RDRE1.RcdTrg", "ST", value);
            //    GspIedServer_updateReferValue(iedServer, "RMV2201ARCD1/RDRE1.RcdTrg", "ST", value);
            //    GspIedServer_updateReferValue(iedServer, "RMV2201ARCD0/RDRE1.RcdMade", "ST", value);
        }
