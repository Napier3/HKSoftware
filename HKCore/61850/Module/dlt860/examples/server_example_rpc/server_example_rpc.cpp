...
int main(int argc, char** argv) {
    ...
    rpcInfo.timeout = 10;
    rpcInfo.version = 1;
    rpcInfo.func = [](GspMmsValue *request, string &nextCallId) -> GspMmsValue * {
        auto value = (GspMmsValue *)calloc(1, sizeof(GspMmsValue));
        value->present = Data_PR_octet_string;
        OCTET_STRING_fromString(&value->choice.octet_string, "hello world");
        return value;
    };
    rpcInfo.requestDefine.present = DataDefinition_PR_octet_string;
    rpcInfo.requestDefine.choice.octet_string = 255;
    rpcInfo.responseDefine.present = DataDefinition_PR_octet_string;
    rpcInfo.responseDefine.choice.octet_string = 255;

    GspIedServer_addRpcFunc("hello", "world", &rpcInfo);
