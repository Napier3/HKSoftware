...
void CXScdDrawViewBase::Draw(CDC *pDC, double fZoomRatio,const CPoint &ptOffset, DWORD dwDrawFlag)
{
	CXDrawElements::Draw(pDC, fZoomRatio, ptOffset, dwDrawFlag);
	m_oScdDrawLines.Draw(pDC, fZoomRatio, ptOffset, dwDrawFlag);
}
...
void CXScdDrawViewBase::DrawActiveElement(CDC *pDC, double fZoomRatio,const CPoint &ptOffset)
{
	...
	m_pActiveElement->Draw(pDC, fZoomRatio, ptOffset, 0xFFFFFFFF);
}
