...
#define SMV_RATENAME_STR_UABCZ   (_T("Vabcz"))									//dingxy 20250122 增加用于英文系统下
#define SMV_RATENAME_STR_IABC    (_T("Iabc"))
#define SMV_RATENAME_STR_UABCZ2  (_T("V2-abcz"))
#define SMV_RATENAME_STR_IABC2   (_T("I2-abc"))
#define SMV_RATENAME_STR_UABCZ3  (_T("V3-abcz"))
#define SMV_RATENAME_STR_IABC3   (_T("I3-abc"))
#define SMV_RATENAME_STR_UABCZ4  (_T("V4-abcz"))
#define SMV_RATENAME_STR_IABC4   (_T("I4-abc"))
#define SMV_RATENAME_STR_UABCZ5  (_T("V5-abcz"))
#define SMV_RATENAME_STR_IABC5   (_T("I5-abc"))
#define SMV_RATENAME_STR_UABCZ6  (_T("V6-abcz"))
#define SMV_RATENAME_STR_IABC6   (_T("I6-abc"))
