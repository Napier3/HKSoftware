...
void CNameSortGroup::AddToTail(CNameSortGroup *pGroup)
{
...
void CNameSortGroup::AddToTail(CNameSortObject *pData)
{
	...
	{
		AddToTail((CNameSortGroup*)pData);
	}
}	
...
CNameSortMngr::CNameSortMngr(CDrawBaseList *pDrawVariables, const CRect &rcClip,UINT nType)
{
