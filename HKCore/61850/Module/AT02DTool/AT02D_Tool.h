...
//	BOOL ExportDeviceModel(CIecCfgFile *pIecCfgFile,const CString &strAT02D_CfgPath,const CString &strSaveFilePath ,BOOL bUseHarm);
	...
	BOOL GenDeviceModel(CIecCfgDevice *pIecCfgDevice, CDvmLogicDevice *pDvmLogicDevice, BOOL bUseHarm,BOOL bhasMUTestParas = FALSE);
	BOOL GenDeviceModel(CIecCfgDatasMngr *pCfgDatasMngr, CDvmLogicDevice *pDvmLogicDevice, BOOL bUseHarm,BOOL bhasMUTestParas = FALSE);
	BOOL GenDeviceModel_BySmvInGin(CIecCfgDatasMngr *pCfgDatasMngr, CDvmLogicDevice *pDvmLogicDevice, BOOL bUseHarm,BOOL bhasMUTestParas);
...
BOOL iec_GenDeviceModel_BySmvInGin(CIecCfgDatasMngr *pCfgDatasMngr, CDvmLogicDevice *pDvmLogicDevice, BOOL bUseHarm,BOOL bhasMUTestParas);//20220811 zhouhj  根据Iec配置中的SMV接收和GOOSE接收初始化逻辑设备
