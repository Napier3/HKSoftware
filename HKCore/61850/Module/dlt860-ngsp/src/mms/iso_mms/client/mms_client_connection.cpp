...
GspLinkedList GspMmsConnection_getBRCBValues(GspMmsConnection self,
    ...
    return mmsClient_getDataWorkflow(self, mmsError, brcbReference, GSP_MMS_SC_GetBRCBValues, GSP_ACSIClass_reserved, GspFunctionalConstraint::DLT860_FC_NONE, NOTHING);
}
...
GspLinkedList GspMmsConnection_getURCBValues(GspMmsConnection self,
    ...
    return mmsClient_getDataWorkflow(self,
                                     ...
                                     GspFunctionalConstraint::DLT860_FC_NONE,
                                     NOTHING);
}
