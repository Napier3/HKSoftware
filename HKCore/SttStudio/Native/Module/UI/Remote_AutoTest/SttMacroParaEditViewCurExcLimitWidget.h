#ifndef QSttMacroParaEditViewCurExcLimitWidget_H
#define QSttMacroParaEditViewCurExcLimitWidget_H
...
class QSttMacroParaEditViewCurExcLimitWidget: public CSttMacroParaEditViewOriginal
{
	Q_OBJECT

public:
	QSttMacroParaEditViewCurExcLimitWidget(QWidget *parent = 0);
	~QSttMacroParaEditViewCurExcLimitWidget();


	virtual char* GetMacroID(){ return STT_ORG_MACRO_Remote_CurExcLimitTest; }
	void InitUI();
