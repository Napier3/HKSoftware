#ifndef STTMACROPARAEDITVIEWSEQUENCEMANU_H
#define STTMACROPARAEDITVIEWSEQUENCEMANU_H
...
class QSttMacroParaEditViewSequenceManu : public CSttMacroParaEditViewOriginal
{
    Q_OBJECT

public:
	QSequenceManualWidget *m_pSequenceManualWidget;
	QManualView_IV m_oIV;

	tmt_SequenceManuTest m_oManualTest;
...
public:
    explicit QSttMacroParaEditViewSequenceManu(QWidget *parent = 0);
    virtual ~QSttMacroParaEditViewSequenceManu();
...
public:
	...
	virtual char* GetMacroID(){ return STT_ORG_MACRO_SequenceManuTest; }
...
extern QSttMacroParaEditViewSequenceManu* g_pSequenceManuTest;

#endif // STTMACROPARAEDITVIEWSEQUENCEMANU_H
