#ifndef SEQUENCEMANUALWIDGET_H
#define SEQUENCEMANUALWIDGET_H
...
class QSequenceManualWidget : public QWidget
{
	Q_OBJECT

public:
    QSequenceManualWidget(QWidget *pParent);
    virtual ~QSequenceManualWidget();
	void InitUI();
	void InitConnect();
	...
	QSttTabWidget *m_pSequenceManuTab;
	...
	QWidget *m_pFirstRowWidget;
	QWidget *m_pSecondRowWidget;
	QWidget *m_pThirdRowWidget;
	QHBoxLayout* m_pFirstRowLayout;
	QHBoxLayout* m_pSecondRowLayout;
	QHBoxLayout* m_pThirdRowLayout;
...
public:
	...
	tmt_SequenceManuParas* m_pManualParas;
...
public:
	void SetData(CSttTestResourceBase *pSttTestResource,tmt_SequenceManuParas* pManualParas,CEventResult* pEvent);
	void UpdateData();
	...
	void InitGradientVar(Sequence_type vartype);
