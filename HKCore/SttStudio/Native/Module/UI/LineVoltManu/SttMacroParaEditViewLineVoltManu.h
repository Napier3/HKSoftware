#ifndef STTMACROPARAEDITVIEWLINEVOLTMANU_H
#define STTMACROPARAEDITVIEWLINEVOLTMANU_H
...
class QSttMacroParaEditViewLineVoltManu : public CSttMacroParaEditViewOriginal
{
    Q_OBJECT

public:
	QLineVoltManualWidget *m_pLinevoltManualWidget;
	QManualView_IV m_oIV;

	tmt_LinevoltManuTest m_oManualTest;
...
public:
    explicit QSttMacroParaEditViewLineVoltManu(QWidget *parent = 0);
    virtual ~QSttMacroParaEditViewLineVoltManu();
...
public:
	...
	virtual char* GetMacroID(){ return STT_ORG_MACRO_LineVolManuTest; }
...
extern QSttMacroParaEditViewLineVoltManu* g_pLinevoltManuTest;

#endif // STTMACROPARAEDITVIEWLINEVOLTMANU_H
