#ifndef QPowerManualGrid_H
#define QPowerManualGrid_H

#include "../QSttInfWidgetBase.h"
#include "PowerManualGridImp.h"


class QPowerManualGrid : public QSttInfWidgetBase
{
	Q_OBJECT

public:
	QPowerManualGrid(QWidget *parent = 0);
	~QPowerManualGrid();
...
public:
	QPowerManualGridImp *m_pParaSetImp;
...
protected:
	...
	void SetBasicTestParaSetImp(QPowerManualGridImp* pParaSetImp);
	QPowerManualGridImp* GetBasicTestParaSetImp() { return m_pParaSetImp; }
