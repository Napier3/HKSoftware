...
// 	pCbbError6->setCurrentIndex(pParas->m_nXValue_ErrorLogic);
	...
	SetOrGetErrorType(pCbbError7, pParas->m_nAngleActVal_ErrorLogic, TRUE);

	QComboBox *pCbbError8 = AbsErrorType();
	//pCbbError8->setCurrentIndex(pParas->m_nRetCoef_ErrorLogic);
	SetOrGetErrorType(pCbbError8, pParas->m_nRetCoef_ErrorLogic, TRUE);
	...
	((QSettingItem*)item(0, 3))->setText(QString::number(pParas->m_fTimeValue_RelErr));//UpdateStructText(CVariantDataAddress(&pParas->m_fTimeValue_RelErr));
	((QSettingItem*)item(1, 3))->setText(QString::number(pParas->m_fUActVal_RelErr));//UpdateStructText(CVariantDataAddress(&pParas->m_fUActVal_RelErr));
	((QSettingItem*)item(2, 3))->setText(QString::number(pParas->m_fIActVal_RelErr));//UpdateStructText(CVariantDataAddress(&pParas->m_fIActVal_RelErr));
	((QSettingItem*)item(3, 3))->setText(QString::number(pParas->m_fImpValue_RelErr));//UpdateStructText(CVariantDataAddress(&pParas->m_fImpValue_RelErr));
	((QSettingItem*)item(4, 3))->setText(QString::number(pParas->m_fRValue_RelErr));//UpdateStructText(CVariantDataAddress(&pParas->m_fRValue_RelErr));
	((QSettingItem*)item(5, 3))->setText(QString::number(pParas->m_fXValue_RelErr));//UpdateStructText(CVariantDataAddress(&pParas->m_fXValue_RelErr));
	((QSettingItem*)item(6, 3))->setText(QString::number(pParas->m_fAngleActVal_RelErr));//UpdateStructText(CVariantDataAddress(&pParas->m_fAngleActVal_RelErr));
	((QSettingItem*)item(7, 3))->setText(QString::number(pParas->m_fRetCoef_RelErr));//UpdateStructText(CVariantDataAddress(&pParas->m_fRetCoef_RelErr));
	...
	((QSettingItem*)item(0, 4))->setText(QString::number(pParas->m_fTimeValue_AbsErr));//UpdateStructText(CVariantDataAddress(&pParas->m_fTimeValue_AbsErr));
	((QSettingItem*)item(1, 4))->setText(QString::number(pParas->m_fUActVal_AbsErr));//UpdateStructText(CVariantDataAddress(&pParas->m_fUActVal_AbsErr));
	((QSettingItem*)item(2, 4))->setText(QString::number(pParas->m_fIActVal_AbsErr));//UpdateStructText(CVariantDataAddress(&pParas->m_fIActVal_AbsErr));
	((QSettingItem*)item(3, 4))->setText(QString::number(pParas->m_fImpValue_AbsErr));//UpdateStructText(CVariantDataAddress(&pParas->m_fImpValue_AbsErr));
	((QSettingItem*)item(4, 4))->setText(QString::number(pParas->m_fRValue_AbsErr));//UpdateStructText(CVariantDataAddress(&pParas->m_fRValue_AbsErr));
	((QSettingItem*)item(5, 4))->setText(QString::number(pParas->m_fXValue_AbsErr));//UpdateStructText(CVariantDataAddress(&pParas->m_fXValue_AbsErr));
	((QSettingItem*)item(6, 4))->setText(QString::number(pParas->m_fAngleActVal_AbsErr));//UpdateStructText(CVariantDataAddress(&pParas->m_fAngleActVal_AbsErr));
	((QSettingItem*)item(7, 4))->setText(QString::number(pParas->m_fRetCoef_AbsErr));//UpdateStructText(CVariantDataAddress(&pParas->m_fRetCoef_AbsErr));
	...
	((QSettingItem*)item(0, 1))->setText(QString::number(pParas->m_fTimeSet));//UpdateStructText(CVariantDataAddress(&pParas->m_fTimeSet));
	((QSettingItem*)item(1, 1))->setText(QString::number(pParas->m_fUSet));//UpdateStructText(CVariantDataAddress(&pParas->m_fUSet));
	((QSettingItem*)item(2, 1))->setText(QString::number(pParas->m_fISet));//UpdateStructText(CVariantDataAddress(&pParas->m_fISet));
	((QSettingItem*)item(3, 1))->setText(QString::number(pParas->m_fImpSet));//UpdateStructText(CVariantDataAddress(&pParas->m_fImpSet));
	((QSettingItem*)item(4, 1))->setText(QString::number(pParas->m_fRSet));//UpdateStructText(CVariantDataAddress(&pParas->m_fRSet));
	((QSettingItem*)item(5, 1))->setText(QString::number(pParas->m_fXSet));//UpdateStructText(CVariantDataAddress(&pParas->m_fXSet));
	((QSettingItem*)item(6, 1))->setText(QString::number(pParas->m_fAngleSet));//UpdateStructText(CVariantDataAddress(&pParas->m_fAngleSet));
	((QSettingItem*)item(7, 1))->setText(QString::number(pParas->m_fRetCoefSet));//UpdateStructText(CVariantDataAddress(&pParas->m_fRetCoefSet));

	setItem(0, 5, new QSettingItem(this));
	((QSettingItem*)item(0, 5))->setText(QString::number(pParas->m_fTimeValue_AbsErrNeg));//UpdateStructText(CVariantDataAddress(&pParas->m_fTimeValue_AbsErrNeg));
...
void ImpedanceEstimateGrid::SetOrGetErrorType(QComboBox *pComboBox, long &nErrorLogic, bool bSetMode)
{
	if (bSetMode)
	{
		if (nErrorLogic == 5)
		...
		{
			pComboBox->setCurrentIndex(nErrorLogic);
		}
	}
	else
	{
		...
		{
			nErrorLogic = pComboBox->currentIndex();
		}
	}
...
// 	m_pParas->m_nRetCoef_ErrorLogic = ((QComboBox*)m_pGrid->cellWidget(7, 2))->currentIndex();
	...
	m_pGrid->SetOrGetErrorType((QComboBox*)m_pGrid->cellWidget(0, 2), m_pParas->m_nTimeValue_ErrorLogic, FALSE);
	m_pGrid->SetOrGetErrorType((QComboBox*)m_pGrid->cellWidget(1, 2), m_pParas->m_nUActVal_ErrorLogic, FALSE);
	m_pGrid->SetOrGetErrorType((QComboBox*)m_pGrid->cellWidget(2, 2), m_pParas->m_nIActVal_ErrorLogic, FALSE);
	m_pGrid->SetOrGetErrorType((QComboBox*)m_pGrid->cellWidget(3, 2), m_pParas->m_nImpValue_ErrorLogic, FALSE);
	m_pGrid->SetOrGetErrorType((QComboBox*)m_pGrid->cellWidget(4, 2), m_pParas->m_nRValue_ErrorLogic, FALSE);
	m_pGrid->SetOrGetErrorType((QComboBox*)m_pGrid->cellWidget(5, 2), m_pParas->m_nXValue_ErrorLogic, FALSE);
	m_pGrid->SetOrGetErrorType((QComboBox*)m_pGrid->cellWidget(6, 2), m_pParas->m_nAngleActVal_ErrorLogic, FALSE);
	m_pGrid->SetOrGetErrorType((QComboBox*)m_pGrid->cellWidget(7, 2), m_pParas->m_nRetCoef_ErrorLogic, FALSE);
