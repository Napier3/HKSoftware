...
void CSttGlobalRtDataMngr::InitSoftResource(CSttTestResourceBase *pTestRerouce,CSttChMaps *pChMaps)
{
	ASSERT(pTestRerouce);
...
void CSttGlobalRtDataMngr::InitSoftResource_Sync(CSttTestResourceBase *pTestRerouce,CSttChMaps *pChMaps)
{
	if (m_pMacroChannels == NULL)
	{
...
void CSttGlobalRtDataMngr::InitSoftResource_Async(CSttTestResourceBase *pTestRerouce,CSttChMaps *pChMaps)
{
