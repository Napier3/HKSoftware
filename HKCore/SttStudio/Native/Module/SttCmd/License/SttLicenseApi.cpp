...
// 	}
// 
// 	return g_pAtsXDes->IsCurrTmUpdated();
// }
bool SttLicenseCanUse_Key(char *pszKey, char *strSN, char *strModuleID
                 , int nCurrYear, int nCurrMonth, int nCurrDay
                 , int nCurrTimes)
{
	if (g_pAtsXDes == 0)
    ...
    return g_pAtsXDes->IsValid_Key(pszKey, strSN, strModuleID, nCurrYear, nCurrMonth, nCurrDay, nCurrTimes);
}
