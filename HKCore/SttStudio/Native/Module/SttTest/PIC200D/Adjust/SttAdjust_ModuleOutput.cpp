...
#include "../../common/SttSystemConfig.h"
...
BOOL CSttAdjust_ModuleOutput::EventProcess()
{
    ...
    CSttDeviceBase::g_pSttDeviceBase->ProPic200dDrvResult(NULL);
#endif
	return FALSE;
}
...
void CSttAdjust_ModuleOutput::StartTest()
{
	...
	CLogPrint::LogString(XLOGLEVEL_DEBUG,"CSttAdjust_ModuleOutput::DataDownload Finished");
}
