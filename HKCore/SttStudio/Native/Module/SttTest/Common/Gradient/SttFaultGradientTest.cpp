...
void CSttFaultGradientTest::CalStepValue_Fault(tmt_channel *pCh_Vol, tmt_channel *pCh_Cur, float fCurValue)
{
	...
	case FG_FaultMode_AB:
	{
		...
		{
			bFind = TRUE;
			fPhi = fabs(atan2(fCurValue,m_oFaultGradientParas.m_fPreFaultEDU))*180.0/pi;
			fVa = p1.polar(fCurValue/2.0/sin(fPhi*pi/180.0),-90.0+fPhi);
			fVb = p1.polar(fCurValue/2.0/sin(fPhi*pi/180.0),-90.0-fPhi);
		...
		case FG_FM_Vaule_ShortVA:
		{
			...
			{
				fPhi = atan2(3.0*m_oFaultGradientParas.m_fPreFaultEDU - 6.0*m_oFaultGradientParas.m_fShortVm,sqrt(3.0)*m_oFaultGradientParas.m_fPreFaultEDU)*180.0/pi;
				fV = (3.0*m_oFaultGradientParas.m_fPreFaultEDU - 6.0*m_oFaultGradientParas.m_fShortVm)/sqrt(3.0);
			}
			else
			{
				fPhi = atan2(m_oFaultGradientParas.m_fShortVm,m_oFaultGradientParas.m_fPreFaultEDU)*180.0/pi;
				fV = m_oFaultGradientParas.m_fShortVm;
			}

			fVa = p1.polar(fV/2.0/sin(fPhi*pi/180.0),-90.0+fPhi);
			fVb = p1.polar(fV/2.0/sin(fPhi*pi/180.0),-90.0-fPhi);
			fVc = p1.polar(m_oFaultGradientParas.m_fPreFaultEDU,90.0);
			fIa = p1.polar(fCurValue,0.0-m_oFaultGradientParas.m_fAngle);
		...
		{
			bFind = TRUE;
			fPhi = atan2(3.0*m_oFaultGradientParas.m_fPreFaultEDU - 6.0*fCurValue,sqrt(3.0)*m_oFaultGradientParas.m_fPreFaultEDU)*180.0/pi;
	...
	case FG_FaultMode_BC:
	{
		...
		case FG_FM_Vaule_ShortVM:
		{
			...
			fPhi = fabs(atan2(fCurValue,m_oFaultGradientParas.m_fPreFaultEDU))*180.0/pi;
			fVb = p1.polar(fCurValue/2.0/sin(fPhi*pi/180.0),-90.0+fPhi);
			fVc = p1.polar(fCurValue/2.0/sin(fPhi*pi/180.0),-90.0-fPhi);
		...
		case FG_FM_Vaule_ShortVA:
		{
			...
			fVb = p1.polar(fV/2.0/sin(fPhi*pi/180.0),-90.0+fPhi);
			fVc = p1.polar(fV/2.0/sin(fPhi*pi/180.0),-90.0-fPhi);
			fVa = p1.polar(m_oFaultGradientParas.m_fPreFaultEDU,90.0);
