...
//#ifdef _PSX_IDE_QT_   原先仅在linux下需要，国际版7.0也需要-故注释。2024-8-14
	 if (bCreate)
	 {
         CreateSmartTestWnd();
...
// 	m_pTestControl->InitGuideBook();
	...
	if (nRet == 0)
	{
		//执行成功，因为系统参数修改后，需要重新生成或删除已有的Iec61850Config项目
		//再次开始测试时，应当重新筛选项目
		if (m_pTestControl != NULL)
		{
			m_pTestControl->m_nCurrTestItemIndex = 0;
...
// 	}
	...
	strFileName = ChangeFilePostfix(strFileName, _T("doc"));  //容错处理：上位机下发时可能没带后缀  2025-3-4
...
/*
<ats-cmd name="脱机选择" id="OfflineSel" mid="0" time="2024-12-24 10:21:35" testor="ATS">
	<paras name="" id="">
		<data name="装置型号" id="DeviceModel" data-type="string" value="PNS330" format="" />
		<data name="装置序列号" id="DeviceSN" data-type="string" value="645240304" format="" />
	</paras>
</ats-cmd>
*/
...
//将第一个device下的测试前准备项目，转换成CSiiItems，返回
