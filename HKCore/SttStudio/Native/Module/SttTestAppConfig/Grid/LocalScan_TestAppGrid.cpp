...
{
#ifndef NOT_USE_XLANGUAGE
	CString astrGridTitle[ATS_TESTAPP_LOCALSEARCH_GRID_COLS] = {/*_T("±àºÅ")*/g_sLangTxt_Index,/*_T("²âÊÔÒÇÐÍºÅ")*/g_sLangTxt_Native_TestInstrumentModel,/*_T("²âÊÔÒÇ±àºÅ")*/g_sLangTxt_Native_TestInstrumentID,_T("IP")};
#else
