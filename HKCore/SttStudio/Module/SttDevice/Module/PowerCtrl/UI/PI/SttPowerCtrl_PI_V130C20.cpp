#include "stdafx.h"
#include "SttPowerCtrl_PI_V130C20.h"
#include "../../../../../SttTest/Common/tmt_system_config.h"

CSttPowerCtrlV130C20_PI::CSttPowerCtrlV130C20_PI()
{

}

void CSttPowerCtrlV130C20_PI::SetVoltDA(float fVout, BOOL bIsDc)
{
	if(bIsDc)
		fVout = fVout /1.414;
...
void CSttPowerCtrlV130C20_PI::SetCurrentDA(float fIoutSum,float fIoutMax,int nModuleIndex,BOOL bIsDc)
{
	bIsDc=FALSE;
	float fDAValue=0.3;
	float fVset=0;
...
void CSttPowerCtrlV130C20_PI::SetVoltDA_State()
{
    SetVoltDA(130,FALSE);
}

void CSttPowerCtrlV130C20_PI::SetCurrentDA_State(int nModuleIndex)
{
    float fDAValue=0.3;
    float fVset=0;
    int nPowerMode=STT_CurrentMODULE_POWER_LOW;
