#include "stdafx.h"
#include "SttPowerCtrl_C12_5.h"
#include "../../../../SttTest/Common/tmt_system_config.h"

CSttPowerCtrlC12_5::CSttPowerCtrlC12_5()
{
	m_fMaxVal_DC=6;
	m_fMaxVal=12.5;
}

void CSttPowerCtrlC12_5::SetCurrentDA(float fIoutSum,float fIoutMax,int nModuleIndex,BOOL bIsDc)
{
	float fDAValue=0.7;
	float fVset=0;
...
void CSttPowerCtrlC12_5::SetCurrentDA_State(int nModuleIndex)
{
	float fDAValue=0.7;
	float fVset=0;
	int nPowerMode=STT_CurrentMODULE_POWER_LOW;
