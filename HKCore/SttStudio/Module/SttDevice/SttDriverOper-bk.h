...
public:
	...
	static int setDeviceDaPara_SysDefaultOut(char* pBuff,int nLen);
	...
	static int setFlashReadCmd(int module);
	static int readFlashDataState(char* pbuff);
	static int setFlashData(char* pbuff,int nLen,int nMode);
	static void Set_BO_ENABLE(bool bEnable);
	static void Set_BI_ENABLE(bool bEnable);
	static void Set_Goose_BO_ENABLE(bool bEnable);
	static void Set_Goose_BI_ENABLE(bool bEnable);
	...
	static int updateFpga(char* pbuff,int nLen,int nModule);
	static int sendUpdateFpgaOver();
