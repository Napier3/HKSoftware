...
void CSttLiveUpdateEngine::OnSocketClose(CSttSocketDataBase *pSocket, BOOL bDeleteSocket)
{
	...
	{
		if (g_theLiveUpdateBaseApp->m_oSttLiveUpdateEngine.m_pSttClientSocket != NULL)
		{
		bSttLiveupdate = TRUE;
		}
