...
inline unsigned long stt_pkg_get_idtester(BYTE *pPkg)
{
    unsigned long nRet = 0;
    nRet = (unsigned int)(pPkg[STT_PKG_INDEX_IDTESTER+3]<<24);
    nRet += (unsigned int)(pPkg[STT_PKG_INDEX_IDTESTER+2]<<16);
    nRet += (unsigned int)(pPkg[STT_PKG_INDEX_IDTESTER+1]<<8);
    nRet += (unsigned int)(pPkg[STT_PKG_INDEX_IDTESTER]);
//    nRet = pPkg[STT_PKG_INDEX_IDTESTER] + (pPkg[STT_PKG_INDEX_IDTESTER+1]<<8)
