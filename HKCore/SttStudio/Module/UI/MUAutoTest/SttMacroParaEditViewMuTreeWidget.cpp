...
{  
	...
	strItem = /*_T("合并单元自动测试")*/g_sLangTxt_Native_MergeUnitAutoTest;
	...
	strItem = /*_T("精度测试")*/g_sLangTxt_Native_AccuracyTest;
	...
	strItem = /*_T("零漂测试")*/g_sLangTxt_Native_ZeroDriftTest;
	...
	strItem = /*_T("首周波测试")*/g_sLangTxt_Native_FirstCycleTest;
	...
	strItem = /*_T("时间测试")*/g_sLangTxt_Native_TimeTest;
	...
	strItem = /*_T("对时精度")*/g_sLangTxt_Native_TimingAccuracy;
	...
	strItem = /*_T("守时精度")*/g_sLangTxt_Native_TimeKeepingAccuracy;
