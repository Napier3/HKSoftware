#ifndef QSttMacroParaEditViewInputCurWidget_H
#define QSttMacroParaEditViewInputCurWidget_H
...
class QSttMacroParaEditViewInputCurWidget : public CSttMacroParaEditViewOriginal
{
	Q_OBJECT

public:
	explicit QSttMacroParaEditViewInputCurWidget(QWidget *parent = 0);
	~QSttMacroParaEditViewInputCurWidget();

	virtual char* GetMacroID(){ return STT_ORG_MACRO_Remote_InputCurTest; }
	void InitUI();
...
class QInputCurEstimateDlg : public QDialog
{
	Q_OBJECT

public:
	explicit QInputCurEstimateDlg(CDataGroup* pParas, QWidget* parent = NULL);
	virtual ~QInputCurEstimateDlg();
