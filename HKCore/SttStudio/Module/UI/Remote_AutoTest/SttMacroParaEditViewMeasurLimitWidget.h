#ifndef QSttMacroParaEditViewMeasurLimitWidget_H
#define QSttMacroParaEditViewMeasurLimitWidget_H
...
class QSttMacroParaEditViewMeasurLimitWidget : public CSttMacroParaEditViewOriginal
{
	Q_OBJECT

public:
	explicit QSttMacroParaEditViewMeasurLimitWidget(QWidget *parent = 0);
	~QSttMacroParaEditViewMeasurLimitWidget();

	virtual char* GetMacroID(){ return STT_ORG_MACRO_Remote_MeasurLimitTest; }
	void InitUI();
...
class QMeasurLimitEstimateDlg : public QDialog
{
	Q_OBJECT

public:
	explicit QMeasurLimitEstimateDlg(CDataGroup* pParas, QWidget* parent = NULL);
	virtual ~QMeasurLimitEstimateDlg();
...
public:
	...
	QSttLineEdit *m_pValLineEdit;

protected slots:
	void slot_btnOK_Clicked();
	void slot_btnCancel_Clicked();
	void slot_PowerEditFinished();
	void slot_ValEditFinished();
};
