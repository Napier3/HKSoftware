...
void CSclCtrlsSmvInGrid::InitGridTitle()
{
	...
	CString astrGridTitle[SCLCTRLS_SMVIN_GRID_COLS] = {strChoose/*,strType*/,_T("APPID"),/*_T("Íâ²¿IEDÃèÊö")*/g_sLangTxt_Gradient_ExIEDdescrip,strMACAddr,_T("AP"),strChAllNum,strSubChNum,strSubIED,_T("svID"),strDataSets
