#include "ScrollTreeWidget.h"

QScrollTreeWidget::QScrollTreeWidget(QWidget* pParent) : QTreeWidget(pParent)
{
...
QScrollTreeWidget::~QScrollTreeWidget()
{

}

void QScrollTreeWidget::mousePressEvent(QMouseEvent *ev)
{
...
void QScrollTreeWidget::mouseMoveEvent(QMouseEvent *ev)
{
...
void QScrollTreeWidget::mouseReleaseEvent(QMouseEvent *ev)
{
...
bool QScrollTreeWidget::IsScrollMoving()
{
