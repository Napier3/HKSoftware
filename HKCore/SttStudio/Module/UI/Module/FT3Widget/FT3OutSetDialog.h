#ifndef FT3OUTSETDIALOG_H
#define FT3OUTSETDIALOG_H
...
class QFT3OutSetDialog: public QDialog
{
	Q_OBJECT

public:
	QFT3OutSetDialog(long dwValue,QWidget *parent= NULL);
	~QFT3OutSetDialog();

	void InitUI();
	void SaveData();
	void ShowData();
	void SetInitValueFont();
