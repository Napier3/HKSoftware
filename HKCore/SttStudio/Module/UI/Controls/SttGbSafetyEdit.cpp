...
void QSttGbSafetyEdit::InitSafetyMsgCfgs(const CString &strMsgs)
{
	...
	CSttSafetyMsgCfgs *pMsgCfgs = &g_theTestCntrFrame->m_oSafetyMsgCfgs;
	CSttSafetyMsgCfg *pMsgCfg = (CSttSafetyMsgCfg *)pMsgCfgs->FindByID(g_theGbSmartGenWzd->m_strDeviceType);
	m_pMsgCfg = pMsgCfg;
