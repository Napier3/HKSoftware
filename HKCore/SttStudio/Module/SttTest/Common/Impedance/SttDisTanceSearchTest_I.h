...
class CSttDisTanceSearchTest_I : public CSttDisTanceTest_I
{
public:
    CSttDisTanceSearchTest_I();
    virtual ~CSttDisTanceSearchTest_I(void);
	...
	{
        return new CSttDisTanceSearchTest_I();
	}
public:
...
private:
    tmt_DistanceSearchParas_I m_oParas;
