...
public:
    ...
    Drv_LtReplayBuffer *m_pLtReplayBuffer;
    tmt_ReplayResult m_oReplayResult;
	BOOL bTestFinishNormal;
...
public:
	...
	{
		if(!bTestFinishNormal)
		{
			CSttDeviceBase::g_pSttDeviceBase->SetTestStop();
			CLogPrint::LogString(XLOGLEVEL_DEBUG,_T("[error] LtReplayTest Stopped, IRQ Signal TimeOut"));
		}
