...
void CSttDiffCbopTest::TranslateToStateParas()
{
    ...
    {
    case 0://0-高-低
        fI1 = m_fKph*m_fCurrent;
        fI2 = m_fKpl*m_fCurrent;
        break;
    case 1://1-高-中
        fI1 = m_fKph*m_fCurrent;
        fI2 = m_fKpm*m_fCurrent;
        break;
    case 2://2-中-低
        fI1 = m_fKpm*m_fCurrent;
        fI2 = m_fKpl*m_fCurrent;
        break;
    }
    switch(m_nFaultType)
    ...
    case 0://A相
        ...
        fAmp[4]=fI2/2.0;
        fAmp[5]=fI2/2.0;
        switch (m_nFaultLocation)
        {
        case FAULTLOCATION_HIGH_IN:
        case FAULTLOCATION_LOW_IN:
            fAngle[0]=0;
            fAngle[1]=180.0;
            fAngle[2]=180.0;
            fAngle[3]=0;
    ...
    {
        m_pStateTest->m_oStateParas.m_paraState[1].m_uiCUR[nIndex].Harm[1].fAmp = fAmp[nIndex];
        m_pStateTest->m_oStateParas.m_paraState[1].m_uiCUR[nIndex].Harm[1].fAngle = fAngle[nIndex];
