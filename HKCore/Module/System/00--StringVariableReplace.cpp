// StringVariableReplace.cpp: implementation of the CStringVariableReplace class.
//
//////////////////////////////////////////////////////////////////////
...
void CStringVariableReplace::Init(const CString &strBuffer)
{
	...
	m_nDataLength = CString_to_char(strBuffer, &m_pData);
...
{
	char pszSrc[MAX_PATH], pszDest[MAX_PATH];
	CString_to_char(strSrc, pszSrc);
	CString_to_char(strDest, pszDest);

	long nDestLen = strlen(pszDest);
