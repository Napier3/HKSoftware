// XLanguageNameParser.cpp: implementation of the CXLanguageNameParser class.
//
//////////////////////////////////////////////////////////////////////
...
const char CXLanguageNameParser::g_chLanguageSeparator = '$';

CXLanguageNameParser::CXLanguageNameParser()
{
...
long CXLanguageNameParser::ParseLanguageString(CString &strName)
{
	memset((void*)(&m_oLanguageString), 0, sizeof(LANGUAGESTRING)*MAX_LanguageString);
	m_nLanguageStringCount = 0;
	...
	if (pLangBegin != NULL)
	{
        CLogPrint::LogFormatString(XLOGLEVEL_TRACE, _T("Error Langeuage String: [%s]"), strName.GetString());
	}
...
void CXLanguageNameParser::ReAllocLanguageStringBuffer()
{
...
void CXLanguageNameParser::Parse()
{
	long nIndex = 0;
	...
	while (IsPoiterInBuffer(pString))
	{
		...
		{
				strLangString = xlang_GetLgugStr(CString(pLanguageStringBegin));
