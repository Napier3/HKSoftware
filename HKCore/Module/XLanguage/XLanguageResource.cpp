...
void CXLanguageResourceBase::InitLangRsByFileEx(CXLanguage *pXLangRef, const CString &strFile)
{
	...
	BOOL bRet = FALSE;
	if (IsFileExist(strXLangFileB))//dingxy 20240918 采用二进制文件方式打开保存多语言文件
	{
...
{
	/*使用改函数时，确保使用场景为英文，则需要再上方115行增加xlang_SetCurrLanguageID("English");
	*
	*此处是英文换成俄文的,如需转换为其他语言，更换当前语言ID
	*/
...
//2024-11-08 zhouyangyong
CString g_sLangID_NotSupportVoltGather;//当前设备不支持电压采集
CString g_sLangTxt_NotSupportVoltGather;//当前设备不支持电压采集

//2024-11-19 wuxinyi 
CString g_sLangID_CreatReplaySocket;
CString g_sLangTxt_CreatReplaySocket;//建立报文故障回放通道......
CString g_sLangID_CreatCapRcdSocket;
CString g_sLangTxt_CreatCapRcdSocket;//建立报文录波通道......
CString g_sLangID_ConnectOKWaitTest;
CString g_sLangTxt_ConnectOKWaitTest;//连接完成，准备开始测试......

CString g_sLangID_RevReplayRequest;
CString g_sLangTxt_RevReplayRequest;//收到回放数据请求
CString g_sLangID_RevSendDataReply;
CString g_sLangTxt_RevSendDataReply;//收到发送数据开始应答
CString g_sLangID_ReplayData;
CString g_sLangTxt_ReplayData;//回放数据
CString g_sLangID_ReadyToSend;
CString g_sLangTxt_ReadyToSend;//准备发送
CString g_sLangID_SentComplete;
CString g_sLangTxt_SentComplete;//已发送完成
CString g_sLangID_SentAllReplayData;
CString g_sLangTxt_SentAllReplayData;//回放数据全部发送完成

//CString g_sLangID_Qualified;
//CString g_sLangTxt_Qualified;//合格
//CString g_sLangID_Unqualified;
//CString g_sLangTxt_Unqualified;//不合格
CString g_sLangID_ControlBlock;
CString g_sLangTxt_ControlBlock;//控制块
CString g_sLangID_Packet;
CString g_sLangTxt_Packet;//报文
CString g_sLangID_AxisUnitOmega;
CString g_sLangTxt_AxisUnitOmega;//Ω
CString g_sLangID_AxisUnitAng;
CString g_sLangTxt_AxisUnitAng;//°
CString g_sLangID_AxisUnitDeltaSmall;
CString g_sLangTxt_AxisUnitDeltaSmall;//δ
...
CString g_sLangTxt_AxisUnitPhi;           //_T("Φ")
