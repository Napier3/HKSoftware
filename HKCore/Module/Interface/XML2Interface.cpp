...
BOOL xml_GetElementText(CXmlRWElementBase &oElement, CString &strAttrVal)
{
	...
	MSXML2::IXMLDOMNodePtr oNode = oElement;
...
BOOL xml_SetElementText(const BSTR &strAttrName, CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oParent, DWORD &dwAttrVal)
{
	CString strVal;
...
BOOL xml_SetElementText(const BSTR &strAttrName, CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oParent, double &dAttrVal)
{
	CString strVal;
...
BOOL xml_SetElementText(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oParent, const CString &strAttrVal)
{
	...
	MSXML2::IXMLDOMNodePtr oChildNode = oParent;
	oChildNode->put_text(_bstr_t(strAttrVal));
...
BOOL xml_SetElementText(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oParent, long &nAttrVal)
{
	...
	return xml_SetElementText(oXMLDoc, oParent, strVal);
}

BOOL xml_SetElementText(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oParent, DWORD &dwAttrVal)
{
	CString strVal;
	strVal.Format(_T("%d"), dwAttrVal);
...
BOOL xml_SetElementText(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oParent, double &dAttrVal)
{
	CString strVal;
	strVal.Format(_T("%f"), dAttrVal);
