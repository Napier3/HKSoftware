...
#include "include\libssh2_config.h"
...
public:
	...
	*/
	...
	int preSftpDownloadFileDir(const char sftpDir[MAX_PATH],const char localDir[MAX_PATH],const char extendDir[MAX_PATH]);
	int preSftpUpdateFileDir(const char localDir[MAX_PATH],const char sftpDir[MAX_PATH],const char externDir[MAX_PATH]);      
