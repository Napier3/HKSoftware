...
//////////////////////////////////////////////
//报文格式
#ifdef STT_SOCKET_ONLY_USE_FILE
	#define STT_PKG_HEAD_LEN	8
	#define STT_PKG_INDEX_TYPECMD	4
	#define STT_PKG_INDEX_DATALEN	5
	#define STT_PKG_INDEX_DATALEN_FILEMODE		5
	#define STT_PKG_INDEX_DATALEN_FILEDATALEN	6
#else
...
#define STT_PKG_SEND_FILEDATA_MAXLEN		4096  //2048  //4096  //16384  //4096
...
#ifndef STT_SOCKET_ONLY_USE_FILE
inline long stt_pkg_get_src_id(BYTE *pPkg)
{
	return pPkg[STT_PKG_INDEX_SRCID] + (pPkg[STT_PKG_INDEX_SRCID+1]<<8);
}

inline long stt_pkg_get_dest_id(BYTE *pPkg)
{
	return pPkg[STT_PKG_INDEX_DSTID] + (pPkg[STT_PKG_INDEX_DSTID+1]<<8);
}
...
// inline long stt_pkg_get_compress(BYTE *pPkg)
// {
// 	return pPkg[STT_PKG_INDEX_COMPRESS];
// }
#endif
...
#ifndef STT_SOCKET_ONLY_USE_FILE
inline void stt_pkg_set_src_id(BYTE *pPkg, long nSrcID)
{
	pPkg[STT_PKG_INDEX_SRCID] = nSrcID & 0xFF;
	pPkg[STT_PKG_INDEX_SRCID+1] = (nSrcID >> 8)  & 0xFF;
}

inline void stt_pkg_set_dest_id(BYTE *pPkg, long nDestID)
{
	pPkg[STT_PKG_INDEX_DSTID] = nDestID & 0xFF;
	pPkg[STT_PKG_INDEX_DSTID+1] = (nDestID >> 8)  & 0xFF;
}

inline void stt_pkg_set_send_index(BYTE *pPkg, long nSendIndex)
{
	pPkg[STT_PKG_INDEX_DSTID] = nSendIndex & 0xFF;
	pPkg[STT_PKG_INDEX_DSTID+1] = (nSendIndex >> 8)  & 0xFF;
}

// inline void stt_pkg_set_compress(BYTE *pPkg, BYTE bCompress)
// {
// 	pPkg[STT_PKG_INDEX_COMPRESS] = (BYTE)bCompress;
// }
#endif
