...
#define ECCLASSID_CEPCAPNETREMOTE       (ECCLASSID_EXLISTCLASS + 0X00000002)
#define ECCLASSID_CEPCAPNETSUBREMOTE       (ECCLASSID_EXLISTCLASS + 0X00000003)
#define ECCLASSID_CEPCAPNETDEVICE       (ECCLASSID_BASECLASS + 0X00000004)
#define ECCLASSID_CEPCAPNETLOCAL       (ECCLASSID_EXLISTCLASS + 0X00000005)
#define ECCLASSID_CEPCAPDIRS       (ECCLASSID_EXLISTCLASS + 0X00000006)
#define ECCLASSID_CEPCAPDIR       (ECCLASSID_BASECLASS + 0X00000007)
#define ECCLASSID_CEPCAPSERIALCONFIG       (ECCLASSID_EXLISTCLASS + 0X00000008)
#define ECCLASSID_CEPCAPSERIALGROUP       (ECCLASSID_EXLISTCLASS + 0X00000009)
#define ECCLASSID_CEPCAPSERIALDEVICE       (ECCLASSID_BASECLASS + 0X0000000A)
...
public:
	...
	BSTR m_strCEpCapNetLocalKey; //local
	BSTR m_strCEpCapNetDeviceKey; //device
	BSTR m_strCEpCapNetSubRemoteKey; //sub-remote
	BSTR m_strCEpCapNetRemoteKey; //remote
...
public:
	...
	static BSTR CEpCapNetLocalKey()  {   return g_pXmlKeys->m_strCEpCapNetLocalKey;  }
	static BSTR CEpCapNetDeviceKey()  {   return g_pXmlKeys->m_strCEpCapNetDeviceKey;  }
	static BSTR CEpCapNetSubRemoteKey()  {   return g_pXmlKeys->m_strCEpCapNetSubRemoteKey;  }
	static BSTR CEpCapNetRemoteKey()  {   return g_pXmlKeys->m_strCEpCapNetRemoteKey;  }
