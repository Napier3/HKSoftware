// EpVirtualListCtrlBase.cpp : 实现文件
//

#include "stdafx.h"
#include "EpVirtualListCtrlBase.h"

// CEpVirtualListCtrlBase

IMPLEMENT_DYNAMIC(CEpVirtualListCtrlBase, CListCtrl)

CEpVirtualListCtrlBase::CEpVirtualListCtrlBase()
{
	m_nCount = 0;
	m_nItemsLimit = 0;;
	m_pListBuffer = NULL;
...
void CEpVirtualListCtrlBase::SetItemsLimit(UINT nLimit)
{
...
void CEpVirtualListCtrlBase::AddItem(CExBaseObject *pData)
{
...
void  CEpVirtualListCtrlBase::AddItems(CExBaseList *pDatas)
{
...
void CEpVirtualListCtrlBase::DeleteAllItems()
{
	CListCtrl::DeleteAllItems();
	m_nCount = 0;
}

BEGIN_MESSAGE_MAP(CEpVirtualListCtrlBase, CListCtrl)
	ON_WM_CREATE()
	ON_WM_DESTROY()
	ON_NOTIFY_REFLECT(LVN_GETDISPINFO, OnGetDispinfo)
	ON_NOTIFY_REFLECT(NM_DBLCLK, &CEpVirtualListCtrlBase::OnNMDblclk)
END_MESSAGE_MAP()



// CEpVirtualListCtrlBase 消息处理程序

int CEpVirtualListCtrlBase::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void CEpVirtualListCtrlBase::OnDestroy() 
{
	CListCtrl::OnDestroy();
}

void CEpVirtualListCtrlBase::OnGetDispinfo(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
void CEpVirtualListCtrlBase::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct)
{
...
void CEpVirtualListCtrlBase::OnNMDblclk(NMHDR *pNMHDR, LRESULT *pResult)
{
...
BOOL CEpVirtualListCtrlBase::GetItemText(int iRow, int iCol, CString &strText)
{
	strText = "";
...
BOOL CEpVirtualListCtrlBase::GetItemText(CCapCycleMemBuffer *pBuffer, int iCol, CString &strText)
{
	long nDataLen = 0;
...
BOOL CEpVirtualListCtrlBase::CreateVirtualList(CRect rcWnd, CWnd *pParent, UINT nID)
{
...
BOOL CEpVirtualListCtrlBase::InitVirtualListTitle()
{
	//设置列表框
...
CCapCycleMemBuffer* CEpVirtualListCtrlBase::GetItemDataPtr(long nItemIndex)
{
