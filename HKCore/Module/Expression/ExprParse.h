...
public:
	CExprTextUnit()							{						};
	CExprTextUnit(char chChar)				{	SetTChar(chChar);	};
...
public:
	...
	BOOL InsertChar(char chChar, int nPos);
	CString GetString();
	BOOL AppendChar(char chChar);

private:
	void SetTChar(char chChar);
...
protected:
	CExprTextUnit* NewTextUnit(char chChar);
