...
// 	AfxMessageBox(strMsg);
	...
	LocateAreaPos(oSmDbFilePos.n64DbIndexCurrPos);
...
LPVOID CCapDbIndexSmDbFile::LocatePos(volatile __int64 n64CurrPos)
{
	return m_pDbIndex->LocateAreaPos(n64CurrPos);
}
