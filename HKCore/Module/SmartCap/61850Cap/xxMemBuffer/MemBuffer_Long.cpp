...
void CMemBuffer_Long::DettachBuffer()
{
	m_bBufferAttach = TRUE;
	m_pBuffer = NULL;
	m_nBufferLength		= 0;	
...
void CMemBuffer_Long::ModifyLastValue(short nOffSet)
{
...
void CMemBuffer_Long::LOG_ShowBufferInfor()
{
	long nIndex = 0;
	CString strTemp;
	CString strData;
