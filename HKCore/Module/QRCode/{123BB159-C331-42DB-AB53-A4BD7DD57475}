// Barcode.cpp: implementation of the CXBarcodeBase class.
//
...
void CXBarcodeBase::LoadData(const CString &csMessage, double dNarrowBar, double dFinalHeight, HDC pDC, int nStartingXPixel, int nStartingYPixel, double dRatio )
{
...
long CXBarcodeBase::GetBarcodePixelHeight()
{
	return m_nPixelHeight;
}

long CXBarcodeBase::GetBarcodePixelWidth()
{
