...
void CSerialBaudRateComboBox::InitBaudRateString()
{
	...
	nIndex = AddString(_T("5600"));
	SetItemData(nIndex, 5600);

	nIndex = AddString(_T("9600"));
	SetItemData(nIndex, 9600);

	nIndex = AddString(_T("14400"));
	SetItemData(nIndex, 14400);

	nIndex = AddString(_T("19200"));
	SetItemData(nIndex, 19200);

	nIndex = AddString(_T("38400"));
	SetItemData(nIndex, 38400);

	nIndex = AddString(_T("115200"));
	SetItemData(nIndex, 115200);

	nIndex = AddString(_T("128000"));
	SetItemData(nIndex, 128000);
	
	nIndex = AddString(_T("256000"));
	SetItemData(nIndex, 256000);
