...
/* ID_QT_NONE add by yp.w */
const GUID ID_QT_NONE = { 0x67f6af7f, 0xf753, 0x11cf, { 0x9d, 0x89, 0x0, 0x80, 0xc7, 0x2e, 0x70, 0xa3 } };
...
#define ID_QU_FLUKE_U 1000               //20201126 zhouhj Fluke表计中自定义单位
#define ID_QU_FLUKE_I 1001               //20201126 zhouhj Fluke表计中自定义单位
...
/* ID_SERIES_VALUE_TYPE_NONE add by yp.w */
const GUID ID_SERIES_VALUE_TYPE_NONE = { 0x67f60000, 0xf753, 0x11cf, { 0x9d, 0x89, 0x0, 0x80, 0xc7, 0x2e, 0x70, 0xa3 } };
...
const GUID ID_SERIES_VALUE_TYPE_QUALITY = {  0x67f6afa0, 0xf753, 0x11cf, { 0x9d, 0x89, 0x0, 0x80, 0xc7, 0x2e, 0x70, 0xa3 } };//zhouhj 20180928 按联研院最新标准扩充

const GUID ID_SERIES_VALUE_TYPE_FLUKE = {  0x80c4a748, 0x2816, 0x11d4, { 0x8a, 0xb4, 0x0, 0x40, 0x5, 0x69, 0x8d, 0x26 } };//zhouhj 20201126 按Fluke的PQDIF文件扩充
...
//zhouhj 按照《电能质量数据交换格式规范》新增的GUID
const GUID ID_QC_REACTANCE = { 0xCD65F4D5, 0x9E8A, 0x10E3,{ 0xF8, 0x73, 0xB8, 0x5A, 0x2A, 0x4E, 0xEE, 0xCC} }; 
const GUID ID_QC_RESISTANCE = { 0xB187C91E, 0x09B6, 0x06D1,{ 0x6B, 0x37, 0x37, 0xAF, 0xC6, 0x62, 0x08, 0x10} }; 
const GUID ID_QC_DVC = { 0x22DF29BE, 0x8D8F, 0x4970, { 0x92, 0xB2, 0xC5, 0xDA, 0x03, 0x31, 0x2B, 0xC9} }; 
const GUID ID_QC_RVC = { 0x9DCA1D02, 0x26BD, 0x482f, { 0xB7, 0x67, 0xFF, 0x7C, 0xD7, 0x15, 0xC9, 0x6F} }; 
const GUID ID_QC_Q_HARMONIC = { 0x82EB0866, 0x6879, 0x44B7, { 0xBF, 0x32, 0xBE, 0x1D, 0xB2, 0xBC, 0x44, 0x07} }; 
const GUID ID_QC_S_HARMONIC = { 0xDB2576E7, 0xF0F7, 0x4469, { 0xA0, 0xF1, 0x57, 0xCE, 0xB9, 0xEA, 0x00, 0xB4} }; 
const GUID ID_QC_PF_HARMONIC = { 0x805D2943, 0x4955, 0x398F, { 0x57, 0x1B, 0x9B, 0xD7, 0x93, 0x4F, 0xC4, 0xCA} }; 
const GUID ID_QC_P_INTG_FUND = { 0x68FF5B66, 0x7123, 0xF7FE, { 0xEA, 0xC5, 0xEF, 0x8C, 0x35, 0x9D, 0xBC, 0xA9} }; 
const GUID ID_QC_Q_INTG_FUND = { 0x9DEBA8DB, 0x266D, 0x4881, { 0x1F, 0x98, 0xD2, 0xE3, 0x0B, 0x5F, 0xC0, 0x2F} }; 
const GUID ID_QC_P_INTG_HARMONIC = { 0x49D83AB4, 0x8C5A, 0x13DE, { 0xE7, 0x06, 0x8A, 0xA9, 0xAC, 0x8A, 0x05, 0x92} }; 
const GUID ID_QC_Q_INTG_HARMONIC = { 0xA6BC1A2C, 0xBE6A, 0x6103, { 0x68, 0x8B, 0x75, 0xF6, 0x93, 0xD3, 0x05, 0x27} }; 
const GUID ID_QC_S_INTG_HARMONIC = { 0x94C794EC, 0x9CC0, 0xF50D, { 0xAB, 0x1A, 0x2E, 0x93, 0x76, 0xB8, 0x89, 0x53} }; 
const GUID ID_QC_P_INTG_POS_HARMONIC = { 0xAE8FAF2E, 0xC140, 0x7BF3, { 0x69, 0xFA, 0x3C, 0x98, 0x29, 0x4F, 0xCA, 0xB1} }; 
const GUID ID_QC_Q_INTG_POS_HARMONIC = { 0x2F964B99, 0x8805, 0x28C0, { 0x8F, 0x4C, 0xC7, 0x7B, 0x20, 0xBE, 0x7B, 0x7C} }; 
const GUID ID_QC_P_INTG_NEG_HARMONIC = { 0x2488218B, 0xCFF2, 0xB522, { 0x94, 0x54, 0xEA, 0xF5, 0xF8, 0x21, 0xD6, 0xE0} }; 
const GUID ID_QC_Q_INTG_NEG_HARMONIC = { 0xFE36A4B1, 0x80A8, 0xBE33, { 0x6F, 0x20, 0xF0, 0x27, 0x52, 0x74, 0x13, 0xB2} };

const GUID ID_QC_FLUKE_THD_INDUCTIVE = { 0x80C4A765, 0x2816, 0x11D4, { 0x8A, 0xB4, 0x0, 0x40, 0x5, 0x69, 0x8D, 0x26} };//zhouhj 20201201 根据Fluke表计新增
const GUID ID_QC_FLUKE_THD_IHARM = { 0x80C4A766, 0x2816, 0x11D4, { 0x8A, 0xB4, 0x0, 0x40, 0x5, 0x69, 0x8D, 0x26} };//zhouhj 20201201 根据Fluke表计新增
const GUID ID_QC_FLUKE_UI_CP = { 0x80C4A769, 0x2816, 0x11D4, { 0x8A, 0xB4, 0x0, 0x40, 0x5, 0x69, 0x8D, 0x26} };//zhouhj 20201201 根据Fluke表计新增
const GUID ID_QC_FLUKE_UI_P = { 0x80C4A767, 0x2816, 0x11D4, { 0x8A, 0xB4, 0x0, 0x40, 0x5, 0x69, 0x8D, 0x26} };//zhouhj 20201201 根据Fluke表计新增
const GUID ID_QC_FLUKE_UI_Q = { 0x80C4A768, 0x2816, 0x11D4, { 0x8A, 0xB4, 0x0, 0x40, 0x5, 0x69, 0x8D, 0x26} };//zhouhj 20201201 根据Fluke表计新增
const GUID ID_QC_FLUKE_IMBALANCE = { 0x80C4A751, 0x2816, 0x11D4, { 0x8A, 0xB4, 0x0, 0x40, 0x5, 0x69, 0x8D, 0x26} };//zhouhj 20201201 根据Fluke表计新增
...
typedef struct _STRUCT_ValueCString
{
	int value;
	CString cstr;
} STRUCT_ValueCString;

typedef struct _STRUCT_GuidCString 
{
	GUID value;
	CString cstr;
} STRUCT_GuidCString;

static STRUCT_ValueCString valCstr_phase[] = 
{
	{ ID_PHASE_NONE, _T("ID_PHASE_NONE") },
	{ ID_PHASE_AN, _T("ID_PHASE_AN")   },
	{ ID_PHASE_BN, _T("ID_PHASE_BN") },
	{ ID_PHASE_CN, _T("ID_PHASE_CN") },
	{ ID_PHASE_NG, _T("ID_PHASE_NG") },
	{ ID_PHASE_AB, _T("ID_PHASE_AB") },
	{ ID_PHASE_BC, _T("ID_PHASE_BC") },
	{ ID_PHASE_CA, _T("ID_PHASE_CA") },
	{ ID_PHASE_RES, _T("ID_PHASE_RES") },
	{ ID_PHASE_NET, _T("ID_PHASE_NET") },
	{ ID_PHASE_TOTAL, _T("ID_PHASE_TOTAL") },
	{ ID_PHASE_LN_AVE, _T("ID_PHASE_LN_AVE") },
	{ ID_PHASE_LL_AVE, _T("ID_PHASE_LL_AVE") },
	{ ID_PHASE_WORST, _T("ID_PHASE_WORST") },
	{ ID_PHASE_PLUS, _T("ID_PHASE_PLUS") },
	{ ID_PHASE_MINUS, _T("ID_PHASE_MINUS") },
	{ ID_PHASE_GENERAL_1, _T("ID_PHASE_GENERAL_1") },
	{ ID_PHASE_GENERAL_2, _T("ID_PHASE_GENERAL_2") },
	{ ID_PHASE_GENERAL_3, _T("ID_PHASE_GENERAL_3") },
	{ ID_PHASE_GENERAL_4, _T("ID_PHASE_GENERAL_4") },
	{ ID_PHASE_GENERAL_5, _T("ID_PHASE_GENERAL_5") },
	{ ID_PHASE_GENERAL_6, _T("ID_PHASE_GENERAL_6") },
	{ ID_PHASE_GENERAL_7, _T("ID_PHASE_GENERAL_7") },
	{ ID_PHASE_GENERAL_8, _T("ID_PHASE_GENERAL_8") },
	{ ID_PHASE_GENERAL_9, _T("ID_PHASE_GENERAL_9") },
	{ ID_PHASE_GENERAL_10, _T("ID_PHASE_GENERAL_10") },
	{ ID_PHASE_GENERAL_11, _T("ID_PHASE_GENERAL_11") },
	{ ID_PHASE_GENERAL_12, _T("ID_PHASE_GENERAL_12") },
	{ ID_PHASE_GENERAL_13, _T("ID_PHASE_GENERAL_13") },
	{ ID_PHASE_GENERAL_14, _T("ID_PHASE_GENERAL_14") },
	{ ID_PHASE_GENERAL_15, _T("ID_PHASE_GENERAL_15") },
	{ ID_PHASE_GENERAL_16, _T("ID_PHASE_GENERAL_16") }
};

static STRUCT_ValueCString valCStr_measured[] =
{
	{ ID_QM_NONE, _T("ID_QM_NONE") },
	{ ID_QM_VOLTAGE, _T("ID_QM_VOLTAGE") },
	{ ID_QM_CURRENT, _T("ID_QM_CURRENT") },
	{ ID_QM_POWER, _T("ID_QM_POWER") },
	{ ID_QM_ENERGY, _T("ID_QM_ENERGY") },
	{ ID_QM_TEMPERATURE, _T("ID_QM_TEMPERATURE") },
	{ ID_QM_PRESSURE, _T("ID_QM_PRESSURE") },
	{ ID_QM_CHARGE, _T("ID_QM_CHARGE") },
	{ ID_QM_EFIELD, _T("ID_QM_EFIELD") },
	{ ID_QM_MFIELD, _T("ID_QM_MFIELD") },
	{ ID_QM_VELOCITY, _T("ID_QM_VELOCITY") },
	{ ID_QM_BEARING, _T("ID_QM_BEARING") },
	{ ID_QM_FORCE, _T("ID_QM_FORCE") },
	{ ID_QM_TORQUE, _T("ID_QM_TORQUE") },
	{ ID_QM_POSITION, _T("ID_QM_POSITION") },
	{ ID_QM_FLUXLINKAGE, _T("ID_QM_FLUXLINKAGE") },
	{ ID_QM_FLUXDENSITY, _T("ID_QM_FLUXDENSITY") },
	{ ID_QM_STATUS, _T("ID_QM_STATUS") }
};

static STRUCT_ValueCString valCStr_unit[] = 
{
	{ ID_QU_NONE, _T("ID_QU_NONE") },
	{ ID_QU_SECONDS, _T("ID_QU_SECONDS") },
	{ ID_QU_TIMESTAMP, _T("ID_QU_TIMESTAMP") },
	{ ID_QU_CYCLES, _T("ID_QU_CYCLES") },
	{ ID_QU_VOLTS, _T("ID_QU_VOLTS") },
	{ ID_QU_AMPS, _T("ID_QU_AMPS") },
	{ ID_QU_VA, _T("ID_QU_VA") },
	{ ID_QU_WATTS, _T("ID_QU_WATTS") },
	{ ID_QU_VARS, _T("ID_QU_VARS") },
	{ ID_QU_OHMS, _T("ID_QU_OHMS") },
	{ ID_QU_SIEMENS, _T("ID_QU_SIEMENS") },
	{ ID_QU_VOLTSPERAMP, _T("ID_QU_VOLTSPERAMP") },
	{ ID_QU_JOULES, _T("ID_QU_JOULES") },
	{ ID_QU_HERTZ, _T("ID_QU_HERTZ") },
	{ ID_QU_CELCIUS, _T("ID_QU_CELCIUS") },
	{ ID_QU_DEGREES, _T("ID_QU_DEGREES") },
	{ ID_QU_DB, _T("ID_QU_DB") },
	{ ID_QU_PERCENT, _T("ID_QU_PERCENT") },
	{ ID_QU_PERUNIT, _T("ID_QU_PERUNIT") },
	{ ID_QU_SAMPLES, _T("ID_QU_SAMPLES") },
	{ ID_QU_VARHOURS, _T("ID_QU_VARHOURS") },
	{ ID_QU_WATTHOURS, _T("ID_QU_WATTHOURS") },
	{ ID_QU_VAHOURS, _T("ID_QU_VAHOURS") },
	{ ID_QU_MPS, _T("ID_QU_MPS") },
	{ ID_QU_MPH, _T("ID_QU_MPH") },
	{ ID_QU_BARS, _T("ID_QU_BARS") },
	{ ID_QU_PASCALS, _T("ID_QU_PASCALS") },
	{ ID_QU_NEWTONS, _T("ID_QU_NEWTONS") },
	{ ID_QU_NEWTONMETERS, _T("ID_QU_NEWTONMETERS") },
	{ ID_QU_RPM, _T("ID_QU_RPM") },
	{ ID_QU_RADPERSEC, _T("ID_QU_RADPERSEC") },
	{ ID_QU_METERS, _T("ID_QU_METERS") },
	{ ID_QU_WEBERTURNS, _T("ID_QU_WEBERTURNS") },
	{ ID_QU_TESLAS, _T("ID_QU_TESLAS") },
	{ ID_QU_WEBERS, _T("ID_QU_WEBERS") },
	{ ID_QU_VOLTSPERVOLT, _T("ID_QU_VOLTSPERVOLT") },
	{ ID_QU_AMPSPERAMP, _T("ID_QU_AMPSPERAMP") },
	{ ID_QU_AMPSPERVOLT, _T("ID_QU_AMPSPERVOLT") },
	{ ID_QU_FLUKE_U, _T("ID_QU_FLUKE_U") },
	{ ID_QU_FLUKE_I, _T("ID_QU_FLUKE_I") }
};

static STRUCT_GuidCString valCStr_characteristic[] = 
{
	{ ID_QC_RMS, _T("ID_QC_RMS") },
	{ ID_QC_FLKR_MAX_DVV, _T("ID_QC_FLKR_MAX_DVV") },
	{ ID_QC_ANGLE_FUND, _T("ID_QC_ANGLE_FUND") },
	{ ID_QC_S2S1, _T("ID_QC_S2S1") },
	{ ID_QC_FREQUENCY, _T("ID_QC_FREQUENCY") },
	{ ID_QC_SPOS, _T("ID_QC_SPOS") },
	{ ID_QC_SNEG, _T("ID_QC_SNEG") },
	{ ID_QC_SZERO, _T("ID_QC_SZERO") },
	{ ID_QC_TOTAL_THD, _T("ID_QC_TOTAL_THD") },
	{ ID_QC_SPECTRA, _T("ID_QC_SPECTRA") },
	{ ID_QC_P, _T("ID_QC_P") },
	{ ID_QC_Q, _T("ID_QC_Q") },
	{ ID_QC_S, _T("ID_QC_S") },
	{ ID_QC_PF, _T("ID_QC_PF") },
	{ ID_QC_DF, _T("ID_QC_DF") },
	{ ID_QC_P_FUND, _T("ID_QC_P_FUND") },
	{ ID_QC_Q_FUND, _T("ID_QC_Q_FUND") },
	{ ID_QC_S_FUND, _T("ID_QC_S_FUND") },
	{ ID_QC_P_HARMONIC_UNSIGNED, _T("ID_QC_P_HARMONIC_UNSIGNED") },
	{ ID_QC_FLKR_PST, _T("ID_QC_FLKR_PST") },
	{ ID_QC_FLKR_PLT, _T("ID_QC_FLKR_PLT") },
	{ ID_QC_INSTANTANEOUS, _T("ID_QC_INSTANTANEOUS") },
	{ ID_QC_PEAK, _T("ID_QC_PEAK") },
	{ ID_QC_HRMS, _T("ID_QC_HRMS") },
	{ ID_QC_EVEN_THD, _T("ID_QC_EVEN_THD") },
	{ ID_QC_ODD_THD, _T("ID_QC_ODD_THD") },
	{ ID_QC_CREST_FACTOR, _T("ID_QC_CREST_FACTOR") },
	{ ID_QC_FORM_FACTOR, _T("ID_QC_FORM_FACTOR") },
	{ ID_QC_ARITH_SUM, _T("ID_QC_ARITH_SUM") },
	{ ID_QC_S0S1, _T("ID_QC_S0S1") },
	{ ID_QC_AVG_IMBAL, _T("ID_QC_AVG_IMBAL") },
	{ ID_QC_TOTAL_THD_RMS, _T("ID_QC_TOTAL_THD_RMS") },
	{ ID_QC_ODD_THD_RMS, _T("ID_QC_ODD_THD_RMS") },
	{ ID_QC_EVEN_THD_RMS, _T("ID_QC_EVEN_THD_RMS") },
	{ ID_QC_TID, _T("ID_QC_TID") },
	{ ID_QC_TID_RMS, _T("ID_QC_TID_RMS") },
	{ ID_QC_IHRMS, _T("ID_QC_IHRMS") },
	{ ID_QC_SPECTRA_HGROUP, _T("ID_QC_SPECTRA_HGROUP") },
	{ ID_QC_SPECTRA_IGROUP, _T("ID_QC_SPECTRA_IGROUP") },
	{ ID_QC_TIF, _T("ID_QC_TIF") },
	{ ID_QC_FLKR_MAG_AVG, _T("ID_QC_FLKR_MAG_AVG") },
	{ ID_QC_FLKR_FREQ_MAX, _T("ID_QC_FLKR_FREQ_MAX") },
	{ ID_QC_FLKR_MAG_MAX, _T("ID_QC_FLKR_MAG_MAX") },
	{ ID_QC_FLKR_WGT_AVG, _T("ID_QC_FLKR_WGT_AVG") },
	{ ID_QC_FLKR_SPECTRUM, _T("ID_QC_FLKR_SPECTRUM") },
	{ ID_QC_TIF_RMS, _T("ID_QC_TIF_RMS") },
	{ ID_QC_FLKR_PLTSLIDE, _T("ID_QC_FLKR_PLTSLIDE") },
	{ ID_QC_FLKR_PILPF, _T("ID_QC_FLKR_PILPF") },
	{ ID_QC_FLKR_PIMAX, _T("ID_QC_FLKR_PIMAX") },
	{ ID_QC_FLKR_PIROOT, _T("ID_QC_FLKR_PIROOT") },
	{ ID_QC_FLKR_PIROOTLPF, _T("ID_QC_FLKR_PIROOTLPF") },
	{ ID_QC_IT, _T("ID_QC_IT") },
	{ ID_QC_RMS_DEMAND, _T("ID_QC_RMS_DEMAND") },
	{ ID_QC_ANSI_TDF, _T("ID_QC_ANSI_TDF") },
	{ ID_QC_K_FACTOR, _T("ID_QC_K_FACTOR") },
	{ ID_QC_TDD, _T("ID_QC_TDD") },
	{ ID_QC_RMS_PEAK_DEMAND, _T("ID_QC_RMS_PEAK_DEMAND") },
	{ ID_QC_P_DEMAND, _T("ID_QC_P_DEMAND") },
	{ ID_QC_Q_DEMAND, _T("ID_QC_Q_DEMAND") },
	{ ID_QC_S_DEMAND, _T("ID_QC_S_DEMAND") },
	{ ID_QC_DF_DEMAND, _T("ID_QC_DF_DEMAND") },
	{ ID_QC_PF_DEMAND, _T("ID_QC_PF_DEMAND") },
	{ ID_QC_P_PRED_DEMAND, _T("ID_QC_P_PRED_DEMAND") },
	{ ID_QC_Q_PRED_DEMAND, _T("ID_QC_Q_PRED_DEMAND") },
	{ ID_QC_S_PRED_DEMAND, _T("ID_QC_S_PRED_DEMAND") },
	{ ID_QC_P_CO_Q_DEMAND, _T("ID_QC_P_CO_Q_DEMAND") },
	{ ID_QC_P_CO_S_DEMAND, _T("ID_QC_P_CO_S_DEMAND") },
	{ ID_QC_Q_CO_P_DEMAND, _T("ID_QC_Q_CO_P_DEMAND") },
	{ ID_QC_Q_CO_S_DEMAND, _T("ID_QC_Q_CO_S_DEMAND") },
	{ ID_QC_DF_CO_S_DEMAND, _T("ID_QC_DF_CO_S_DEMAND") },
	{ ID_QC_PF_CO_S_DEMAND, _T("ID_QC_PF_CO_S_DEMAND") },
	{ ID_QC_PF_CO_P_DEMAND, _T("ID_QC_PF_CO_P_DEMAND") },
	{ ID_QC_PF_CO_Q_DEMAND, _T("ID_QC_PF_CO_Q_DEMAND") },
	{ ID_QC_PF_VECTOR, _T("ID_QC_PF_VECTOR") },
	{ ID_QC_DF_VECTOR, _T("ID_QC_DF_VECTOR") },
	{ ID_QC_S_VECTOR, _T("ID_QC_S_VECTOR") },
	{ ID_QC_S_VECTOR_FUND, _T("ID_QC_S_VECTOR_FUND") },
	{ ID_QC_S_CO_P_DEMAND, _T("ID_QC_S_CO_P_DEMAND") },
	{ ID_QC_S_CO_Q_DEMAND, _T("ID_QC_S_CO_Q_DEMAND") },
	{ ID_QC_PF_ARITH, _T("ID_QC_PF_ARITH") },
	{ ID_QC_DF_ARITH, _T("ID_QC_DF_ARITH") },
	{ ID_QC_S_ARITH, _T("ID_QC_S_ARITH") },
	{ ID_QC_S_ARITH_FUND, _T("ID_QC_S_ARITH_FUND") },
	{ ID_QC_S_PEAK_DEMAND, _T("ID_QC_S_PEAK_DEMAND") },
	{ ID_QC_Q_PEAK_DEMAND, _T("ID_QC_Q_PEAK_DEMAND") },
	{ ID_QC_P_PEAK_DEMAND, _T("ID_QC_P_PEAK_DEMAND") },
	{ ID_QC_P_HARMONIC, _T("ID_QC_P_HARMONIC") },
	{ ID_QC_P_INTG, _T("ID_QC_P_INTG") },
	{ ID_QC_P_INTG_POS, _T("ID_QC_P_INTG_POS") },
	{ ID_QC_P_INTG_POS_FUND, _T("ID_QC_P_INTG_POS_FUND") },
	{ ID_QC_P_INTG_NEG, _T("ID_QC_P_INTG_NEG") },
	{ ID_QC_P_INTG_NEG_FUND, _T("ID_QC_P_INTG_NEG_FUND") },
	{ ID_QC_Q_INTG, _T("ID_QC_Q_INTG") },
	{ ID_QC_Q_INTG_POS, _T("ID_QC_Q_INTG_POS") },
	{ ID_QC_Q_INTG_POS_FUND, _T("ID_QC_Q_INTG_POS_FUND") },
	{ ID_QC_Q_INTG_NEG_FUND, _T("ID_QC_Q_INTG_NEG_FUND") },
	{ ID_QC_Q_INTG_NEG, _T("ID_QC_Q_INTG_NEG") },
	{ ID_QC_S_INTG, _T("ID_QC_S_INTG") },
	{ ID_QC_S_INTG_FUND, _T("ID_QC_S_INTG_FUND") },
	{ ID_QC_P_IVL_INTG, _T("ID_QC_P_IVL_INTG") },
	{ ID_QC_P_IVL_INTG_POS, _T("ID_QC_P_IVL_INTG_POS") },
	{ ID_QC_P_IVL_INTG_POS_FUND, _T("ID_QC_P_IVL_INTG_POS_FUND") },
	{ ID_QC_P_IVL_INTG_NEG, _T("ID_QC_P_IVL_INTG_NEG") },
	{ ID_QC_P_IVL_INTG_NEG_FUND, _T("ID_QC_P_IVL_INTG_NEG_FUND") },
	{ ID_QC_Q_IVL_INTG, _T("ID_QC_Q_IVL_INTG") },
	{ ID_QC_Q_IVL_INTG_POS, _T("ID_QC_Q_IVL_INTG_POS") },
	{ ID_QC_Q_IVL_INTG_POS_FUND, _T("ID_QC_Q_IVL_INTG_POS_FUND") },
	{ ID_QC_Q_IVL_INTG_NEG_FUND, _T("ID_QC_Q_IVL_INTG_NEG_FUND") },
	{ ID_QC_Q_IVL_INTG_NEG, _T("ID_QC_Q_IVL_INTG_NEG") },
	{ ID_QC_S_IVL_INTG, _T("ID_QC_S_IVL_INTG") },
	{ ID_QC_S_IVL_INTG_FUND, _T("ID_QC_S_IVL_INTG_FUND") },
	{ ID_QC_DAXISFIELD, _T("ID_QC_DAXISFIELD") },
	{ ID_QC_QAXIS, _T("ID_QC_QAXIS") },
	{ ID_QC_ROTATIONAL, _T("ID_QC_ROTATIONAL") },
	{ ID_QC_DAXIS, _T("ID_QC_DAXIS") },
	{ ID_QC_LINEAR, _T("ID_QC_LINEAR") },
	{ ID_QC_TRANSFERFUNC, _T("ID_QC_TRANSFERFUNC") },
	{ ID_QC_STATUS, _T("ID_QC_STATUS") },

//zhouhj 按照《电能质量数据交换格式规范》新增的GUID
	{ ID_QC_REACTANCE, _T("ID_QC_REACTANCE") },
	{ ID_QC_RESISTANCE, _T("ID_QC_RESISTANCE") },
	{ ID_QC_DVC, _T("ID_QC_DVC") }, 
	{ ID_QC_RVC, _T("ID_QC_RVC") },
	{ ID_QC_Q_HARMONIC, _T("ID_QC_Q_HARMONIC") },
	{ ID_QC_S_HARMONIC, _T("ID_QC_S_HARMONIC") },
	{ ID_QC_PF_HARMONIC, _T("ID_QC_PF_HARMONIC") },
	{ ID_QC_P_INTG_FUND, _T("ID_QC_P_INTG_FUND") },
	{ ID_QC_Q_INTG_FUND, _T("ID_QC_Q_INTG_FUND") },
	{ ID_QC_P_INTG_HARMONIC, _T("ID_QC_P_INTG_HARMONIC") },
	{ ID_QC_Q_INTG_HARMONIC, _T("ID_QC_Q_INTG_HARMONIC") },
	{ ID_QC_S_INTG_HARMONIC, _T("ID_QC_S_INTG_HARMONIC") },
	{ ID_QC_P_INTG_POS_HARMONIC, _T("ID_QC_P_INTG_POS_HARMONIC") },
	{ ID_QC_Q_INTG_POS_HARMONIC, _T("ID_QC_Q_INTG_POS_HARMONIC") },
	{ ID_QC_P_INTG_NEG_HARMONIC, _T("ID_QC_P_INTG_NEG_HARMONIC") },
	{ ID_QC_Q_INTG_NEG_HARMONIC, _T("ID_QC_Q_INTG_NEG_HARMONIC") },
	{ ID_QC_FLUKE_THD_INDUCTIVE, _T("ID_QC_FLUKE_THD_INDUCTIVE") },//zhouhj 20201201 根据Fluke表计新增
	{ ID_QC_FLUKE_THD_IHARM, _T("ID_QC_FLUKE_THD_IHARM") },//zhouhj 20201201 根据Fluke表计新增
	{ ID_QC_FLUKE_UI_CP, _T("ID_QC_FLUKE_UI_CP") },//zhouhj 20201201 根据Fluke表计新增
	{ ID_QC_FLUKE_UI_P, _T("ID_QC_FLUKE_UI_P") },//zhouhj 20201201 根据Fluke表计新增
	{ ID_QC_FLUKE_UI_Q, _T("ID_QC_FLUKE_UI_Q") },//zhouhj 20201201 根据Fluke表计新增
	{ ID_QC_FLUKE_IMBALANCE, _T("ID_QC_FLUKE_IMBALANCE") },//zhouhj 20201201 根据Fluke表计新增
	{ ID_EQUIP_QUALIMETRE, _T("ID_EQUIP_QUALIMETRE") },      //根据Fluke表计 新增的  zhouhj20201130

	{ ID_QC_NONE, _T("ID_QC_NONE") }
};

static STRUCT_GuidCString valCStr_valuetype[] =
{
	ID_SERIES_VALUE_TYPE_NONE, _T("ID_SERIES_VALUE_TYPE_NONE"), 
	ID_SERIES_VALUE_TYPE_VAL, _T("ID_SERIES_VALUE_TYPE_VAL"),  
	ID_SERIES_VALUE_TYPE_TIME, _T("ID_SERIES_VALUE_TYPE_TIME"),  
	ID_SERIES_VALUE_TYPE_MIN, _T("ID_SERIES_VALUE_TYPE_MIN"),  
	ID_SERIES_VALUE_TYPE_MAX, _T("ID_SERIES_VALUE_TYPE_MAX"),  
	ID_SERIES_VALUE_TYPE_AVG, _T("ID_SERIES_VALUE_TYPE_AVG"),  
	ID_SERIES_VALUE_TYPE_INST, _T("ID_SERIES_VALUE_TYPE_INST"), 
	ID_SERIES_VALUE_TYPE_PHASEANGLE, _T("ID_SERIES_VALUE_TYPE_PHASEANGLE"),  
	ID_SERIES_VALUE_TYPE_PHASEANGLE_MIN, _T("ID_SERIES_VALUE_TYPE_PHASEANGLE_MIN"),  
	ID_SERIES_VALUE_TYPE_PHASEANGLE_MAX, _T("ID_SERIES_VALUE_TYPE_PHASEANGLE_MAX"),  
	ID_SERIES_VALUE_TYPE_PHASEANGLE_AVG, _T("ID_SERIES_VALUE_TYPE_PHASEANGLE_AVG"), 
	ID_SERIES_VALUE_TYPE_AREA, _T("ID_SERIES_VALUE_TYPE_AREA"), 
	ID_SERIES_VALUE_TYPE_LATITUDE, _T("ID_SERIES_VALUE_TYPE_LATITUDE"), 
	ID_SERIES_VALUE_TYPE_DURATION, _T("ID_SERIES_VALUE_TYPE_DURATION"), 
	ID_SERIES_VALUE_TYPE_LONGITUDE, _T("ID_SERIES_VALUE_TYPE_LONGITUDE"), 
	ID_SERIES_VALUE_TYPE_POLARITY, _T("ID_SERIES_VALUE_TYPE_POLARITY"), 
	ID_SERIES_VALUE_TYPE_ELLIPSE, _T("ID_SERIES_VALUE_TYPE_ELLIPSE"), 
	ID_SERIES_VALUE_TYPE_BINID, _T("ID_SERIES_VALUE_TYPE_BINID"),  
	ID_SERIES_VALUE_TYPE_BINHIGH, _T("ID_SERIES_VALUE_TYPE_BINHIGH"), 
	ID_SERIES_VALUE_TYPE_BINLOW, _T("ID_SERIES_VALUE_TYPE_BINLOW"), 
	ID_SERIES_VALUE_TYPE_XBINHIGH, _T("ID_SERIES_VALUE_TYPE_XBINHIGH"), 
	ID_SERIES_VALUE_TYPE_XBINLOW, _T("ID_SERIES_VALUE_TYPE_XBINLOW"), 
	ID_SERIES_VALUE_TYPE_YBINHIGH, _T("ID_SERIES_VALUE_TYPE_YBINHIGH"), 
	ID_SERIES_VALUE_TYPE_YBINLOW, _T("ID_SERIES_VALUE_TYPE_YBINLOW"), 
	ID_SERIES_VALUE_TYPE_COUNT, _T("ID_SERIES_VALUE_TYPE_COUNT"), 
	ID_SERIES_VALUE_TYPE_TRANSITION, _T("ID_SERIES_VALUE_TYPE_TRANSITION"), 
	ID_SERIES_VALUE_TYPE_PROB, _T("ID_SERIES_VALUE_TYPE_PROB"), 
	ID_SERIES_VALUE_TYPE_INTERVAL, _T("ID_SERIES_VALUE_TYPE_INTERVAL"), 
	ID_SERIES_VALUE_TYPE_STATUS, _T("ID_SERIES_VALUE_TYPE_STATUS"), 
	ID_SERIES_VALUE_TYPE_P1, _T("ID_SERIES_VALUE_TYPE_P1"), 
	ID_SERIES_VALUE_TYPE_P5, _T("ID_SERIES_VALUE_TYPE_P5"), 
	ID_SERIES_VALUE_TYPE_P10, _T("ID_SERIES_VALUE_TYPE_P10"), 
	ID_SERIES_VALUE_TYPE_P90, _T("ID_SERIES_VALUE_TYPE_P90"), 
	ID_SERIES_VALUE_TYPE_P95, _T("ID_SERIES_VALUE_TYPE_P95"), 
	ID_SERIES_VALUE_TYPE_P99, _T("ID_SERIES_VALUE_TYPE_P99"), 
	ID_SERIES_VALUE_TYPE_FREQUENCY, _T("ID_SERIES_VALUE_TYPE_FREQUENCY"),

	ID_SERIES_VALUE_TYPE_QUALITY, _T("ID_SERIES_VALUE_TYPE_QUALITY"),//zhouhj 20180928 按联研院最新标准扩充
	ID_SERIES_VALUE_TYPE_FLUKE, _T("ID_SERIES_VALUE_TYPE_FLUKE")////zhouhj 20201126 按Fluke的PQDIF文件扩充
};

static UINT4 get_TagPhaseID_From_Str(const CString &str)
{
	size_t size = sizeof(valCstr_phase) / sizeof(STRUCT_ValueCString);

	for ( size_t i = 0; i < size; ++i )
	{
		if ( str == valCstr_phase[i].cstr )
		{
			return valCstr_phase[i].value;
		}
	}

	return ID_PHASE_NONE;
}

static UINT4 get_TagQuantityMeasuredID_From_Str ( const CString &str )
{
	size_t size = sizeof(valCStr_measured) / sizeof(STRUCT_ValueCString);

	for ( size_t i = 0; i < size; ++i )
	{
		if ( str == valCStr_measured[i].cstr )
		{
			return valCStr_measured[i].value;
		}
	}
...
static UINT4 get_TagQuantityUnitsID_From_Str ( const CString &str ) 
{
	size_t size = sizeof(valCStr_unit/*valCStr_characteristic*/) / sizeof(STRUCT_ValueCString);//zhouhj 20201130 两者数量对不上，故修改

	for ( size_t i = 0; i < size; ++i )
	{
		if ( str == valCStr_unit[i].cstr )
		{
			return valCStr_unit[i].value;
		}
	}
...
static GUID get_TagQuantityCharacteristicID_From_Str ( const CString &str )
{
	size_t size = sizeof(valCStr_characteristic) / sizeof(STRUCT_GuidCString);

	for ( size_t i = 0; i < size; ++i )
	{
		if ( str == valCStr_characteristic[i].cstr )
		{
			return valCStr_characteristic[i].value;
		}
	}
...
static GUID get_TagValueTypeID_From_Str ( const CString &str )
{
	size_t size = sizeof(valCStr_valuetype) / sizeof(STRUCT_GuidCString);

	for( size_t i = 0; i < size; ++i )
	{
		if( str == valCStr_valuetype[i].cstr )
		{
			return valCStr_valuetype[i].value;
		}
	}

	return ID_SERIES_VALUE_TYPE_NONE;
}

static CString get_Str_From_TagPhaseID( const UINT4 tagPhaseID )
{
	size_t size = sizeof(valCstr_phase) / sizeof(STRUCT_ValueCString);

	for ( size_t i = 0; i < size; ++i )
	{
		if( tagPhaseID == valCstr_phase[i].value )
		{
			return valCstr_phase[i].cstr;
		}
	}
...
static CString get_Str_From_TagQuantityMeasuredID( const UINT4 tagQuantityMeasuredID )
{
	size_t size = sizeof(valCStr_measured) / sizeof(STRUCT_ValueCString);

	for ( size_t i = 0; i < size; ++i )
	{
		if ( tagQuantityMeasuredID == valCStr_measured[i].value )
		{
			return valCStr_measured[i].cstr;
		}
	}
...
static CString get_Str_From_TagQuantityUnitsID( const UINT4 tagQuantityUnitsID )
{
	size_t size = sizeof(valCStr_characteristic) / sizeof(STRUCT_ValueCString);

	for ( size_t i = 0; i < size; ++i )
	{
		if ( tagQuantityUnitsID == valCStr_unit[i].value )
		{
			return valCStr_unit[i].cstr;
		}
	}
...
static CString get_Str_From_TagQuantityCharacteristicID( const GUID tagQuantityCharacteristicID )
{
	size_t size = sizeof(valCStr_characteristic) / sizeof(STRUCT_GuidCString);

	for ( size_t i = 0; i < size; ++i )
	{
		if ( tagQuantityCharacteristicID == valCStr_characteristic[i].value )
		{
			return valCStr_characteristic[i].cstr;
		}
	}
...
static CString get_Str_From_TagValueTypeID( const GUID tagValueTypeID )
{
	size_t size = sizeof(valCStr_valuetype) / sizeof(STRUCT_GuidCString);

	for( size_t i = 0; i < size; ++i )
	{
		if( tagValueTypeID == valCStr_valuetype[i].value )
		{
			return valCStr_valuetype[i].cstr;
		}
	}
...
/*
static GUID get_tagQuantityTypeID_FromStr ( const CString &str ) // ID_QT_VALUELOG ID_QT_WAVEFORM
{
// 	char pszBuffer[MAX_PATH];
// 	CString_to_char(str, pszBuffer);

	// 	if ( ! str )
	// 	{
	// 		CLogPrint::LogFormatString(XLOGLEVEL_TRACE,  "tagQuantityTypeID string NULL \n" );
	// 		return ID_QT_NONE; 
	// 	}

	if ( (str == STR(ID_QT_VALUELOG) ) )
	{
		return ID_QT_VALUELOG;
	}
	else if ( (str == STR(ID_QT_WAVEFORM) ) )
	{
		return ID_QT_WAVEFORM;
	}
	else if ( (str == STR(ID_QT_PHASOR) ) )
	{
		return ID_QT_PHASOR;
	}
	else if ( (str == STR(ID_QT_RESPONSE) ) )
	{
		return ID_QT_RESPONSE;
	}
	else if ( (str == STR(ID_QT_FLASH) ) )
	{
		return ID_QT_FLASH;
	}
	else if ( (str == STR(ID_QT_HISTOGRAM) ) )
	{
		return ID_QT_HISTOGRAM;
	}
	else if ( (str == STR(ID_QT_HISTOGRAM3D) ) )
	{
		return ID_QT_HISTOGRAM3D;
	}
	else if ( (str == STR(ID_QT_CPF) ) )
	{
		return ID_QT_CPF;
	}
	else if ( (str == STR(ID_QT_XY) ) )
	{
		return ID_QT_XY;
	}
	else if ( (str == STR(ID_QT_MAGDUR) ) )
	{
		return ID_QT_MAGDUR;
	}
	else if ( (str == STR(ID_QT_XYZ) ) )
	{
		return ID_QT_XYZ;
	}
	else if ( (str == STR(ID_QT_MAGDURTIME) ) )
	{
		return ID_QT_MAGDURTIME;
	}
	else if ( (str == STR(ID_QT_MAGDURCOUNT) ) )
	{
		return ID_QT_MAGDURCOUNT;
	}

	return ID_QT_NONE; // ID_QT_NONE 是自定义的,头文件中原本没有
}

// ID_SERIES_METHOD_VALUES 0x1 ID_SERIES_METHOD_SCALED 0x2 ID_SERIES_METHOD_INCREMENT 0x4
static UINT4 get_tagStorageMethodID_FromStr ( const CString &str )
{
	// 	if ( ! str )
	// 	{
	// 		CLogPrint::LogFormatString(XLOGLEVEL_TRACE,  "tagStorageMethodID string NULL \n" );
	// 		return 0x0; 
	// 	}
...
// 	CString_to_char(str, pszBuffer);
	...
	if ( (str == STR(ID_SERIES_METHOD_VALUES|ID_SERIES_METHOD_SCALED) ) )
	{
		return (ID_SERIES_METHOD_VALUES|ID_SERIES_METHOD_SCALED);
	}
	else if ( (str == STR(ID_SERIES_METHOD_VALUES|ID_SERIES_METHOD_INCREMENT) ) )
	{
		return (ID_SERIES_METHOD_VALUES|ID_SERIES_METHOD_INCREMENT);
	}
	else if ( (str == STR(ID_SERIES_METHOD_VALUES|ID_SERIES_METHOD_INCREMENT) ) )
	{
		return (ID_SERIES_METHOD_VALUES|ID_SERIES_METHOD_INCREMENT);
	}
	else if ( (str == STR(ID_SERIES_METHOD_VALUES) ) )
	{
		return ID_SERIES_METHOD_VALUES;
	}
	else if ( (str == STR(ID_SERIES_METHOD_SCALED) ) )
	{
		return ID_SERIES_METHOD_SCALED;
	}
	else if ( (str == STR(ID_SERIES_METHOD_INCREMENT) ) )
	{
		return ID_SERIES_METHOD_INCREMENT;
	}
...
// ID_GREEK_DONTCARE
static UINT4 get_tagHintGreekPrefixID_FromStr ( const CString &str )
{
	// 	if ( ! str )
	// 	{
	// 		CLogPrint::LogFormatString(XLOGLEVEL_TRACE,  "tagHintGreekPrefixID string NULL \n" );
	// 		return 0xFFFF; 
	// 	}
...
// 	CString_to_char(str, pszBuffer);
	...
	if ( (str == STR(ID_GREEK_DONTCARE) ) )
	{
		return ID_GREEK_DONTCARE;
	}
	else if ( (str == STR(ID_GREEK_FEMTO) ) )
	{
		return ID_GREEK_FEMTO;
	}
	else if ( (str == STR(ID_GREEK_PICO) ) )
	{
		return ID_GREEK_PICO;
	}
	else if ( (str == STR(ID_GREEK_NANO) ) )
	{
		return ID_GREEK_NANO;
	}
	else if ( (str == STR(ID_GREEK_MICRO) ) )
	{
		return ID_GREEK_MICRO;
	}
	else if ( (str == STR(ID_GREEK_MILLI) ) )
	{
		return ID_GREEK_MILLI;
	}
	else if ( (str == STR(ID_GREEK_NONE) ) )
	{
		return ID_GREEK_NONE;
	}
	else if ( (str == STR(ID_GREEK_KILO) ) )
	{
		return ID_GREEK_KILO;
	}
	else if ( (str == STR(ID_GREEK_MEGA) ) )
	{
		return ID_GREEK_MEGA;
	}
	else if ( (str == STR(ID_GREEK_TERA) ) )
	{
		return ID_GREEK_TERA;
	}
	else if ( (str == STR(ID_GREEK_GIGA) ) )
	{
		return ID_GREEK_GIGA;
	}
