...
protected:
	void Init(ENUM_KEYSIZE keysize, BYTE *key);
	void Init();
...
public:  
	...
	*/ 
	...
	CXAes( ENUM_KEYSIZE keysize, BYTE *key );  
	CXAes(  );  
	...
	*/  
	...
	CString Cipher(const CString &strSrc);
	...
	*/  
	...
	CString InvCipher(const CString &strSrc);
...
protected:  
	...
	*/  
	...
	BYTE4 m_pTransBuffer[1024];  
	LPBYTE State[4];  

	static BYTE g_pAesBuffer[1024];
};  
