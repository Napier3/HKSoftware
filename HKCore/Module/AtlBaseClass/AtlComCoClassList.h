// AtlComCoClassList.h: interface for the CAtlComCoClassListt class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(_ATLCOMCOCLASSLIST_H__)
...
public:
	...
	// Construction
	CAtlComCoClassList(int nBlockSize = 10)
	{
		m_nCount = 0;
	...
	void AddTail(T* newElement, BOOL bAddRef=TRUE)
	{
...
template <class T>
inline typename CAtlComCoClassList<T>::CComCoClassNode* CAtlComCoClassList<T>::NewNode(CComCoClassNode* pPrev, CComCoClassNode* pNext)
{
	if (m_pNodeFree == NULL)
	{
		// add another block
...
template <class T>
inline void CAtlComCoClassList<T>::FreeNode(CComCoClassNode* pNode)
{
