...
CXmlRWDocBase* CXmlRWFactory::CreateXmlRWDoc(long nType)
{
	...
	if (g_pXmlRWFactory != NULL)
	{
		pRWDocBase = g_pXmlRWFactory->I_CreateXmlRWDoc(nType);
...
CXmlRWFactory* CXmlRWFactory::g_pXmlRWFactory = NULL;

void CXmlRWFactory::CreateXmlRWFactory(CXmlRWFactory *pXmlRWFactory)
{
	g_pXmlRWFactory = pXmlRWFactory;
}

CXmlRWDocBase* CXmlRWFactory::I_CreateXmlRWDoc(long nType)
{
	CXmlRWDocBase *pRWDocBase = NULL;
