...
BOOL CXmlRWNodeBase::xml_SetElementOwnText(const BSTR strAttrName, CXmlRWDocBase *pXMLDoc, const CString &strAttrVal)
{
	return FALSE;
}
...
long CXmlRWDocBase::GetXml(char **ppszRetBuffer, long nOffset, bool bUtf8)
{
	ASSERT(FALSE);
	return 0;
}
