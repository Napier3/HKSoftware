...
void CXRecordDrawComtradeDib::ComtradeDib()
{
	...
	//2024-10-18  lijunqing 分配和实际波形数据大小一样的绘图空间
	InitDrawPoints(nTotalPoints+10);

	MrDraw::InitDrawBuffPos(&m_oDrawBufferPos);
	//m_oDrawBufferPos.nGap = nTotalPoints / AnalyseWnd_MaxDrawlength;
	//2024-10-18  lijunqing 分配和实际波形数据大小一样的绘图空间  所以间隔永远等于1
	m_oDrawBufferPos.nGap = 1;//nTotalPoints / AnalyseWnd_MaxDrawlength;
