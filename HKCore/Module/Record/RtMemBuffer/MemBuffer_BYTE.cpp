// MemBuffer_BYTE.cpp: implementation of the CMemBuffer_BYTE class.
//
//////////////////////////////////////////////////////////////////////

#include "stdafx.h"
#include "MemBuffer_BYTE.h"
...
CMemBuffer_BYTE::CMemBuffer_BYTE()
{
	m_nBufferLength		= 0;	
...
long CMemBuffer_BYTE::CopyBuffer(CMemBufferInterface *pBuffer, long &lCopyBeginPos, long lGap)
{
	ASSERT (FALSE);
	return 0;
}

void CMemBuffer_BYTE::SetBufferLength(long lBufferLen)
{
	FreeBuffer();
...
void CMemBuffer_BYTE::AttachBuffer(long *pBuffer, long lLen)
{
	FreeBuffer();
	m_pBuffer = pBuffer;
...
void CMemBuffer_BYTE::AttachBuffer(CMemBuffer_BYTE *pBuffer)
{
	FreeBuffer();
...
long CMemBuffer_BYTE::CopyBuffer(long *pBuffer, long lLen, long lGap)
{
	long lPos1Begin = -1;
	long lPos1End = -1;
	long lPos2Begin = -1;
...
long CMemBuffer_BYTE::CopyBuffer(CMemBuffer_BYTE *pBuffer, long &lCopyBeginPos, long lGap)
{
	{
...
// long CMemBuffer_BYTE::CopyBuffer(long lLen, long lGap, BOOL bOffsetBuffer, long &lPos1Begin, long &lPos1End, long &lPos2Begin, long &lPos2End)
// {
...
long CMemBuffer_BYTE::CopyBufferByPos(long *pBuffer, long lBeginPos, long lEndPos, long lGap)
{
...
long CMemBuffer_BYTE::AddValue(long *pValue)
{
...
long CMemBuffer_BYTE::AddValue(long nValue)
{
...
void CMemBuffer_BYTE::FreeBuffer()
{
	if (m_pBuffer!= NULL)
	{
		delete m_pBuffer;
...
void CMemBuffer_BYTE::LOG_ShowBuffer(BOOL bShowTitle)
{
	long nIndex = 0;
	CString strTemp;
	CString strData;
...
//////////////////////////////////////////////////////////////////////////
/*
CComplexMemBuffer_BYTE::CComplexMemBuffer_BYTE()
{
	m_pScript = NULL;
...
BOOL CComplexMemBuffer_BYTE::ExecScript(long nPos1Begin, long nPos1End, long nPos2Begin, long nPos2End)
{
	short nVal = 0;
	long nIndex = 0;
...
void CComplexMemBuffer_BYTE::CreateScript()
{
