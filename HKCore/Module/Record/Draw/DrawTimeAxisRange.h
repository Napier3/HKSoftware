...
extern long TIMEAXIS_RANGESTATEAXIS_HEIGHT;// (RANGESTATEAXIS_BLOCK_WIDTH+4)
...
public:
	...
	void SetTimeRange(double dMin, double dMax);
	void GetAxisRange(double &dCoefLeft, double &dCoefRight);
