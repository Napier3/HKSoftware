...
public:
	...
	//得到或者设置触发电平
	double GetTrigElectricValue()							{	return m_dTrigElectricValue;	}
	void SetTrigElectricValue(double dValue)				{	m_dTrigElectricValue = dValue;	g_oMR1200SysAnalyseMngr.dTrigElectricValue = dValue;}
public:
	CDrawTrigCursor();
