...
typedef CTLinkList<CParaSortObject> CParaSortObjectList;

class CParaSortGroup: public CParaSortObject, public CParaSortObjectList
{
public:
	virtual BOOL IsParaSortObject()									{	return FALSE;									}
	virtual void AddTail(CParaSortGroup *pGroup);		
	virtual void AddTail(CParaSortObject *pData);	
...
{
public:
	CParaSortMngr(CXDrawElements *pDrawVariables, const CRect &rcClip );
