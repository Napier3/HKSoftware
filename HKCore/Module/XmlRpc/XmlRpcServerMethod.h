...
# include <string>
#endif
#include "XmlRpcServerConnection.h"//zhangsen 20170402
namespace XmlRpc {
  ...
  public:
    ...
    virtual void execute(XmlRpcValue& params, XmlRpcValue& result, const XmlRpcServerConnection* context) = 0;//zhangsen 20170402
