...
namespace XmlRpc {
  ...
  public:
	...
	std::string* get_string()   { assertTypeOrInvalid(TypeString); return _value.asString; }
	BOOL get_bool()   { assertTypeOrInvalid(TypeBoolean); return _value.asBool; }
	...
	//2018-10-5  lijq
	void SetBinaryData(void* value, int nBytes)
	{
		invalidate();
		_type = TypeBase64;
		_value.asBinary = new BinaryData((char*)value, ((char*)value)+nBytes);
