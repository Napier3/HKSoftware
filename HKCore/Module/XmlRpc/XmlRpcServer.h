...
namespace XmlRpc {
  ...
  public:
    ...
    bool bindAndListen(char *pszIP, int port, int backlog = 5);
...
#ifdef _use_XmlRpcServerClient_
	//lijunqing 2019-4-30   
	XmlRpcServerClientList listServerClient;
	CWnd * m_pMsgWnd;

  public:
	void SetMsgWnd(CWnd *pWnd)	{	m_pMsgWnd = pWnd;	}
	void CloseServerClient(XmlRpcServerClient *pServerClient);
	void CloseServerClient(int nSocket);
#endif
  };
} // namespace XmlRpc
