...
namespace MSVisio
{
	...
	public:
		...
		LPDISPATCH AddItem(VARIANT* Template);
		LPDISPATCH AddEx(VARIANT* Template,VisMeasurementSystem MeasuremntSystem = visMSDefault,long nFlags = 0,long nLangID = 0);//zhouhj 20200811
		LPDISPATCH Open(VARIANT* FileName);
	};
	/////////////////////////////////////////////////////////////////////////////
	...
	public:
		...
		LPDISPATCH GetView();
		LPDISPATCH GetPage();  //zhouhj 20200813
		long GetType();
		LPDISPATCH GetNext();
