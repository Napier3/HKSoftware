...
namespace MSVisio
{
	...
	LPDISPATCH Documents::AddItem(VARIANT* Template)
	{
		LPDISPATCH result;
		static BYTE parms[] =
			VTS_PVARIANT;
	...
	LPDISPATCH Documents::AddEx(VARIANT* Template,VisMeasurementSystem MeasuremntSystem,long nFlags,long nLangID)
	{
		LPDISPATCH result;
		static BYTE parms[] =
			VTS_PVARIANT VTS_PI4 VTS_PI4 VTS_PI4;
		InvokeHelper(0x6002000e, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms,
			Template,&MeasuremntSystem,&nFlags,&nLangID);
		return result;
	}
