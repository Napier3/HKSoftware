...
#pragma once
#endif // _MSC_VER > 1000
// TitleTipWnd.h : header file
//

#define TITLETIPWND_CLASSNAME _T("_TitleTipWnd_")
#include "..\Api\GloblaDrawFunctions.h"

/////////////////////////////////////////////////////////////////////////////
// CTitleTipWnd window

class CTitleTipWnd : public CWnd
{
// Construction
public:
	CTitleTipWnd();
...
// Implementation
public:
	virtual ~CTitleTipWnd();

	// Generated message map functions
protected:
	//{{AFX_MSG(CTitleTipWnd)
