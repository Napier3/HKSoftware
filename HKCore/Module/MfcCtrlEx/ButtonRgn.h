...
class CButtonRgn : public CButton
{
public:
    CButtonRgn();
	~CButtonRgn();
	...
	enum	{	ST_BITMAP_POS_LEFT	= 0,	
		ST_BITMAP_POS_TOP,
		ST_BITMAP_POS_RIGHT,
		ST_BITMAP_POS_BOTTOM
	};

	// ClassWizard generated virtual function overrides
    //{{AFX_VIRTUAL(CButtonRgn)
	public:
...
public:
	void SetBtnTextColor(COLORREF rcText = 0xFFFFFFFF)	;
	...
	void SetBitmapsPos_Top();
	void SetBitmapsPos_Left();
...
private:
	COLORREF GetTextColor(COLORREF rcText);
	...
	void PrepareImageRect_Horz(BOOL bHasTitle, RECT* rpItem, CRect* rpTitle, BOOL bIsPressed, DWORD dwWidth, DWORD dwHeight, CRect* rpImage);
	void PrepareImageRect_Vert(BOOL bHasTitle, RECT* rpItem, CRect* rpTitle, BOOL bIsPressed, DWORD dwWidth, DWORD dwHeight, CRect* rpImage);
...
#pragma pack()
	...
	long m_nBitmapsPos;  //0=left  1=top 2=bottom 3=right
