...
// set colors if item is selected
	...
	{
		clrTextSave = pDC->SetTextColor(RGB(168,168,168));
		clrBkSave = pDC->SetBkColor(RGB(192,192,192));
	}
...
void CListCtrlEx::OnPaint() 
{
		...
		GetFullRowSel())
	{
		...
		if(rcAllLabels.right < m_cxClient)
		{
			...
			rcClip.left = rcAllLabels.right-1;
			if(rcClip.left>rcClip.left)rcClip.left=rcClip.left;
