...
/////////////////////////////////////////////////////////////////////////////
// _Windows_old properties

/////////////////////////////////////////////////////////////////////////////
// _Windows_old operations

LPDISPATCH _Windows_old::GetVbe()
{
	LPDISPATCH result;
	InvokeHelper(0x1, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
LPDISPATCH _Windows_old::GetParent()
{
	LPDISPATCH result;
	InvokeHelper(0x2, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
LPDISPATCH _Windows_old::Item(const VARIANT& index)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_VARIANT;
...
LPDISPATCH _Windows::CreateToolWindow(LPDISPATCH AddInInst, LPCTSTR ProgId, LPCTSTR Caption, LPCTSTR GuidPosition, LPDISPATCH* DocObj)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_DISPATCH VTS_BSTR VTS_BSTR VTS_BSTR VTS_PDISPATCH;
	InvokeHelper(0x12c, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms,
		AddInInst, ProgId, Caption, GuidPosition, DocObj);
	return result;
}
...
/////////////////////////////////////////////////////////////////////////////
// _VBProject_Old properties

/////////////////////////////////////////////////////////////////////////////
// _VBProject_Old operations

CString _VBProject_Old::GetHelpFile()
{
	CString result;
...
void _VBProject_Old::SetHelpFile(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
...
long _VBProject_Old::GetHelpContextID()
{
	long result;
...
void _VBProject_Old::SetHelpContextID(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CString _VBProject_Old::GetDescription()
{
	CString result;
...
void _VBProject_Old::SetDescription(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
...
LPDISPATCH _VBProject_Old::GetReferences()
{
	LPDISPATCH result;
...
CString _VBProject_Old::GetName()
{
	CString result;
...
void _VBProject_Old::SetName(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
...
LPDISPATCH _VBProject_Old::GetVbe()
{
	LPDISPATCH result;
...
LPDISPATCH _VBProject_Old::GetCollection()
{
	LPDISPATCH result;
...
long _VBProject_Old::GetProtection()
{
	long result;
...
LPDISPATCH _VBProject_Old::GetVBComponents()
{
	LPDISPATCH result;
...
void _VBProject::SaveAs(LPCTSTR FileName)
{
	static BYTE parms[] =
		VTS_BSTR;
...
void _VBProject::MakeCompiledFile()
{
	InvokeHelper(0x8b, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

long _VBProject::GetType()
{
	long result;
...
CString _VBProject::GetFileName()
{
	CString result;
...
CString _VBProject::GetBuildFileName()
{
	CString result;
...
void _VBProject::SetBuildFileName(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
...
/////////////////////////////////////////////////////////////////////////////
// _VBProjects_Old properties

/////////////////////////////////////////////////////////////////////////////
// _VBProjects_Old operations

LPDISPATCH _VBProjects_Old::Item(const VARIANT& index)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_VARIANT;
...
LPDISPATCH _VBProjects_Old::GetVbe()
{
	LPDISPATCH result;
...
LPDISPATCH _VBProjects_Old::GetParent()
{
	LPDISPATCH result;
	InvokeHelper(0x2, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
LPDISPATCH _VBProjects::Add(long Type)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_I4;
...
void _VBProjects::Remove(LPDISPATCH lpc)
{
	static BYTE parms[] =
		VTS_DISPATCH;
	InvokeHelper(0x8a, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
...
LPDISPATCH _VBProjects::Open(LPCTSTR bstrPath)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_BSTR;
	InvokeHelper(0x8b, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms,
		bstrPath);
	return result;
}
...
/////////////////////////////////////////////////////////////////////////////
// _VBComponents_Old properties

/////////////////////////////////////////////////////////////////////////////
// _VBComponents_Old operations

LPDISPATCH _VBComponents_Old::Item(const VARIANT& index)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_VARIANT;
...
LPDISPATCH _VBComponents_Old::GetParent()
{
	LPDISPATCH result;
	InvokeHelper(0x2, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
long _VBComponents_Old::GetCount()
{
	long result;
	InvokeHelper(0xa, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
	return result;
...
void _VBComponents_Old::Remove(LPDISPATCH VBComponent)
{
	static BYTE parms[] =
		VTS_DISPATCH;
	InvokeHelper(0xb, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
...
LPDISPATCH _VBComponents_Old::Add(long ComponentType)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_I4;
...
LPDISPATCH _VBComponents_Old::Import(LPCTSTR FileName)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_BSTR;
...
LPDISPATCH _VBComponents_Old::GetVbe()
{
	LPDISPATCH result;
	InvokeHelper(0x14, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
LPDISPATCH _VBComponents::AddCustom(LPCTSTR ProgId)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_BSTR;
...
/////////////////////////////////////////////////////////////////////////////
// _VBComponent_Old properties

/////////////////////////////////////////////////////////////////////////////
// _VBComponent_Old operations

BOOL _VBComponent_Old::GetSaved()
{
	BOOL result;
	InvokeHelper(0xa, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
	return result;
...
CString _VBComponent_Old::GetName()
{
	CString result;
	InvokeHelper(0x30, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, NULL);
	return result;
...
void _VBComponent_Old::SetName(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
	InvokeHelper(0x30, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
LPDISPATCH _VBComponent_Old::GetDesigner()
{
	LPDISPATCH result;
...
LPDISPATCH _VBComponent_Old::GetCodeModule()
{
	LPDISPATCH result;
...
void _VBComponent_Old::Export(LPCTSTR FileName)
{
	static BYTE parms[] =
		VTS_BSTR;
...
LPDISPATCH _VBComponent_Old::GetVbe()
{
	LPDISPATCH result;
...
LPDISPATCH _VBComponent_Old::GetCollection()
{
	LPDISPATCH result;
...
BOOL _VBComponent_Old::GetHasOpenDesigner()
{
	BOOL result;
...
LPDISPATCH _VBComponent_Old::GetProperties()
{
	LPDISPATCH result;
...
LPDISPATCH _VBComponent_Old::DesignerWindow()
{
	LPDISPATCH result;
...
void _VBComponent_Old::Activate()
{
...
CString _VBComponent::GetDesignerID()
{
	CString result;
...
LPDISPATCH _AddIns::Item(const VARIANT& index)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_VARIANT;
...
void AddIn::SetDescription(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
	InvokeHelper(0x0, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
LPDISPATCH AddIn::GetCollection()
{
	LPDISPATCH result;
	InvokeHelper(0x2, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
void AddIn::SetConnect(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void AddIn::SetObject(LPDISPATCH newValue)
{
	static BYTE parms[] =
		VTS_DISPATCH;
