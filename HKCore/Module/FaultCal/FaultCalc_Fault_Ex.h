...
class CFaultCalc_Fault_Ex :
	public FaultCalc_Fault_Ex
{
public:

	CFaultCalc_Fault_Ex(void)
	{
		InitStruct();
	}
	~CFaultCalc_Fault_Ex(void)
...
public:
	...
	//结构体初始化
	void InitStruct(FaultCalc_Fault_Ex *pSrc=NULL)
	{
		int i;
	...
	//结构体复制
	void CopyStructTo(FaultCalc_Fault_Ex *pDst)
	{
		CopyStruct(this,pDst);
	}

	//结构体复制
	void CopyStruct(FaultCalc_Fault_Ex *pSrc, FaultCalc_Fault_Ex *pDst)
	{
		pDst=pSrc;
	}
