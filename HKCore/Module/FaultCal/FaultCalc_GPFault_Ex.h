...
class CFaultCalc_GPFault_Ex :
	public FaultCalc_GPFault_Ex
{
public:

	CFaultCalc_GPFault_Ex(void)
	{
		InitStruct();
	}
	~CFaultCalc_GPFault_Ex(void)
...
public:
	...
	//结构体初始化
	void InitStruct(FaultCalc_GPFault_Ex *pSrc=NULL)
	{
		int i;
	...
	//结构体复制
	void CopyStructTo(FaultCalc_GPFault_Ex *pDst)
	{
		CopyStruct(this,pDst);
	}

	//结构体复制
	void CopyStruct(FaultCalc_GPFault_Ex *pSrc, FaultCalc_GPFault_Ex *pDst)
	{
		pDst=pSrc;
	}
