...
class CFaultCalc_Shot :
	public FaultCalc_Shot
{
public:

	CFaultCalc_Shot(void)
	{
		InitStruct();
	}
	~CFaultCalc_Shot(void)
...
public:
	...
	//结构体初始化
	void InitStruct(FaultCalc_Shot *pSrc=NULL)
	{
		int i;
	...
	//结构体复制
	void CopyStructTo(FaultCalc_Shot *pDst)
	{
		CopyStruct(this,pDst);
	}

	//结构体复制
	void CopyStruct(FaultCalc_Shot *pSrc, FaultCalc_Shot *pDst)
	{
		pDst=pSrc;
	}
