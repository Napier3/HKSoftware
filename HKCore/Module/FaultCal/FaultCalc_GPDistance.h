...
class CFaultCalc_GPDistance :
	public FaultCalc_GPDistance
{
public:

	CFaultCalc_GPDistance(void)
	{
		InitStruct();
	}
	~CFaultCalc_GPDistance(void)
...
public:
	...
	//结构体初始化
	void InitStruct(FaultCalc_GPDistance *pSrc=NULL)
	{
		int i;
	...
	//结构体复制
	void CopyStructTo(FaultCalc_GPDistance *pDst)
	{
		CopyStruct(this,pDst);
	}

	//结构体复制
	void CopyStruct(FaultCalc_GPDistance *pSrc, FaultCalc_GPDistance *pDst)
	{
		pDst=pSrc;
	}
