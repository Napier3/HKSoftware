...
//////////////////////////////////////////////////////////////////////////
//
CEp101Frame_68_Asdu1E::CEp101Frame_68_Asdu1E(CEpFrameBase *pHead, CEpFrameBase *pTail)
		:CEp101Frame_68_AsduBase(pHead, pTail)
{
	m_strID = _T("101_ASDU_1E");
	m_strName = m_strID;
}

CEp101Frame_68_Asdu1E::~CEp101Frame_68_Asdu1E()
{

}

DWORD CEp101Frame_68_Asdu1E::ParseOwn(PEPBUFFERPOS pBufferPos, CExBaseList *pDetailList)
{
...
BOOL CEp101Frame_68_Asdu1E::Match(PEPBUFFERPOS pBufferPos)
{
...
DWORD CEp101Frame_68_Asdu1E::Produce(PEPBUFFERPOS pBufferPos)
{
	return 0;
}
