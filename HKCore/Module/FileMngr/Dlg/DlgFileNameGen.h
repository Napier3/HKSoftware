...
class CDlgFileNameGen : public CDynDialogEx
{
	DECLARE_DYNAMIC(CDlgFileNameGen)

public:
	CDlgFileNameGen(const CString &strNameGenConfigFile,CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDlgFileNameGen();
