...
# possible.  								 #
#									 #
# To make the 'ositp4e_l.a' library:					 #
# 	make -f ositp4e.mak         DFLAG=_l   DEFS=-DDEBUG_SISCO	 #
# To make the 'ositp4e_n.a' library:					 #
# 	make -f ositp4e.mak   	    DFLAG=_n				 #
# To make the 'ositp4e_ld.a' library:					 #
# 	make -f ositp4e.mak  OPT=-g DFLAG=_ld  DEFS=-DDEBUG_SISCO	 #
# To make the 'ositp4e_nd.a' library:					 #
# 	make -f ositp4e.mak  OPT=-g DFLAG=_nd				 #
#								   	 #
# MODIFICATION LOG :	       						 #
...
ALL_CFLAGS = $(PLATFORM_CFLAGS) \
	$(OPT) -I$(INCDIR) \
	$(DEFS) -DMMS_LITE -DLEAN_T -DMOSI -DTP4_ENABLED \
	$(CFLAGS)
