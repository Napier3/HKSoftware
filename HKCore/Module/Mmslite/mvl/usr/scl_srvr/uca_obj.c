...
/*  This file created from input file '..\..\mvl\usr\scl_srvr\uca_obj.odf'
	...
	Created Sat Apr 21 19:13:46 2012
*/
...
MVLU_RD_FUN_INFO mvluRdFunInfoTbl[] =
  {
    ...
    {_MVLU_LEAF_FUN_INIT (mvlu_rptena_rd_ind_fun)},	/* 3=MVLU_RPTENA_RD_IND_FUN_INDEX	*/
    {_MVLU_LEAF_FUN_INIT (mvlu_rptid_rd_ind_fun)},	/* 4=MVLU_RPTID_RD_IND_FUN_INDEX	*/
    {_MVLU_LEAF_FUN_INIT (mvlu_datsetna_rd_ind_fun)},	/* 5=MVLU_DATSETNA_RD_IND_FUN_INDEX	*/
    {_MVLU_LEAF_FUN_INIT (mvlu_confrev_rd_ind)},	/* 6=MVLU_CONFREV_RD_IND_INDEX	*/
    {_MVLU_LEAF_FUN_INIT (mvlu_optflds_rd_ind_fun)},	/* 7=MVLU_OPTFLDS_RD_IND_FUN_INDEX	*/
    {_MVLU_LEAF_FUN_INIT (mvlu_buftim_rd_ind_fun)},	/* 8=MVLU_BUFTIM_RD_IND_FUN_INDEX	*/
    {_MVLU_LEAF_FUN_INIT (mvlu_sqnum_rd_ind_fun)},	/* 9=MVLU_SQNUM_RD_IND_FUN_INDEX	*/
    {_MVLU_LEAF_FUN_INIT (mvlu_sqnum_int16u_rd_ind_fun)},	/* 10=MVLU_SQNUM_INT16U_RD_IND_FUN_INDEX	*/
    {_MVLU_LEAF_FUN_INIT (mvlu_trgops_rd_ind_fun)},	/* 11=MVLU_TRGOPS_RD_IND_FUN_INDEX	*/
    {_MVLU_LEAF_FUN_INIT (mvlu_intgpd_rd_ind_fun)},	/* 12=MVLU_INTGPD_RD_IND_FUN_INDEX	*/
    {_MVLU_LEAF_FUN_INIT (mvlu_gi_rd_ind)},	/* 13=MVLU_GI_RD_IND_INDEX	*/
    {_MVLU_LEAF_FUN_INIT (mvlu_purgebuf_rd_ind)},	/* 14=MVLU_PURGEBUF_RD_IND_INDEX	*/
    {_MVLU_LEAF_FUN_INIT (mvlu_entryid_rd_ind)},	/* 15=MVLU_ENTRYID_RD_IND_INDEX	*/
    {_MVLU_LEAF_FUN_INIT (mvlu_timeofentry_rd_ind)},	/* 16=MVLU_TIMEOFENTRY_RD_IND_INDEX	*/
    {_MVLU_LEAF_FUN_INIT (mvlu_resv_rd_ind_fun)},	/* 17=MVLU_RESV_RD_IND_FUN_INDEX	*/
    {_MVLU_LEAF_FUN_INIT (mvlu_rbepd_rd_ind_fun)},	/* 18=MVLU_RBEPD_RD_IND_FUN_INDEX	*/
    {_MVLU_LEAF_FUN_INIT (mvlu_trgs_rd_ind_fun)}	/* 19=MVLU_TRGS_RD_IND_FUN_INDEX	*/
  };
...
MVLU_WR_FUN_INFO mvluWrFunInfoTbl[] =
  {
    ...
    {_MVLU_LEAF_FUN_INIT (mvlu_rbepd_wr_ind_fun)},	/* 18=MVLU_RBEPD_WR_IND_FUN_INDEX	*/
    {_MVLU_LEAF_FUN_INIT (mvlu_trgs_wr_ind_fun)}	/* 19=MVLU_TRGS_WR_IND_FUN_INDEX	*/
  };
