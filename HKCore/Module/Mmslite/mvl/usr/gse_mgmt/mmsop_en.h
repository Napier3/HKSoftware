...
/* --------  ---  ------   -------------------------------------------	*/
/* 06/29/04  JRB     02    Disable services not needed for IEC GOOSE.	*/
...
#define MMS_CONCLUDE_EN 	REQ_RESP_DIS
...
#define MMS_IDENT_EN		REQ_RESP_DIS
...
#define MMS_GET_DOM_EN		REQ_RESP_DIS
...
#define MMS_INFO_EN		REQ_EN
#define MMS_GETVAR_EN		REQ_RESP_DIS
...
#define MMS_DEFVLIST_EN		REQ_RESP_DIS
#define MMS_GETVLIST_EN		REQ_RESP_DIS
#define MMS_DELVLIST_EN		REQ_RESP_DIS
...
#define MMS_JREAD_EN		REQ_RESP_DIS
#define MMS_JWRITE_EN		REQ_RESP_DIS
#define MMS_JINIT_EN		REQ_RESP_DIS
#define MMS_JSTAT_EN		REQ_RESP_DIS
...
#define MMS_OBTAINFILE_EN	REQ_RESP_DIS
#define MMS_FOPEN_EN		REQ_RESP_DIS
#define MMS_FREAD_EN		REQ_RESP_DIS
#define MMS_FCLOSE_EN		REQ_RESP_DIS
#define MMS_FRENAME_EN		REQ_RESP_DIS
#define MMS_FDELETE_EN		REQ_RESP_DIS
#define MMS_FDIR_EN		REQ_RESP_DIS
