...
/*#define SLOGIPC_SEAL Disable for now, phase in ... */
...
ST_VOID slog_ipc_std_cmd_service (ST_CHAR *logCfgFile, 	    /* As used in logcfgx_exx	*/
...
ST_VOID slog_ipc_std_cmd_service_ex (struct log_ctrl *lc,
...
typedef struct slogipc_ctx_tag
  ...
  ST_INT 		      hdrSize;		/* Calculated at startup */ 
  ST_INT 		      magicNumber;
