...
public:
	...
	virtual BSTR GetXmlElementKey()  {      return CPMXmlRWKey::g_pPMXmlRWKeys->m_strPageButtons;     }
	virtual UINT GetClassID() {        return UIPAGEBUTTONSCLASSID;                               }
