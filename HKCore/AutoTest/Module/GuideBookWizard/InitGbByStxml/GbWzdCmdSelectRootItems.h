...
class CGbWzdCmdSelectRootItems : public CGbWzdCmd
{
public:
	CGbWzdCmdSelectRootItems();
	virtual ~CGbWzdCmdSelectRootItems();

	virtual UINT GetClassID()			{		return GBWZDCLASSID_STXML_SELROOT;	} 
