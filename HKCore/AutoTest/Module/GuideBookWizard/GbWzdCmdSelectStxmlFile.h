...
class CGbWzdCmdSelectStxmlFile : public CGbWzdCmd
{
public:
	CGbWzdCmdSelectStxmlFile();
	virtual ~CGbWzdCmdSelectStxmlFile();

	virtual UINT GetClassID()			{		return GBWZDCLASSID_SELECTSTXML;	} 
