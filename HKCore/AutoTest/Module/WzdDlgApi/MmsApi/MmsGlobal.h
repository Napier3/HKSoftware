...
// 		BOOL bTrue = IsMmsValueID(pszMmsID);
// 		delete pszMmsID;
// 		return bTrue;
	}
...
inline BOOL mms_GetDASubValue(tagDA *pSubDA,long nCount, /*const CString &strValueID,*/ CString &strValue)
{
	//CString strTemp;
	//long nLen = strValueID.GetLength();
	BOOL bFind = FALSE;
...
inline BOOL mms_GetDASubValueRpt(tagDA *pSubDA,long nCount, /*const CString &strValueID,*/ CString &strValue, tagRptValue *pRptValue)
{
	BOOL bFind = FALSE;
...
inline BOOL mms_view_GetDASubValue(tagDA *pDA, /*const CString &strValueID,*/ CString &strValue, BOOL bAll)
{
	CString strTemp;
	BOOL bFind = TRUE;
