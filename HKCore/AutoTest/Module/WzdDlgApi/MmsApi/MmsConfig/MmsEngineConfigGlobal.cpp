...
CMmsEngineConfigXmlRWKeys::CMmsEngineConfigXmlRWKeys()
{
	...
	m_strSpecifiedDatasetKey = L"specifi-dataset";
	m_strEnumRptKey = L"enum-rpt";
	m_strReadDataDescKey = L"read-desc";
	m_strReadDataMaxMinKey = L"read-maxmin";
	m_strReadDescGbkKey = L"read-desc-gbk";
