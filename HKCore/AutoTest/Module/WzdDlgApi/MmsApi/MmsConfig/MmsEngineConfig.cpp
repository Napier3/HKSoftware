...
long CMmsEngineConfig::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
	...
	xml_GetAttibuteValue(pXmlKeys->m_strEnumRptKey, oNode, m_nEnumRpt);
	xml_GetAttibuteValue(pXmlKeys->m_strSpecifiedDatasetKey, oNode, m_nSpecifiedDataset);
	xml_GetAttibuteValue(pXmlKeys->m_strReadDataDescKey, oNode, m_nReadDataDesc);
	xml_GetAttibuteValue(pXmlKeys->m_strReadDataMaxMinKey, oNode, m_nReadMaxMinValue);
	xml_GetAttibuteValue(pXmlKeys->m_strReadDescGbkKey, oNode, m_nReadDescGbk);

	m_nSpecifiedDataset = 1;
	return 0;
}
...
long CMmsEngineConfig::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	...
	xml_SetAttributeValue(pXmlKeys->m_strEnumRptKey, oElement, m_nEnumRpt);
	xml_SetAttributeValue(pXmlKeys->m_strSpecifiedDatasetKey, oElement, m_nSpecifiedDataset);
	xml_SetAttributeValue(pXmlKeys->m_strReadDataDescKey, oElement, m_nReadDataDesc);
	xml_SetAttributeValue(pXmlKeys->m_strReadDataMaxMinKey, oElement, m_nReadMaxMinValue);
	xml_SetAttributeValue(pXmlKeys->m_strReadDescGbkKey, oElement, m_nReadDescGbk);
