...
long CRptTemp_Cell::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
    ...
    xml_GetAttibuteValue(pXmlKeys->m_strHAlignTypeKey, oNode, m_strHAlignType); //ftt 2024.12.20
    xml_GetAttibuteValue(pXmlKeys->m_strVAlignTypeKey, oNode, m_strVAlignType); //ftt 2024.12.24
...
long CRptTemp_Cell::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
    ...
    xml_SetAttributeValue(pXmlKeys->m_strHAlignTypeKey, oElement, m_strHAlignType); //ftt 2024.12.20
    xml_SetAttributeValue(pXmlKeys->m_strVAlignTypeKey, oElement, m_strVAlignType); //ftt 2024.12.24
...
long CRptTemp_Cell::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
	if(oBinaryBuffer.IsCalSizeMode())
	{
        ...
        BinarySerializeCalLen(oBinaryBuffer, m_strHAlignType);  //ftt 2024.12.20
        BinarySerializeCalLen(oBinaryBuffer, m_strVAlignType);  //ftt 2024.12.24
...
BOOL CRptTemp_Cell::IsEqualOwn(CBaseObject* pObj)
{
    ...
    if(m_strHAlignType != p->m_strHAlignType) //ftt 2024.12.20
    {
        return FALSE;
    }

    if(m_strVAlignType != p->m_strVAlignType) //ftt 2024.12.24
    {
        return FALSE;
    }
...
BOOL CRptTemp_Cell::CopyOwn(CBaseObject* pDest)
{
    ...
    p->m_strHAlignType = m_strHAlignType; //ftt 2024.12.20
    p->m_strVAlignType = m_strVAlignType; //ftt 2024.12.24
