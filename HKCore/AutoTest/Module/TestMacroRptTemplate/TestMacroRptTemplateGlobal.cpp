...
CTestMacroRptTemplateXmlRWKeys::CTestMacroRptTemplateXmlRWKeys()
{
	...
	m_strPngCharKey = L"png-char";
	m_strXLangKey = L"xlang";
	...
	m_strCRptTemp_NewPageKey = L"newpage";  //ftt 2024.12.9
	m_strHAlignTypeKey = L"halign-type";   //ftt 2024.12.10
	m_strVAlignTypeKey = L"valign-type";   //ftt 2024.12.24
	m_strHeadHeightKey = L"head-height"; //ftt 2024.12.23
	m_strColWidthKey = L"col-width";  //ftt 2024.12.23
	m_strRowHeightKey = L"row-height"; //ftt 2024.12.23
