...
long CRptTemp_Text::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
    ...
    xml_GetAttibuteValue(pXmlKeys->m_strHAlignTypeKey, oNode, m_strHAlignType); //ftt 2024.12.10
...
long CRptTemp_Text::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
    ...
    xml_SetAttributeValue(pXmlKeys->m_strHAlignTypeKey, oElement, m_strHAlignType);  //ftt 2024.12.10
...
long CRptTemp_Text::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
	if(oBinaryBuffer.IsCalSizeMode())
	{
        ...
        BinarySerializeCalLen(oBinaryBuffer, m_strHAlignType); //ftt 2024.12.10
	...
	else if(oBinaryBuffer.IsReadMode())
	{
        ...
        BinarySerializeRead(oBinaryBuffer, m_strHAlignType); //ftt 2024.12.10
	...
	else if(oBinaryBuffer.IsWriteMode())
	{
        ...
        BinarySerializeWrite(oBinaryBuffer, m_strHAlignType);  //ftt 2024.12.10
...
BOOL CRptTemp_Text::IsEqualOwn(CBaseObject* pObj)
{
    ...
    if(m_strHAlignType != p->m_strHAlignType) //ftt 2024.12.10
    {
        return FALSE;
    }
...
BOOL CRptTemp_Text::CopyOwn(CBaseObject* pDest)
{
	...
	p->m_fSize = m_fSize;
	p->m_nBold = m_nBold;
    p->m_strHAlignType = m_strHAlignType;  //ftt 2024.12.10
