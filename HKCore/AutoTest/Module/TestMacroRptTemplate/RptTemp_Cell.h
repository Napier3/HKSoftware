...
public:
    ...
    CString  m_strHAlignType; //文本水平对齐方式 AlignLeft和空值:左对齐 AlignRight：右对齐 AlignCenter：水平居中 //ftt 2024.12.20
    CString  m_strVAlignType; //文本垂直对齐方式 AlignTop和空值:顶端对齐 AlignCenter：垂直居中 AlignBottom：底端对齐 //ftt 2024.12.24
