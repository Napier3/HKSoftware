...
long CAutoTestBaseFrame::OnConnectFailed(CExBaseObject *pTestControl)
{
	return 0;
}

long CAutoTestBaseFrame::OnEngineEvent(CExBaseObject *pTestControl, const CString &strEventID)
{
	return 0;
}
