...
long CGbVarReplaceBaseObj::CalBuffer()
{
	...
	{
		m_nBufLength = m_pTextRef->GetLength() + 50;
	}
	else
	{
...
//////////////////////////////////////////////////////////////////////////
//CGbItemDvmReplace
BOOL CGbItemDvmVarQuery::g_bShowReplaceItemPath = TRUE;

CGbItemDvmVarQuery::CGbItemDvmVarQuery()
{
	m_pGbItemDest = NULL;
	...
	strFile += _T("GbItemDvmVarQuery.txt");
...
void CGbItemDvmVarQuery::BuildRepalce(CExBaseList *pGbItems)
{
...
void CGbItemDvmVarQuery::Replace(CExBaseObject *pDestObject, const CString &strSrcID, const CString &strDestID)
{
	if (m_bFileVarReplace)
	{
...
void CGbItemDvmVarQuery::FinishReplace()
{
	POS pos = GetHeadPosition();
	CGbVarReplaceBaseObj *p = NULL;
...
void CGbItemDvmVarQuery::BuildItems(CExBaseList *pGbItemDest)
{
...
void CGbItemDvmVarQuery::BuildItem(CExBaseObject *pGbItemDest)
{
...
void CGbItemDvmVarQuery::Build_RptData(CReportMap *pRptMap, CExBaseObject *pRptData)
{
...
void CGbItemDvmVarQuery::Build(CGbItemBase *pGbObj)
{
...
void CGbItemDvmVarQuery::Build(CMacroTest *pGbObj)
{
...
void CGbItemDvmVarQuery::Build(CMacroCharItems *pGbObj)
{
	CMacroTestPara *pMacroTestPara = pGbObj->GetMacroTestPara();
	//Build(pMacroTestPara->GetScriptText());
...
void CGbItemDvmVarQuery::Build(CCommCmd *pGbObj)
{
	Build((CGbItemBase*)pGbObj);
...
void CGbItemDvmVarQuery::Build(CSafety *pGbObj)
{
	Build((CGbItemBase*)pGbObj);
}

void CGbItemDvmVarQuery::Build(CSysParaEdit *pGbObj)
{
	Build((CGbItemBase*)pGbObj);
...
void CGbItemDvmVarQuery::Build(CScriptText *pText)
{
	//内部引用脚本替换
	if (pText->m_nIsRef)
	{
...
void CGbItemDvmVarQuery::Build(CString &strText)
{
...
void CGbItemDvmVarQuery::ShowReplaceItemPath(CExBaseObject *pItem)
{
	if (g_bShowReplaceItemPath)
	{
		CString strPath = Gb_GetItemPathName(pItem);
		CLogPrint::LogString(LOGLEVEL_TRACE, strPath);
	}
}

void CGbItemDvmVarQuery::Build(CDsvScript *pDsvScript)
{
	if (pDsvScript == NULL)
	{
		return;
...
void CGbItemDvmVarQuery::Build(CCharacteristics *pCharacteristics)
{
	...
	CCharacteristicTmplate *pCharTmpl = NULL;

	while (pos != NULL)
	{
		pCharTmpl = (CCharacteristicTmplate *)pCharacteristics->GetNext(pos);
...
void CGbItemDvmVarQuery::Build_Characteristics(UINT nClassID, CExBaseObject *pGbItemDest)
{
...
void CGbItemDvmVarQuery::BuildBuffer()
{
	POS pos = GetHeadPosition();
	CGbVarReplaceBaseObj *p = NULL;
	m_nLenBufferForReplace = 0;
