...
public:
	CJsonRptEdit(void);
	virtual ~CJsonRptEdit(void);
	virtual CString GetReportEditClassID(){	return REPORTFILL_PROGID_JSON; };
	virtual CString GetReportSuffix(){ return _T("json");};
public:
	CDialogEditRpt m_xmlDlg;
	CJsonPathData m_JsonProssData;
