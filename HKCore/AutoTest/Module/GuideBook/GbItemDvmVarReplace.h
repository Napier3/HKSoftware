...
public:
	...
	virtual BOOL HasReplace(CGbVarReplacePara *pReplacePara);
...
class CGbItemDvmVarReplace : public CBaseList
{
public:
	CGbItemDvmVarReplace();
	virtual ~CGbItemDvmVarReplace();
...
protected:
	...
	virtual void Build(CString &strText, BOOL bUseMinLen=TRUE);
