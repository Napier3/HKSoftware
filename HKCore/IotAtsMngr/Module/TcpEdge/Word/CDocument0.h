...
//#import "D:\\WorkLiJQ\\Source\\IotAtsMngr\\Module\\TcpEdge\\Word\\MSWORD.OLB" no_namespace
// CDocument0 包装类
...
public:
	...
	void InsertAppForOfficeTest(LPCTSTR ID, long Type, LPCTSTR Version, long StoreType, LPCTSTR StoreId, LPCTSTR AssetId, LPCTSTR AssetStoreId, long Width, long Height)
	{
		...
		InvokeHelper(0x26e, DISPATCH_METHOD, VT_EMPTY, NULL, parms, ID, Type, Version, StoreType, StoreId, AssetId, AssetStoreId, Width, Height);
	}
	...
	{
		static BYTE parms[] = VTS_BOOL ;
		InvokeHelper(0x270, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	void ExportAsFixedFormat2(LPCTSTR OutputFileName, long ExportFormat, BOOL OpenAfterExport, long OptimizeFor, long Range, long From, long To, long Item, BOOL IncludeDocProps, BOOL KeepIRM, long CreateBookmarks, BOOL DocStructureTags, BOOL BitmapMissingFonts, BOOL UseISO19005_1, BOOL OptimizeForImageQuality, VARIANT * FixedFormatExtClassPtr)
	{
		...
		InvokeHelper(0x271, DISPATCH_METHOD, VT_EMPTY, NULL, parms, OutputFileName, ExportFormat, OpenAfterExport, OptimizeFor, Range, From, To, Item, IncludeDocProps, KeepIRM, CreateBookmarks, DocStructureTags, BitmapMissingFonts, UseISO19005_1, OptimizeForImageQuality, FixedFormatExtClassPtr);
	}
	LPDISPATCH get_SensitivityLabel()
	{
		LPDISPATCH result;
		InvokeHelper(0x272, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
