...
//TcpEdgePkgData_ConStopResp.cpp  CTcpEdgePkgData_ConStopResp
...
CTcpEdgePkgData_ConStopResp::CTcpEdgePkgData_ConStopResp()
{
	//初始化属性
...
BOOL CTcpEdgePkgData_ConStopResp::xml_GetAttibuteValue(const BSTR strAttrName, CXmlRWNodeBase &oNode, CString &strAttrVal)
{
	...
	if(!strAttrVal.GetLength())
	{
		...
		strTemp = QString("【错误】【必需项缺失】ConStopResp：[%1]=>[%2]必需字段缺失;\n").arg(strID).arg(strAttr);
	...
	{
		//值存在时检查类型是否正确
		strTemp = QString("【错误】【必需项错误】ConStopResp：[%1]=>[%2]字段类型错误;\n").arg(strID).arg(strAttr);
		m_strErrorInfo += strTemp;
...
long CTcpEdgePkgData_ConStopResp::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_ConStopResp::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_ConStopResp::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CTcpEdgePkgData_ConStopResp::InitAfterRead()
{
}

BOOL CTcpEdgePkgData_ConStopResp::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CTcpEdgePkgData_ConStopResp *p = (CTcpEdgePkgData_ConStopResp*)pObj;
...
BOOL CTcpEdgePkgData_ConStopResp::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CTcpEdgePkgData_ConStopResp *p = (CTcpEdgePkgData_ConStopResp*)pDest;
...
CBaseObject* CTcpEdgePkgData_ConStopResp::Clone()
{
	CTcpEdgePkgData_ConStopResp *p = new CTcpEdgePkgData_ConStopResp();
	Copy(p);
	return p;
}

CBaseObject* CTcpEdgePkgData_ConStopResp::CloneEx(BOOL bCopyOwn/*=TRUE*/, BOOL bCopyChildren/*=FALSE*/)
{
	CTcpEdgePkgData_ConStopResp *p = new CTcpEdgePkgData_ConStopResp();
...
BOOL CTcpEdgePkgData_ConStopResp::CanPaste(UINT nClassID)
{
	return FALSE;
}

CExBaseObject* CTcpEdgePkgData_ConStopResp::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CTcpEdgePkgData_ConStopResp::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
long CTcpEdgePkgData_ConStopResp::DB_ReadFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_ConStopResp::DB_WriteFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
