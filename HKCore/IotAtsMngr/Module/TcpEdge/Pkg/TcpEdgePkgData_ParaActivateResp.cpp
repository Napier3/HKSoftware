...
//TcpEdgePkgData_ParaActivateResp.cpp  CTcpEdgePkgData_ParaActivateResp


#include "stdafx.h"
#include "TcpEdgePkgData_ParaActivateResp.h"

CTcpEdgePkgData_ParaActivateResp::CTcpEdgePkgData_ParaActivateResp()
{
	//初始化属性
...
BOOL CTcpEdgePkgData_ParaActivateResp::xml_GetAttibuteValue(const BSTR strAttrName, CXmlRWNodeBase &oNode, CString &strAttrVal)
{
	...
	if(!strAttrVal.GetLength())
	{
		...
		strTemp = QString("【错误】【必需项缺失】ParaActivateResp：[%1]=>[%2]必需字段缺失;\n").arg(strID).arg(strAttr);
	...
	{
		//值存在时检查类型是否正确
		strTemp = QString("【错误】【必需项错误】ParaActivateResp：[%1]=>[%2]字段类型错误;\n").arg(strID).arg(strAttr);
		m_strErrorInfo += strTemp;
...
long CTcpEdgePkgData_ParaActivateResp::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_ParaActivateResp::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_ParaActivateResp::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CTcpEdgePkgData_ParaActivateResp::InitAfterRead()
{
}

BOOL CTcpEdgePkgData_ParaActivateResp::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CTcpEdgePkgData_ParaActivateResp *p = (CTcpEdgePkgData_ParaActivateResp*)pObj;
...
BOOL CTcpEdgePkgData_ParaActivateResp::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CTcpEdgePkgData_ParaActivateResp *p = (CTcpEdgePkgData_ParaActivateResp*)pDest;
...
CBaseObject* CTcpEdgePkgData_ParaActivateResp::Clone()
{
	CTcpEdgePkgData_ParaActivateResp *p = new CTcpEdgePkgData_ParaActivateResp();
	Copy(p);
	return p;
}

long CTcpEdgePkgData_ParaActivateResp::InitListCtrlColumns(CListCtrl *pListCtrl)
{
...
long CTcpEdgePkgData_ParaActivateResp::UpdateListCtrl(CListCtrl *pListCtrl, long lItemIndex)
{
	CString strTemp;
...
BOOL CTcpEdgePkgData_ParaActivateResp::CanPaste(UINT nClassID)
{
	return FALSE;
}

CExBaseObject* CTcpEdgePkgData_ParaActivateResp::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CTcpEdgePkgData_ParaActivateResp::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
long CTcpEdgePkgData_ParaActivateResp::DB_ReadFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_ParaActivateResp::DB_WriteFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
