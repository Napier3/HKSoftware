...
//TcpEdgePkgData_ConSetConfigReq.cpp  CTcpEdgePkgData_ConSetConfigReq
...
CTcpEdgePkgData_ConSetConfigReq::CTcpEdgePkgData_ConSetConfigReq()
{
	//初始化属性
	...
	m_arrayNotMust[0] = PkgData_Node_Port;
	m_arrayNotMust[1] = PkgData_Node_Mount;
	m_arrayNotMust[2] = PkgData_Node_Dev;
}
...
long CTcpEdgePkgData_ConSetConfigReq::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_ConSetConfigReq::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_ConSetConfigReq::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CTcpEdgePkgData_ConSetConfigReq::InitAfterRead()
{
...
BOOL CTcpEdgePkgData_ConSetConfigReq::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CTcpEdgePkgData_ConSetConfigReq *p = (CTcpEdgePkgData_ConSetConfigReq*)pObj;
...
BOOL CTcpEdgePkgData_ConSetConfigReq::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CTcpEdgePkgData_ConSetConfigReq *p = (CTcpEdgePkgData_ConSetConfigReq*)pDest;

	p->m_strContainer = m_strContainer;
	return TRUE;
}

CBaseObject* CTcpEdgePkgData_ConSetConfigReq::Clone()
{
	CTcpEdgePkgData_ConSetConfigReq *p = new CTcpEdgePkgData_ConSetConfigReq();
	Copy(p);
	return p;
}

CBaseObject* CTcpEdgePkgData_ConSetConfigReq::CloneEx(BOOL bCopyOwn/*=TRUE*/, BOOL bCopyChildren/*=FALSE*/)
{
	CTcpEdgePkgData_ConSetConfigReq *p = new CTcpEdgePkgData_ConSetConfigReq();
...
BOOL CTcpEdgePkgData_ConSetConfigReq::CanPaste(UINT nClassID)
{
	if (nClassID == MNGRCLASSID_CTCPEDGEPKGCFGCPU)
	{
		return TRUE;
...
CExBaseObject* CTcpEdgePkgData_ConSetConfigReq::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CTcpEdgePkgData_ConSetConfigReq::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
long CTcpEdgePkgData_ConSetConfigReq::DB_ReadFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_ConSetConfigReq::DB_WriteFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_ConSetConfigReq::XmlReadJsonArray(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys, const char *string)
{
	//取到JSON
...
long CTcpEdgePkgData_ConSetConfigReq::XmlWriteJsonArray(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys, const char *string)
{
...
CDvmDataset* CTcpEdgePkgData_ConSetConfigReq::ToDataset()
{
