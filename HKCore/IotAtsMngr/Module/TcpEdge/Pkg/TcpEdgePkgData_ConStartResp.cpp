...
//TcpEdgePkgData_ConStartResp.cpp  CTcpEdgePkgData_ConStartResp
...
CTcpEdgePkgData_ConStartResp::CTcpEdgePkgData_ConStartResp()
{
	//初始化属性
...
BOOL CTcpEdgePkgData_ConStartResp::xml_GetAttibuteValue(const BSTR strAttrName, CXmlRWNodeBase &oNode, CString &strAttrVal)
{
	...
	if(!strAttrVal.GetLength())
	{
		...
		strTemp = QString("【错误】【必需项缺失】ConStartResp：[%1]=>[%2]必需字段缺失;\n").arg(strID).arg(strAttr);
	...
	{
		//值存在时检查类型是否正确
		strTemp = QString("【错误】【必需项错误】ConStartResp：[%1]=>[%2]字段类型错误;\n").arg(strID).arg(strAttr);
		m_strErrorInfo += strTemp;
...
long CTcpEdgePkgData_ConStartResp::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_ConStartResp::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_ConStartResp::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CTcpEdgePkgData_ConStartResp::InitAfterRead()
{
}

BOOL CTcpEdgePkgData_ConStartResp::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CTcpEdgePkgData_ConStartResp *p = (CTcpEdgePkgData_ConStartResp*)pObj;
...
BOOL CTcpEdgePkgData_ConStartResp::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CTcpEdgePkgData_ConStartResp *p = (CTcpEdgePkgData_ConStartResp*)pDest;
...
CBaseObject* CTcpEdgePkgData_ConStartResp::Clone()
{
	CTcpEdgePkgData_ConStartResp *p = new CTcpEdgePkgData_ConStartResp();
	Copy(p);
	return p;
}

CBaseObject* CTcpEdgePkgData_ConStartResp::CloneEx(BOOL bCopyOwn/*=TRUE*/, BOOL bCopyChildren/*=FALSE*/)
{
	CTcpEdgePkgData_ConStartResp *p = new CTcpEdgePkgData_ConStartResp();
...
BOOL CTcpEdgePkgData_ConStartResp::CanPaste(UINT nClassID)
{
	return FALSE;
}

CExBaseObject* CTcpEdgePkgData_ConStartResp::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CTcpEdgePkgData_ConStartResp::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
long CTcpEdgePkgData_ConStartResp::DB_ReadFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_ConStartResp::DB_WriteFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
