...
//TcpEdgePkgData_AppGetLogRes.cpp  CTcpEdgePkgData_AppGetLogResp
...
CTcpEdgePkgData_AppGetLogResp::CTcpEdgePkgData_AppGetLogResp()
{
	//初始化属性
...
BOOL CTcpEdgePkgData_AppGetLogResp::xml_GetAttibuteValue(const BSTR strAttrName, CXmlRWNodeBase &oNode, CString &strAttrVal)
{
	...
	if(!strAttrVal.GetLength())
	{
		...
		strTemp = QString("【错误】【必需项缺失】AppGetLogResp：[%1]=>[%2]必需字段缺失;\n").arg(strID).arg(strAttr);
	...
	{
		//值存在时检查类型是否正确
		strTemp = QString("【错误】【必需项错误】AppGetLogResp：[%1]=>[%2]字段类型错误;\n").arg(strID).arg(strAttr);
		m_strErrorInfo += strTemp;
...
long CTcpEdgePkgData_AppGetLogResp::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_AppGetLogResp::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_AppGetLogResp::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CTcpEdgePkgData_AppGetLogResp::InitAfterRead()
{
...
BOOL CTcpEdgePkgData_AppGetLogResp::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CTcpEdgePkgData_AppGetLogResp *p = (CTcpEdgePkgData_AppGetLogResp*)pObj;
...
BOOL CTcpEdgePkgData_AppGetLogResp::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CTcpEdgePkgData_AppGetLogResp *p = (CTcpEdgePkgData_AppGetLogResp*)pDest;
...
CBaseObject* CTcpEdgePkgData_AppGetLogResp::Clone()
{
	CTcpEdgePkgData_AppGetLogResp *p = new CTcpEdgePkgData_AppGetLogResp();
	Copy(p);
	return p;
}

CBaseObject* CTcpEdgePkgData_AppGetLogResp::CloneEx(BOOL bCopyOwn/*=TRUE*/, BOOL bCopyChildren/*=FALSE*/)
{
	CTcpEdgePkgData_AppGetLogResp *p = new CTcpEdgePkgData_AppGetLogResp();
...
BOOL CTcpEdgePkgData_AppGetLogResp::CanPaste(UINT nClassID)
{
	if (nClassID == MNGRCLASSID_CTCPEDGEPKGFILE)
	{
		return TRUE;
...
CExBaseObject* CTcpEdgePkgData_AppGetLogResp::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
	...
	if (strClassID == pXmlKeys->m_strCTcpEdgePkgFileKey)
	{
		...
		pNew->m_strID = _T("AppGetLogResp");
	}

	return pNew;
}

CExBaseObject* CTcpEdgePkgData_AppGetLogResp::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
long CTcpEdgePkgData_AppGetLogResp::DB_ReadFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_AppGetLogResp::DB_WriteFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
