...
//TcpEdgePkgData_AppStartResp.cpp  CTcpEdgePkgData_AppStartResp
...
CTcpEdgePkgData_AppStartResp::CTcpEdgePkgData_AppStartResp()
{
	//初始化属性
...
BOOL CTcpEdgePkgData_AppStartResp::xml_GetAttibuteValue(const BSTR strAttrName, CXmlRWNodeBase &oNode, CString &strAttrVal)
{
	...
	if(!strAttrVal.GetLength())
	{
		...
		strTemp = QString("【错误】【必需项缺失】AppStartResp：[%1]=>[%2]必需字段缺失;\n").arg(strID).arg(strAttr);
	...
	{
		//值存在时检查类型是否正确
		strTemp = QString("【错误】【必需项错误】AppStartResp：[%1]=>[%2]字段类型错误;\n").arg(strID).arg(strAttr);
		m_strErrorInfo += strTemp;
...
long CTcpEdgePkgData_AppStartResp::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_AppStartResp::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_AppStartResp::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CTcpEdgePkgData_AppStartResp::InitAfterRead()
{
}

BOOL CTcpEdgePkgData_AppStartResp::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CTcpEdgePkgData_AppStartResp *p = (CTcpEdgePkgData_AppStartResp*)pObj;
...
BOOL CTcpEdgePkgData_AppStartResp::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CTcpEdgePkgData_AppStartResp *p = (CTcpEdgePkgData_AppStartResp*)pDest;
...
CBaseObject* CTcpEdgePkgData_AppStartResp::Clone()
{
	CTcpEdgePkgData_AppStartResp *p = new CTcpEdgePkgData_AppStartResp();
	Copy(p);
	return p;
}

CBaseObject* CTcpEdgePkgData_AppStartResp::CloneEx(BOOL bCopyOwn/*=TRUE*/, BOOL bCopyChildren/*=FALSE*/)
{
	CTcpEdgePkgData_AppStartResp *p = new CTcpEdgePkgData_AppStartResp();
...
BOOL CTcpEdgePkgData_AppStartResp::CanPaste(UINT nClassID)
{
	return FALSE;
}

CExBaseObject* CTcpEdgePkgData_AppStartResp::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CTcpEdgePkgData_AppStartResp::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
long CTcpEdgePkgData_AppStartResp::DB_ReadFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_AppStartResp::DB_WriteFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
