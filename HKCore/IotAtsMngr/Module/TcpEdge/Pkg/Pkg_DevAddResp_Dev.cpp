...
//Pkg_DevAddResp_Dev.cpp  CPkg_DevAddResp_Dev


#include "stdafx.h"
#include "Pkg_DevAddResp_Dev.h"

CPkg_DevAddResp_Dev::CPkg_DevAddResp_Dev()
{
	//初始化属性
...
long CPkg_DevAddResp_Dev::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CPkg_DevAddResp_Dev::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
...
long CPkg_DevAddResp_Dev::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CPkg_DevAddResp_Dev::InitAfterRead()
{
}

BOOL CPkg_DevAddResp_Dev::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CPkg_DevAddResp_Dev *p = (CPkg_DevAddResp_Dev*)pObj;
...
BOOL CPkg_DevAddResp_Dev::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CPkg_DevAddResp_Dev *p = (CPkg_DevAddResp_Dev*)pDest;
...
CBaseObject* CPkg_DevAddResp_Dev::Clone()
{
	CPkg_DevAddResp_Dev *p = new CPkg_DevAddResp_Dev();
	Copy(p);
	return p;
}

long CPkg_DevAddResp_Dev::InitListCtrlColumns(CListCtrl *pListCtrl)
{
...
long CPkg_DevAddResp_Dev::UpdateListCtrl(CListCtrl *pListCtrl, long lItemIndex)
{
	CString strTemp;
...
BOOL CPkg_DevAddResp_Dev::CanPaste(UINT nClassID)
{
	return FALSE;
}

CExBaseObject* CPkg_DevAddResp_Dev::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CPkg_DevAddResp_Dev::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
long CPkg_DevAddResp_Dev::DB_ReadFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
...
long CPkg_DevAddResp_Dev::DB_WriteFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
