...
//TcpEdgePkgData_DeviceUpdateResult.cpp  CTcpEdgePkgData_DeviceUpdateResult
...
CTcpEdgePkgData_DeviceUpdateResult::CTcpEdgePkgData_DeviceUpdateResult()
{
	//初始化属性
...
BOOL CTcpEdgePkgData_DeviceUpdateResult::xml_GetAttibuteValue(const BSTR strAttrName, CXmlRWNodeBase &oNode, CString &strAttrVal)
{
	...
	if(!strAttrVal.GetLength())
	{
		...
		strTemp = QString("【错误】【必需项缺失】DeviceUpdateResult：[%1]=>[%2]必需字段缺失;\n").arg(strID).arg(strAttr);
	...
	{
		//值存在时检查类型是否正确
		strTemp = QString("【错误】【必需项缺失】DeviceUpdateResult：[%1]=>[%2]字段类型错误;\n").arg(strID).arg(strAttr);
		m_strErrorInfo += strTemp;
...
long CTcpEdgePkgData_DeviceUpdateResult::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_DeviceUpdateResult::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_DeviceUpdateResult::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CTcpEdgePkgData_DeviceUpdateResult::InitAfterRead()
{
}

BOOL CTcpEdgePkgData_DeviceUpdateResult::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CTcpEdgePkgData_DeviceUpdateResult *p = (CTcpEdgePkgData_DeviceUpdateResult*)pObj;
...
BOOL CTcpEdgePkgData_DeviceUpdateResult::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CTcpEdgePkgData_DeviceUpdateResult *p = (CTcpEdgePkgData_DeviceUpdateResult*)pDest;
...
CBaseObject* CTcpEdgePkgData_DeviceUpdateResult::Clone()
{
	CTcpEdgePkgData_DeviceUpdateResult *p = new CTcpEdgePkgData_DeviceUpdateResult();
	Copy(p);
	return p;
}

CBaseObject* CTcpEdgePkgData_DeviceUpdateResult::CloneEx(BOOL bCopyOwn/*=TRUE*/, BOOL bCopyChildren/*=FALSE*/)
{
	CTcpEdgePkgData_DeviceUpdateResult *p = new CTcpEdgePkgData_DeviceUpdateResult();
...
BOOL CTcpEdgePkgData_DeviceUpdateResult::CanPaste(UINT nClassID)
{
	return FALSE;
}

CExBaseObject* CTcpEdgePkgData_DeviceUpdateResult::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CTcpEdgePkgData_DeviceUpdateResult::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
long CTcpEdgePkgData_DeviceUpdateResult::DB_ReadFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_DeviceUpdateResult::DB_WriteFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
