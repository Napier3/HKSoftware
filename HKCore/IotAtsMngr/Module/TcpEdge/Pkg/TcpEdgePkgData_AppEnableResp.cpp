...
//TcpEdgePkgData_AppEnableResp.cpp  CTcpEdgePkgData_AppEnableResp
...
CTcpEdgePkgData_AppEnableResp::CTcpEdgePkgData_AppEnableResp()
{
	//初始化属性
...
BOOL CTcpEdgePkgData_AppEnableResp::xml_GetAttibuteValue(const BSTR strAttrName, CXmlRWNodeBase &oNode, CString &strAttrVal)
{
	...
	if(!strAttrVal.GetLength())
	{
		...
		strTemp = QString("【错误】【必需项缺失】AppEnableResp：[%1]=>[%2]必需字段缺失;\n").arg(strID).arg(strAttr);
	...
	{
		//值存在时检查类型是否正确
		strTemp = QString("【错误】【必需项错误】AppEnableResp：[%1]=>[%2]字段类型错误;\n").arg(strID).arg(strAttr);
		m_strErrorInfo += strTemp;
...
long CTcpEdgePkgData_AppEnableResp::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_AppEnableResp::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_AppEnableResp::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CTcpEdgePkgData_AppEnableResp::InitAfterRead()
{
}

BOOL CTcpEdgePkgData_AppEnableResp::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CTcpEdgePkgData_AppEnableResp *p = (CTcpEdgePkgData_AppEnableResp*)pObj;
...
BOOL CTcpEdgePkgData_AppEnableResp::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CTcpEdgePkgData_AppEnableResp *p = (CTcpEdgePkgData_AppEnableResp*)pDest;
...
CBaseObject* CTcpEdgePkgData_AppEnableResp::Clone()
{
	CTcpEdgePkgData_AppEnableResp *p = new CTcpEdgePkgData_AppEnableResp();
	Copy(p);
	return p;
}

CBaseObject* CTcpEdgePkgData_AppEnableResp::CloneEx(BOOL bCopyOwn/*=TRUE*/, BOOL bCopyChildren/*=FALSE*/)
{
	CTcpEdgePkgData_AppEnableResp *p = new CTcpEdgePkgData_AppEnableResp();
...
BOOL CTcpEdgePkgData_AppEnableResp::CanPaste(UINT nClassID)
{
	return FALSE;
}

CExBaseObject* CTcpEdgePkgData_AppEnableResp::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CTcpEdgePkgData_AppEnableResp::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
long CTcpEdgePkgData_AppEnableResp::DB_ReadFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_AppEnableResp::DB_WriteFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
