...
//TcpEdgePkgData_DeviceUpdateResp.cpp  CTcpEdgePkgData_DeviceUpdateResp
...
CTcpEdgePkgData_DeviceUpdateResp::CTcpEdgePkgData_DeviceUpdateResp()
{
	//初始化属性
...
BOOL CTcpEdgePkgData_DeviceUpdateResp::xml_GetAttibuteValue(const BSTR strAttrName, CXmlRWNodeBase &oNode, CString &strAttrVal)
{
	...
	if(!strAttrVal.GetLength())
	{
		...
		strTemp = QString("【错误】【必需项缺失】DeviceUpdateResp：[%1]=>[%2]必需字段缺失;\n").arg(strID).arg(strAttr);
	...
	{
		//值存在时检查类型是否正确
		strTemp = QString("【错误】【必需项错误】DeviceUpdateResp：[%1]=>[%2]字段类型错误;\n").arg(strID).arg(strAttr);
		m_strErrorInfo += strTemp;
...
long CTcpEdgePkgData_DeviceUpdateResp::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_DeviceUpdateResp::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_DeviceUpdateResp::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CTcpEdgePkgData_DeviceUpdateResp::InitAfterRead()
{
}

BOOL CTcpEdgePkgData_DeviceUpdateResp::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CTcpEdgePkgData_DeviceUpdateResp *p = (CTcpEdgePkgData_DeviceUpdateResp*)pObj;
...
BOOL CTcpEdgePkgData_DeviceUpdateResp::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CTcpEdgePkgData_DeviceUpdateResp *p = (CTcpEdgePkgData_DeviceUpdateResp*)pDest;
...
CBaseObject* CTcpEdgePkgData_DeviceUpdateResp::Clone()
{
	CTcpEdgePkgData_DeviceUpdateResp *p = new CTcpEdgePkgData_DeviceUpdateResp();
	Copy(p);
	return p;
}

CBaseObject* CTcpEdgePkgData_DeviceUpdateResp::CloneEx(BOOL bCopyOwn/*=TRUE*/, BOOL bCopyChildren/*=FALSE*/)
{
	CTcpEdgePkgData_DeviceUpdateResp *p = new CTcpEdgePkgData_DeviceUpdateResp();
...
BOOL CTcpEdgePkgData_DeviceUpdateResp::CanPaste(UINT nClassID)
{
	return FALSE;
}

CExBaseObject* CTcpEdgePkgData_DeviceUpdateResp::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CTcpEdgePkgData_DeviceUpdateResp::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
long CTcpEdgePkgData_DeviceUpdateResp::DB_ReadFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_DeviceUpdateResp::DB_WriteFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
