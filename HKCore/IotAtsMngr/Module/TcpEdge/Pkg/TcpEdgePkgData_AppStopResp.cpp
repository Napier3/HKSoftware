...
//TcpEdgePkgData_AppStopResp.cpp  CTcpEdgePkgData_AppStopResp
...
CTcpEdgePkgData_AppStopResp::CTcpEdgePkgData_AppStopResp()
{
	//初始化属性
...
BOOL CTcpEdgePkgData_AppStopResp::xml_GetAttibuteValue(const BSTR strAttrName, CXmlRWNodeBase &oNode, CString &strAttrVal)
{
	...
	if(!strAttrVal.GetLength())
	{
		...
		strTemp = QString("【错误】【必需项缺失】AppStopResp：[%1]=>[%2]必需字段缺失;\n").arg(strID).arg(strAttr);
	...
	{
		//值存在时检查类型是否正确
		strTemp = QString("【错误】【必需项错误】AppStopResp：[%1]=>[%2]字段类型错误;\n").arg(strID).arg(strAttr);
		m_strErrorInfo += strTemp;
...
long CTcpEdgePkgData_AppStopResp::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_AppStopResp::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_AppStopResp::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CTcpEdgePkgData_AppStopResp::InitAfterRead()
{
}

BOOL CTcpEdgePkgData_AppStopResp::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CTcpEdgePkgData_AppStopResp *p = (CTcpEdgePkgData_AppStopResp*)pObj;
...
BOOL CTcpEdgePkgData_AppStopResp::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CTcpEdgePkgData_AppStopResp *p = (CTcpEdgePkgData_AppStopResp*)pDest;
...
CBaseObject* CTcpEdgePkgData_AppStopResp::Clone()
{
	CTcpEdgePkgData_AppStopResp *p = new CTcpEdgePkgData_AppStopResp();
	Copy(p);
	return p;
}

CBaseObject* CTcpEdgePkgData_AppStopResp::CloneEx(BOOL bCopyOwn/*=TRUE*/, BOOL bCopyChildren/*=FALSE*/)
{
	CTcpEdgePkgData_AppStopResp *p = new CTcpEdgePkgData_AppStopResp();
...
BOOL CTcpEdgePkgData_AppStopResp::CanPaste(UINT nClassID)
{
	return FALSE;
}

CExBaseObject* CTcpEdgePkgData_AppStopResp::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CTcpEdgePkgData_AppStopResp::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
long CTcpEdgePkgData_AppStopResp::DB_ReadFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
...
long CTcpEdgePkgData_AppStopResp::DB_WriteFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
