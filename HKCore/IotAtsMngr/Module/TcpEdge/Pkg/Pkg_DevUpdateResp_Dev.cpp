...
//Pkg_DevUpdateResp_Dev.cpp  CPkg_DevUpdateResp_Dev


#include "stdafx.h"
#include "Pkg_DevUpdateResp_Dev.h"

CPkg_DevUpdateResp_Dev::CPkg_DevUpdateResp_Dev()
{
	//初始化属性
...
long CPkg_DevUpdateResp_Dev::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CPkg_DevUpdateResp_Dev::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
...
long CPkg_DevUpdateResp_Dev::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CPkg_DevUpdateResp_Dev::InitAfterRead()
{
}

BOOL CPkg_DevUpdateResp_Dev::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CPkg_DevUpdateResp_Dev *p = (CPkg_DevUpdateResp_Dev*)pObj;
...
BOOL CPkg_DevUpdateResp_Dev::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CPkg_DevUpdateResp_Dev *p = (CPkg_DevUpdateResp_Dev*)pDest;
...
CBaseObject* CPkg_DevUpdateResp_Dev::Clone()
{
	CPkg_DevUpdateResp_Dev *p = new CPkg_DevUpdateResp_Dev();
	Copy(p);
	return p;
}

long CPkg_DevUpdateResp_Dev::InitListCtrlColumns(CListCtrl *pListCtrl)
{
...
long CPkg_DevUpdateResp_Dev::UpdateListCtrl(CListCtrl *pListCtrl, long lItemIndex)
{
	CString strTemp;
...
BOOL CPkg_DevUpdateResp_Dev::CanPaste(UINT nClassID)
{
	return FALSE;
}

CExBaseObject* CPkg_DevUpdateResp_Dev::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CPkg_DevUpdateResp_Dev::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
long CPkg_DevUpdateResp_Dev::DB_ReadFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
...
long CPkg_DevUpdateResp_Dev::DB_WriteFields(CXDbRecordsetBase *pRecordset, CXmlRWKeys *pXmlRWKeys)
{
