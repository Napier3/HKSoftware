...
//Iot_TemplateFolder.h  CIot_TemplateFolder
...
class CIot_TemplateFolder : public CExBaseList
{
public:
	CIot_TemplateFolder();
	virtual ~CIot_TemplateFolder();


	long  m_nIndex_Folder;
	long  m_nIndex_Parent_Folder;
	SYSTEMTIME  m_tmTm_Create;
//重载函数
public:
	virtual UINT GetClassID() {    return IOTCLASSID_CIOT_TEMPLATEFOLDER;   }
	virtual BSTR GetXmlElementKey()  {      return CNR_IOTMNGRXmlRWKeys::CIot_TemplateFolderKey();     }
	...
	virtual BSTR DB_GetPrimaryKey(CXmlRWKeys *pXmlRWKeys)  {      return CNR_IOTMNGRXmlRWKeys::Index_FolderKey();     }
