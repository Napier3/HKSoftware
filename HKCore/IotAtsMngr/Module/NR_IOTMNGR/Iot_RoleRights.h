...
//Iot_RoleRights.h  CIot_RoleRights
...
class CIot_RoleRights : public CExBaseList
{
public:
	CIot_RoleRights();
	virtual ~CIot_RoleRights();


//重载函数
public:
	virtual UINT GetClassID() {    return IOTCLASSID_CIOT_ROLERIGHTS;   }
	virtual BSTR GetXmlElementKey()  {      return CNR_IOTMNGRXmlRWKeys::CIot_RoleRightsKey();     }
