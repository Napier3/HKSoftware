...
CIotEdgeProtoServer_MqttClientV5::CIotEdgeProtoServer_MqttClientV5()
{
...
// BOOL CIotEdgeProtoServer_MqttClientV5::Connect(const char *pszIP,long nPort)
// {
// 	SYSTEMTIME tm;
// 	GetLocalTime(&tm);
// 
// 	CString strClientID;
// 	strClientID.Format(_T("EdgeProtoSvrExV5_%u_%02d%02d%03d")
...
**************************/
BOOL CIotEdgeProtoServer_MqttClientV5::SubcribeMqttTopic(int nQos)
{
	if (!ConnectServer())
	{
		return FALSE;
...
*/
CString CIotEdgeProtoServer_MqttClientV5::GenerateTopic(const CString &strToSN, long nCmdType, char *pszCmdID, char *pszRetType, char *pszEventID)
{
	CString strTopic;
...
**************************/
BOOL CIotEdgeProtoServer_MqttClientV5::AnalysisTopic(const CString &strTopic, CString &strFromSN, long &nCmdType, char *pszCmdID, char *pszRetType)
{
	...
	CString strDeviceID;
	strFromSN = strDeviceID = oToken.GetToken(1);	
