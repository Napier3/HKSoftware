...
//AtsSvrTestFlows.h  CAtsSvrTestFlows
...
class CAtsSvrTestFlows : public CExBaseList
{
public:
	CAtsSvrTestFlows();
	virtual ~CAtsSvrTestFlows();


//重载函数
public:
	virtual UINT GetClassID() {    return ATSVRCLASSID_CATSSVRTESTFLOWS;   }
	virtual BSTR GetXmlElementKey()  {      return CAtsServiceXmlRWKeys::CAtsSvrTestFlowsKey();     }
