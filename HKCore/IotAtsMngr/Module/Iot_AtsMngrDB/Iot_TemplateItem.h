...
//Iot_TemplateItem.h  CIot_TemplateItem
...
class CIot_TemplateItem : public CExBaseObject
{
public:
	CIot_TemplateItem();
	virtual ~CIot_TemplateItem();
...
//重载函数
public:
	virtual UINT GetClassID() {    return IOTCLASSID_CIOT_TEMPLATEITEM;   }
	virtual BSTR GetXmlElementKey()  {      return CIot_AtsMngrXmlRWKeys::CIot_TemplateItemKey();     }
