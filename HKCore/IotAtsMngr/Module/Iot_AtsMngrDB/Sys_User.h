...
public:
	...
	virtual BSTR GetXmlElementKey()  {      return CIot_AtsMngrXmlRWKeys::CSys_UserKey();     }
	...
	virtual BSTR DB_GetOwnTableName(CXmlRWKeys *pXmlRWKeys)  {      return CIot_AtsMngrXmlRWKeys::CSys_UserKey();     }
	virtual BSTR DB_GetPrimaryKey(CXmlRWKeys *pXmlRWKeys)  {      return CIot_AtsMngrXmlRWKeys::User_IdKey();     }
...
//属性变量访问方法
public:
	long GetIndexUser(CXDbBaseLib *pXDbLib,const CString &strLoginName);
	BOOL QueryUserByUserID(CXDbBaseLib *pXDbLib, long nUser_ID, CString &strUserName);
};
