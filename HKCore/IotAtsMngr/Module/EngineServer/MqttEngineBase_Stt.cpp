...
CMqttEngineBase_Stt::CMqttEngineBase_Stt()
{
...
void CMqttEngineBase_Stt::BufToCmd(CExBaseObject *pCmdBase,char *pBuf,long nLen,const CString &strFormat)
{
...
long CMqttEngineBase_Stt::ReturnSysState(CSttCmdBase *pSttCmd, long nCmdExecStatus,CSttCmdData *pRetData)
{
...
long CMqttEngineBase_Stt::ReturnSysState(CSttCmdBase *pSttCmd, long nCmdExecStatus,const CString &strDeviceID)
{
	CSttSysState oSysState;
	oSysState.UpdateSysStateHead(pSttCmd);
...
long CMqttEngineBase_Stt::ReturnSysState_REPLY(CSttCmmOptrInterface *pCmmOptrInterface, long nCmdExecStatus, CSttCmdData *pRetData
											   , char *pszEventID, char *pszRetCmdType)
{
	...
	pSysState->m_strRetSttCmd = pszRetCmdType;//STT_CMD_SYSSTATE_ATS;   //2021-9-5  lijunqing
...
long CMqttEngineBase_Stt::ReturnSysState_EVENT(CSttCmmOptrInterface *pCmmOptrInterface, CSttCmdData *pRetData, char *pszEventID
											   , char *pszRetCmdType)
{
	//2021-8-6  lijunqing  ??????????? 为什么要重新创建一个CSttSysState
	//CSttSysState oSysState;
...
//2021-8-6  lijunqing
long CMqttEngineBase_Stt::ReturnSysState_REPORT(CSttCmmOptrInterface *pCmmOptrInterface, CSttCmdData *pRetData, char *pszRetCmdType)
{
...
long CMqttEngineBase_Stt::ReturnSysState(CSttCmmOptrInterface *pCmmOptrInterface, CSttCmdBase *pSttCmd, long nCmdExecStatus, const CString &strDeviceID)
{
	CSttSysState oSysState;
	oSysState.UpdateSysStateHead(pSttCmd);
...
long CMqttEngineBase_Stt::ReturnSysState(CSttCmmOptrInterface *pCmmOptrInterface, int nCmdType, char *pszCmdID, BOOL bIsSuccess)
{
	return 0;
}

long CMqttEngineBase_Stt::ReturnSysState(CSttCmmOptrInterface *pCmmOptrInterface, CSttSysState *pSysState, BOOL bSpyAllCmd)
{
	return 0;
}
