...
double CComplexNumber::CalAngle(CComplexNumber &c, long nMode)
{//暂时忽略角度与弧度的差别，都默认为角度
	double dAlgle1 = c.GetAngle_180_180();
	double dAngle2 = GetAngle_180_180();
	double dAngle = GetTheAngleRange_180_180(dAngle2 - dAlgle1);
	return dAngle;
}
