...
void CExBaseListTreeOptrInterface::OnItemCheckChanged(CExBaseListTreeCtrl *pTreeCtrl, CExBaseObject *pSelObj)	{		}
void CExBaseListTreeOptrInterface::OnItemSelChanged(CExBaseListTreeCtrl *pTreeCtrl, CExBaseObject *pSelObj)	{		}
BOOL CExBaseListTreeOptrInterface::OnItemBDblClk(CExBaseListTreeCtrl  *pTreeCtrl, CExBaseObject *pSelObj)	{	return FALSE;	}
