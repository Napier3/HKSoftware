...
public:
	...
	virtual void InitNameAndIDForPaste(CString &strChildObjName, CString &strChildObjID);//zhouhj 2024.10.9
...
public:
	...
	virtual void AddChildByPos(CExBaseObject *pObj, long nAddPos, BOOL bSetParent=TRUE);
};
