...
void CXDrawList::ToXDrawDatas(CXDrawDatas &listDatas)
{
	POS pos = GetHeadPosition();
	CXDrawBase *p = NULL;
	...
	{
		p = (CXDrawBase*)GetNext(pos);
		listDatas.AddTail(p->GetDrawData());
	}
}

//2024-9-24 lijunqing 绘图对象在多个地方存储，扩展CXDrawListEx，析构的时候不删除绘图子对象
CXDrawListEx::CXDrawListEx()
{
