...
public:
	...
	virtual bool IsPointIn(double x, double y);  //点是否在绘图对象上  2024-9-25 lijunqing
};
...
public:
	...
	CXDrawDataBase* PickShortestPoint(double x, double y);
};
...
public:
	...
	void Init_B_by_k_b();  //根据K、起点计算B
	virtual bool IsPointIn(double x, double y);  //点是否在绘图对象上  2024-9-25 lijunqing
	virtual bool IsPointLeft(double x, double y);
	virtual bool IsPointRight(double x, double y);

	void Rotate(double dAngle);

protected:
	//点是否在绘图对象上  2024-9-25 lijunqing
	bool IsPointIn_Beeline(double x, double y);
	bool IsPointIn_Segment(double x, double y);
	bool IsPointIn_Ray(double x, double y);
};
...
public:
	...
	void CalRadius(double x, double y);
