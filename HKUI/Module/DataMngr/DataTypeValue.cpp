...
long CDataTypeValue::ValCmp(CBaseObject* pRightObj)
{
	if (pRightObj->GetClassID() != DTMCLASSID_CDATATYPEVALUE)
	{
		return 1;
	}
	CDataTypeValue *pObj = (CDataTypeValue *)pRightObj;

	return (GetIndex() - pObj->GetIndex());
}
