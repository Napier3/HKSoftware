...
CDataType *CDataTypes::FindAddDataTypeById(const CString &strID, const CString &strName)
{
	CDataType *pFind = (CDataType *)FindByID(strID);
	if (pFind == NULL)
	{
		return AddNew2(strName, strID);
	}
	return pFind;
}
