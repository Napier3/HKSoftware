...
public:
	...
	void ClearDatasetMap(CDvmDatasetMap *pDatasetMap, CDvmDataset *pStandDataset);  //清空映射关系  shaolei 20220209
protected:
...
protected:
    ...
    void CmpDvmFormat(CExBaseList *pMap);
    CDvmDataset * CanonicalFormat(CDvmDataset *pMap);
    CDvmLogicDevice m_OldDest;	//20231031 luozibing 保存格式不规范的信息
