...
protected:
	...
	void UpdatePhaseDeltaValue(double * pValue,  int nChnelCnt);
...
public:
	...
	void UpdateDvmDeviceDatas_Analysis_HarmBase(CDvmValue *pDvmValue,float fActualValue,float fOutputValue,float fErrorValue);//chenling 2024.6.11谐波基波的误差
