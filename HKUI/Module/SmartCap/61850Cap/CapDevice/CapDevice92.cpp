...
//2024-10-25 wuxy 新增定时器时间，在合并单元精确度测试第一次进入监视时延长断链定时器延长为7秒
long g_nCapDevice92RcvOverTime = 7000;

...
// 	return m_oTickCount.GetTickCountLong(FALSE) > 2000; //采样值数据超过2s未收到认为超时
	return m_oTickCount.GetTickCountLong(FALSE) > g_nCapDevice92RcvOverTime;
}
