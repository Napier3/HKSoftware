...
#define Protocol61850_Pkg_Type_BINARY               5
...
int GetTimeGap_EpcapBufferItem(EPCAPBUFFERITEM *pCurrItem,EPCAPBUFFERITEM *pPrevItem,BOOL bUSec = TRUE);//2023.7.23 获取两帧报文之间的时间差,参数3为单位是否为us,否则为ns
unsigned long GetTimeGap_EpcapBufferItem(__int64 u64_CurrTime,__int64 u64_PrevTime,BOOL bUSec = TRUE);
...
bool stt_save_bin_record_file_text(const CString &strSrcAt02dFile, const char *pszSaveTxtFile);//将*.at02d文件转换为txt点表文件20240822zhouyangyong 新增
