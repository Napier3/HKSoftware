...
//XExprErrorCombined_I.h  CXExprErrorCombined_I
...
class CXExprErrorCombined_I : public CXExprBase
{
public:
	CXExprErrorCombined_I();
	virtual ~CXExprErrorCombined_I();

	CString  m_strOptr;  //误差结果与误差限的比较逻辑：<= 或者 <
//重载函数
public:
	virtual UINT GetClassID() {    return XEXPRCLASSID_CXEXPRERRORCOMBINED_I;   }
	virtual BSTR GetXmlElementKey()  {      return CXExprXmlRWKeys::CXExprErrorCombined_IKey();     }
