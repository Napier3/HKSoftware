...
////////////////////////////////////////////////////////////////////////////////////////////////////
//CXExprValueErrorAbs   绝对误差数据对象（绝对误差限）
class CXExprValueErrorAbs_P : public CXExprValue
{
public:
	CXExprValueErrorAbs_P();
	virtual ~CXExprValueErrorAbs_P();

	//重载函数
public:
	virtual UINT GetClassID() {    return XEXPRCLASSID_CXEXPRVALUEERRORABS_P;   }
	virtual BSTR GetXmlElementKey()  {      return CXExprXmlRWKeys::CXExprValueErrorAbs_PKey();     }
	virtual CBaseObject* Clone();
...
////////////////////////////////////////////////////////////////////////////////////////////////////
//CXExprValueErrorAbs_N   绝对误差数据对象（绝对误差限）
class CXExprValueErrorAbs_N : public CXExprValue
{
public:
	CXExprValueErrorAbs_N();
	virtual ~CXExprValueErrorAbs_N();

	//重载函数
public:
	virtual UINT GetClassID() {    return XEXPRCLASSID_CXEXPRVALUEERRORABS_N;   }
	virtual BSTR GetXmlElementKey()  {      return CXExprXmlRWKeys::CXExprValueErrorAbs_NKey();     }
	virtual CBaseObject* Clone();
