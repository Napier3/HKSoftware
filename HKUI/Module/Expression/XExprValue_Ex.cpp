...
/////////////////////////////////////////////////////////////////////////
CXExprValueErrorAbs_P::CXExprValueErrorAbs_P()
{
	//初始化属性
...
CBaseObject* CXExprValueErrorAbs_P::Clone()
{
	CXExprValueErrorAbs_P *p = new CXExprValueErrorAbs_P();
	Copy(p);
	return p;
}

/////////////////////////////////////////////////////////////////////////
CXExprValueErrorAbs_N::CXExprValueErrorAbs_N()
{
	//初始化属性
...
CBaseObject* CXExprValueErrorAbs_N::Clone()
{
	CXExprValueErrorAbs_N *p = new CXExprValueErrorAbs_N();
	Copy(p);
	return p;
}
////////////////////////////////////////////////////////////////////////////////////////////////////
