...
#define XEXPRCLASSID_CXEXPRERROREX_I       (XEXPRCLASSID_EXLISTCLASS + 0X00000020)
#define XEXPRCLASSID_CXEXPRERRORCOMBINED_I       (XEXPRCLASSID_EXLISTCLASS + 0X00000021)
#define XEXPRCLASSID_CXEXPRVALUEERRORABS_P       (XEXPRCLASSID_BASECLASS + 0X00000022)
#define XEXPRCLASSID_CXEXPRVALUEERRORABS_N       (XEXPRCLASSID_BASECLASS + 0X00000023)
...
public:
	...
	BSTR m_strCXExprErrorEx_IKey; //error-ex-i   国际版使用
	BSTR m_strCXExprErrorCombinedKey; //error-combined
	BSTR m_strCXExprErrorCombined_IKey; //error-combined-i  国际版使用
	...
	BSTR m_strErrorAbs_PKey; //error-abs-p	
	BSTR m_strErrorAbs_NKey; //error-abs-n	
...
public:
	...
	static BSTR CXExprErrorEx_IKey()  {   return g_pXmlKeys->m_strCXExprErrorEx_IKey;  }
	static BSTR CXExprErrorCombined_IKey()  {   return g_pXmlKeys->m_strCXExprErrorCombined_IKey;  }
	...
	static BSTR CXExprValueErrorAbs_PKey()	{	return g_pXmlKeys->m_strErrorAbs_PKey;	}	 //error-abs-p
	static BSTR CXExprValueErrorAbs_NKey()	{	return g_pXmlKeys->m_strErrorAbs_NKey;	}	 //error-abs-n
