...
CXExprXmlRWKeys::CXExprXmlRWKeys()
{
	...
	m_strCXExprErrorEx_IKey = L"error-ex-i";   //国际版使用
	m_strCXExprErrorCombined_IKey = L"error-combined-i";   //国际版使用
	...
	m_strErrorAbs_PKey = L"error-abs-p"; //error-abs-p
	m_strErrorAbs_NKey = L"error-abs-n"; //error-abs-n	
