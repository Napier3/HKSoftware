...
static CSttMacroParaEditInterface* new_QSttMacroParaEditViewSoe(const CString &strGridFile)
...
static CSttMacroParaEditInterface* new_QSttMacroParaEditViewMuAutoTest(const CString &strGridFile)
{    return new QSttMacroParaEditViewMuAutoTest();  }

static CSttMacroParaEditInterface* new_QSttMacroParaEditViewRemoteMeas(const CString &strGridFile)
...
static CSttMacroParaEditInterface* new_QSttMacroParaEditViewTerminalAutoTest(const CString &strGridFile)
...
static CSttMacroParaEditInterface* new_QSttMacroParaEditViewVolTimeTypeSec(const CString &strGridFile)
...
static CSttMacroParaEditInterface* new_QSttMacroParaEditViewAdmuAccurAutoTest(const CString &strGridFile)
