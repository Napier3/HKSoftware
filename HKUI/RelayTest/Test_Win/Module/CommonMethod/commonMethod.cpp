...
{
	QStringList List;
	List<<QObject::tr(" 跳  A ")<<QObject::tr(" 跳  B ")<<QObject::tr(" 跳  C ")<<QObject::tr(" 重  合 ")<<QObject::tr(" 后 加 速 ");
...
float setLimit(float min,float max,float val)
{
	if (val<min)
	{
		CLogPrint::LogFormatString(XLOGLEVEL_ERROR,_T("当前设置值(%f)小于最小值(%f),强制设置为最小值."),val,min);
		val = min;
	}
	else if (val>max)
	{
		CLogPrint::LogFormatString(XLOGLEVEL_ERROR,_T("当前设置值(%f)大于最大值(%f),强制设置为最大值."),val,max);
		val = max;
	}
	return val;
}
...
{
	CString strIndex =_T("");
	if (strAPPChID == _T("I1-1"))
	{
		strIndex =_T("0");
	}
	else if (strAPPChID == _T("I1-2"))
	{
		strIndex =_T("1");
	}
	else if (strAPPChID == _T("I1-3"))
	{
		strIndex =_T("2");
	}
	else if (strAPPChID == _T("I2-1"))
	{
		strIndex =_T("3");
	}
	else if (strAPPChID == _T("I2-2"))
	{
		strIndex =_T("4");
	}
	else if (strAPPChID == _T("I2-3"))
	{
		strIndex =_T("5");
	}
	else if (strAPPChID == _T("I3-1"))
	{
		strIndex =_T("6");
	}
	else if (strAPPChID == _T("I3-2"))
	{
		strIndex =_T("7");
	}
	else if (strAPPChID == _T("I3-3"))
	{
		strIndex =_T("8");
	}
	else if (strAPPChID == _T("I4-1"))
	{
		strIndex =_T("9");
	}
	else if (strAPPChID == _T("I4-2"))
	{
		strIndex =_T("10");
	}
	else if (strAPPChID == _T("I4-3"))
	{
		strIndex =_T("11");
	}
...
{
	CString strIndex =_T("");
	if (strAPPChID == _T("U1-1"))
	{
		strIndex =_T("0");
	}
	else if (strAPPChID == _T("U1-2"))
	{
		strIndex =_T("1");
	}
	else if (strAPPChID == _T("U1-3"))
	{
		strIndex =_T("2");
	}
	else if (strAPPChID == _T("U2-1"))
	{
		strIndex =_T("3");
	}
	else if (strAPPChID == _T("U2-2"))
	{
		strIndex =_T("4");
	}
	else if (strAPPChID == _T("U2-3"))
	{
		strIndex =_T("5");
	}
	else if (strAPPChID == _T("U3-1"))
	{
		strIndex =_T("6");
	}
	else if (strAPPChID == _T("U3-2"))
	{
		strIndex =_T("7");
	}
	else if (strAPPChID == _T("U3-3"))
	{
		strIndex =_T("8");
	}
...
{
	CString strIndex =_T("");
	if (strAPPChID == _T("zero"))
	{
		strIndex =_T("0");
	}
	else if (strAPPChID == _T("I1-1"))
	{
		strIndex =_T("1");
	}
	else if (strAPPChID == _T("I1-2"))
...
{
// 	if (fAngle >= 360)  //zhouhj 20220120  需要将传入参数转换到正常范围内,而不是直接赋值
// 	{
// 		fAngle = 360;
// 	}
// 
...
// 	return;
	...
	{
		CLogPrint::LogFormatString(XLOGLEVEL_ERROR,_T("当前相位值越限出错(%f)."),fAngle);
		fAngle = 0;
		return;
	}
...
;
	...
	if (ch[0] == 1)
	{
		tempStr[0] = QObject::tr("跳A");
	}

	if (ch[1] == 1)
	{
		tempStr[1] = QObject::tr("跳B");
	}

	if (ch[2] == 1)
	{
		tempStr[2] = QObject::tr("跳C");
	}

	if (ch[3] == 1)
	{
		tempStr[3] = QObject::tr("跳D");
	}

	if (ch[4] == 1)
	{
		tempStr[4] = QObject::tr("跳E");
	}

	if (ch[5] == 1)
	{
		tempStr[5] = QObject::tr("跳F");
	}

	if (ch[6] == 1)
	{
		tempStr[6] = QObject::tr("跳G");
	}

	if (ch[7] == 1)
	{ 
		tempStr[7] = QObject::tr("跳H");
	}
