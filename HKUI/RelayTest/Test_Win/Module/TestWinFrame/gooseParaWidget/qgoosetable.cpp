...
void QGooseTable::initUI()
{
	...
	QStringList headers;
	headers<</*tr("描述")*/g_sLangTxt_State_Description<</*tr("数据类型")*/g_sLangTxt_DataType<</*tr("映射")*/g_sLangTxt_Native_Maps<</*tr("数值")*/g_sLangTxt_Value<</*tr("取反")*/g_sLangTxt_Native_Reverse;
