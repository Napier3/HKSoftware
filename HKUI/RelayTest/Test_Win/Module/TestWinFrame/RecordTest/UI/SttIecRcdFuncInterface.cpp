...
// 		}
// 
// 		QSttMUTestChsSetDlg oSttMUTestChsSetDlg(pParent);
...
// 				((CXSttCap_61850*)g_theXSmartCapMngr->m_pX61850Cap)->SetPT_CT_Rates(pIecCfgSysParas->GetPrimRatesIn());
...
// 		Global_SoftKeyBoardAttachObj(&oIecRecordSysSetDlg);// suyang 
...
// #endif
		g_oSttTestResourceMngr.SaveDefaultIec61850Config();
		g_oCapAnalysisConfig.Save();
		((CXSttCap_61850*)g_theXSmartCapMngr->m_pX61850Cap)->SetPT_CT_Rates(pIecCfgSysParas->GetPrimRatesIn(),FALSE);
