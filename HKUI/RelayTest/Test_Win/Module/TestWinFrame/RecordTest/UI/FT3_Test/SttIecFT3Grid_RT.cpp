...
void CSttIecFT3Grid_RT::IecRcdFunc(CCapDeviceBase *pCapDevice)
{
	...
	m_pCfgChs = pCfgDataBase->m_pCfgChs;
...
{
	CIecCfg6044CommonCh *pIecCfgFT3Ch = (CIecCfg6044CommonCh *)m_pCfgChs->FindByID(pData->m_strID);
...
void CSttIecFT3Grid_RT::UpdateData(CExBaseObject *pData, int nRow)
{
	...
	CIecCfg6044CommonCh *pIecCfgFT3Ch = (CIecCfg6044CommonCh *)m_pCfgChs->FindByID(pChData->m_strID);
