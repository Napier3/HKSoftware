...
// 	strGroupName = QString(QObject::tr("第%1组(U%2,U%3,U%4,I%5,I%6,I%7)")).arg(nGroupIndex+1).arg(nGroupIndex*3+1).arg(nGroupIndex*3+2).arg(nGroupIndex*3+3)
...
// 		m_pPT_Rate_Label[nGroupIndex]->setText(tr("PT变比:"));
...
// 		m_pPT_Unit1_Label[nGroupIndex]->setText(tr("V/"));
...
// 		m_pPT_Unit2_Label[nGroupIndex]->setText(tr("V"));
...
// 		m_pCT_Rate_Label[nGroupIndex]->setText(tr("CT变比:"));
...
// 		m_pCT_Unit1_Label[nGroupIndex]->setText(tr("A/"));
...
// 		m_pCT_Unit2_Label[nGroupIndex]->setText(tr("A"));
