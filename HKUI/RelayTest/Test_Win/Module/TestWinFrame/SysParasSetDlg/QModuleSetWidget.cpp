...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	m_pCurGear_Label->setText(tr("电流档位设置:"));
	...
	m_pCurMaxPortVol_Label->setText(tr("最大端口电压(Vrms):"));
	...
	m_pLargeCurTerminal_CheckBox = new QCheckBox(m_pCurModule_GroupBox);
	m_pLargeCurTerminal_CheckBox->setText(tr("合并电流端子输出(6I合并为3I或采用大电流端子输出)"));
	...
	m_pLargeCurOutTerm_Label->setText(tr("大电流输出端口:"));
...
//	m_pAntiShakeTime_LineEdit->SetValue(m_pSysParas->m_fStabTime);
	...
	m_pCurGear_ComboBox->insertItem(0,tr("1档(0.2Ω/10A)"));
	m_pCurGear_ComboBox->insertItem(1,tr("2档(0.3Ω/10A)"));
	m_pCurGear_ComboBox->insertItem(2,tr("3档(0.7Ω/10A)"));
	m_pCurGear_ComboBox->insertItem(3,tr("其他"));
