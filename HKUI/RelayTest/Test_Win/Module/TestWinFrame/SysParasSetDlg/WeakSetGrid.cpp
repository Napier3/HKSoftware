...
{
	CString astrGridTitle[WEAKSET_GRID_COLS] = {/*_T("名称")*/g_sLangTxt_Name,/*_T("软件资源标识"),*//*_T("弱信号通道")*/g_sLangTxt_ChMaps_WeekCh,/*_T("一次值(V/A)")*/g_sLangTxt_Gradient_VAOnceValue,/*_T("二次值(V/A)")*/g_sLangTxt_Gradient_VATwiceValue};
...
void CWeakSetGrid::CreateGridMenu()
{
	...
	m_pThreePhaseEqualAction = new QAction(/*tr("三相相同")*/g_sLangTxt_Gradient_SameThreep,this);
	m_pThreePhaseEqualAction->setCheckable(true);
	m_pThreePhaseEqualAction->setCheckable(false);
	m_pAllEqualAction = new QAction(/*tr("全部相同")*/g_sLangTxt_Gradient_AllSamep,this);
