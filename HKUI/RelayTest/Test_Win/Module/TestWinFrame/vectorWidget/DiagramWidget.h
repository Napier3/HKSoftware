...
#define STT_COMMON_VECTOR_TABLE				0//0-普通矢量图表格
#define STT_ULOCKOVERCURRENT_VECTOR_TABLE	1//复压闭锁矢量图表格
#define STT_POWERDIRECTION_VECTOR_TABLE		2//功率方向矢量图表格
...
//	void creatUIMaxDisp();
//	void setUMaxDisp(bool b);
//	void setIMaxDisp(bool b);
	...
	void setFaultInfo(CSttMacroChannel* pUfCh = NULL,CSttMacroChannel* pIfCh = NULL);
	...
	void setUnitOfTable(QStringList str);
	void setUnitDispMode(bool b,int mode);
	void InsertNewLineOfTable(QStringList str,bool bUse);//20211020 sf 复压闭锁 用其他不用
	void SetVectorTableUseType(int nTableUseType);//2023-12-26 zhouyangyong 复压闭锁，功率方向表格单独处理
...
//	void slot_lneUMaxChanged();
//	void slot_lneIMaxChanged();
...
//	QLineEdit *m_lneIMax;
	...
	int m_nTableUseType;//2023-12-26 zhouyangyong 复压闭锁，功率方向模块需要单独处理
