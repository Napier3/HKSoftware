...
#include <QMenu>
#include <QAction>
#include "../../Module/SttTest/Common/Diff/tmt_diff_curr_test.h"
...
struct MakerLine
{
	tmt_DiffCurrThrTest* m_pCurrThrTest;
...
class CDifferCharacPlot: public QwtPlot
{
    Q_OBJECT

public:
    CDifferCharacPlot( QWidget *parent =NULL);
	void setData(TMT_PARAS_MNGR* pTmtTestMngr);

	void updatePlot();
	void updatePlotPos(tmt_DiffCurrThrTest* pCurrThrTest);
	void updateSymbolPos(tmt_DiffCurrThrTest* pCurrThrTest,bool bEnd=true);
	void clearSymbolPos(tmt_DiffCurrThrTest* pCurrThrTest);
	void updateLabelTest(tmt_DiffCurrThrTest* pCurrThrTest);
	
	void clearResultAll();
	void clearResult(tmt_DiffCurrThrTest* pCurrThrTest);
	...
	void setValueByInfo(tmt_DiffCurrThrTest* pCurrThrTest, float fx, float fy);
...
public slots:
   	void slot_AddOneTest(tmt_DiffCurrThrTest* pCurrThrTest);
	void slot_DelOneTest(tmt_DiffCurrThrTest* pCurrThrTest);
	void slot_DelAllTest(tmt_DiffCurrThrTest* pCurrThrTest);
...
private:
	...
	QwtPlotMarker *getMarkerByTestInfo(tmt_DiffCurrThrTest* pCurrThrTest);
	QwtPlotCurve *getCurveByTestInfo(tmt_DiffCurrThrTest* pCurrThrTest);
	...
	tmt_DiffCurrThrTest* m_pCommonParaTest;
