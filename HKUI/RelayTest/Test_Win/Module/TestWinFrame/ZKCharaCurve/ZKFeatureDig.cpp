...
{
	ui.setupUi(this);
        this->setWindowTitle(g_sLangTxt_Native_ImpedanceEditBox);
	m_bSetting = bSetting;
...
void ZKFeatureDig::InitTableWidget()
{
	...
	int nWidth=20;
	QDesktopWidget* desktopWidget = QApplication::desktop(); //20240103 gongyiping 分辨率大于1920
	...
	if (m_bSetting)
	{
		ui.tableWidget_Info->setColumnCount(5);
            ...
            headers << /*tr("编号")*/ g_sLangTxt_Index
            << /*tr("变量名称")*/ g_sLangTxt_Native_VarName
            << /*tr("变量ID")*/ g_sLangTxt_VariableID
            << /*tr("数值")*/ g_sLangTxt_Value
            << /*tr("关联定值")*/ g_sLangTxt_AssociationValue;
		ui.tableWidget_Info->setHorizontalHeaderLabels(headers);
		ui.tableWidget_Info->setColumnWidth(0,nWidth*2);//40
		ui.tableWidget_Info->setColumnWidth(1,nWidth*4);//80
		ui.tableWidget_Info->setColumnWidth(2,nWidth*4);//80
		ui.tableWidget_Info->setColumnWidth(3,nWidth*4);//80
		ui.tableWidget_Info->setColumnWidth(4,nWidth*10);//200
	...
	ui.tableWidget_Info2->setColumnCount(5);
        ...
        headers_2 << /*tr("编号")*/ g_sLangTxt_Index
            << /*tr("边类型")*/ g_sLangTxt_EdgeType
            << /*tr("测点数")*/ g_sLangTxt_TestPoint
            << /*tr("误差带")*/ g_sLangTxt_ErrorBand
            << /*tr("边详细信息")*/ g_sLangTxt_EdgeDetails;
	ui.tableWidget_Info2->setHorizontalHeaderLabels(headers_2);
	ui.tableWidget_Info2->setColumnWidth(0,nWidth*2);//40
	ui.tableWidget_Info2->setColumnWidth(1,nWidth*5);//80
	ui.tableWidget_Info2->setColumnWidth(2,nWidth*3);//60
	ui.tableWidget_Info2->setColumnWidth(3,nWidth*5);//100
	ui.tableWidget_Info2->setColumnWidth(4,nWidth*20);//400
}
