...
void QSttSelSclFileWidget::InitUI()
{
	...
	m_pBtns_HBoxLayout->addWidget(m_pOK_PushButton);
	...
	m_pAddScl_Btn->setFixedWidth(100);
	m_pDelCurr_Btn->setFixedWidth(100);
	m_pClearAll_Btn->setFixedWidth(100);
	m_pSclIedSelect_Btn->setFixedWidth(100);
...
void QSttSelSclFileWidget::slot_AddScl_Clicked()
{
	...
	strFolderPath = g_oFileMngrTool.GetFolderPath("SCD");
...
// 	}
	...
	oScdFileRWDlg.setWindowTitle(CString(("SCL解析界面")));
	CTickCount32 oWait; 
	...
	return Global_SaveSclCfgs(strSclFilePath, pSclStation,strFileID);
}
...
CString Global_SaveSclCfgs(const CString &strSclFilePath, CSclStation *pSclStation,const CString &strFileID)
{
