...
//	xlang_GetLangStrByFile(g_sLangTxt_Native_SCLPath,"IEC_Select");
	...
	m_pSttSelSclFileWidget->m_pOK_PushButton->setVisible(true);
...
//	m_pMainVLayout->addLayout(m_pOK_CancelHLayout);
	...
	connect(m_pSttSelSclFileWidget->m_pOK_PushButton, SIGNAL(clicked()), this, SLOT(slot_OKClicked()));
}
