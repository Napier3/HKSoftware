...
void CSclCtrlsGooseOutGrid::InitGridTitle()
{
	...
	{
		int iGridWidth[SCLCTRLS_GOOSEOUT_GRID_COLS]={50*g_dUIShowCoef/*,140*g_dUIShowCoef*/, 80*g_dUIShowCoef, 170*g_dUIShowCoef, 50*g_dUIShowCoef, 80*g_dUIShowCoef, 100*g_dUIShowCoef, 
			100*g_dUIShowCoef, 150*g_dUIShowCoef, 150*g_dUIShowCoef, 100*g_dUIShowCoef, 120*g_dUIShowCoef,80*g_dUIShowCoef};
		QExBaseListGridBase::InitGridTitle(astrGridTitle, iGridWidth, SCLCTRLS_GOOSEOUT_GRID_COLS);

	}
	else
	{
		int iGridWidth[SCLCTRLS_GOOSEOUT_GRID_COLS]={50/*,140*/, 80, 170, 50, 80, 100, 100, 150, 150, 100, 120,80};
	QExBaseListGridBase::InitGridTitle(astrGridTitle, iGridWidth, SCLCTRLS_GOOSEOUT_GRID_COLS);
