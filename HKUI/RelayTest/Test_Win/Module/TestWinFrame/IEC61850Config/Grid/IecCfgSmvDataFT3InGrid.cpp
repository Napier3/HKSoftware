...
void CIecCfgSmvDataFT3InGrid::InitGridTitle()
{
	...
	{
		int iGridWidth[IECCFGSMVDATAFT3_GRID_COLS]={50*g_dUIShowCoef, 130*g_dUIShowCoef, 120*g_dUIShowCoef, 120*g_dUIShowCoef, 265*g_dUIShowCoef, 120*g_dUIShowCoef};
		QExBaseListGridBase::InitGridTitle(astrGridTitle, iGridWidth, IECCFGSMVDATAFT3_GRID_COLS);
	}
	else
	{
		int iGridWidth[IECCFGSMVDATAFT3_GRID_COLS]={50, 130, 120, 120, 265, 120};
  	        QExBaseListGridBase::InitGridTitle(astrGridTitle, iGridWidth, IECCFGSMVDATAFT3_GRID_COLS);
	}
...
// 		QMessageBox::information(this, tr("提示"),tr("FT3接收口已全部占用，当前无可选择的FT3口！"));
// 	}
