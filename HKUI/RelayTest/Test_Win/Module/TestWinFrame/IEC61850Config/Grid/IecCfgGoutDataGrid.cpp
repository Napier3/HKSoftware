...
void CIecCfgGoutDataGrid::InitGridTitle()
{
	...
	{
		int iGridWidth[IECCFGGOUTDATA_GRID_COLS]={50*g_dUIShowCoef, 100*g_dUIShowCoef, 200*g_dUIShowCoef, 100*g_dUIShowCoef, 100*g_dUIShowCoef, 105*g_dUIShowCoef,220*g_dUIShowCoef
			, 220*g_dUIShowCoef, 160*g_dUIShowCoef, 160*g_dUIShowCoef,  100*g_dUIShowCoef, 150*g_dUIShowCoef, 260*g_dUIShowCoef, 2600*g_dUIShowCoef,260*g_dUIShowCoef,150*g_dUIShowCoef};
		QExBaseListGridBase::InitGridTitle(astrGridTitle, iGridWidth, IECCFGGOUTDATA_GRID_COLS);
	}
	else
	{
		int iGridWidth[IECCFGGOUTDATA_GRID_COLS]={50, 100, 200, 100, 100, 105,220, 220, 160, 160,  100, 150, 260, 260,260,150};
	         QExBaseListGridBase::InitGridTitle(astrGridTitle, iGridWidth, IECCFGGOUTDATA_GRID_COLS);
