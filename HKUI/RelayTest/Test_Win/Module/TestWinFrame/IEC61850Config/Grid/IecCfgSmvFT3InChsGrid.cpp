...
#define STT_IECCFG_FT3IN_GridIndex_CodeValue	         4
#define STT_IECCFG_FT3IN_GridIndex_ChLenth               5
#define STT_IECCFG_FT3IN_GridIndex_BinMap                6
#define STT_IECCFG_FT3IN_GridIndex_AccuracyLevel         7


CString Global_GetCodeValueMapString(CIecCfg6044CommonChIn *pIecCfgFT3Ch)
{
...
void CIecCfgSmvFT3InChsGrid::InitGridTitle()
{
	...
	CString astrGridTitle[IECCFGSMVFT3InCHS_GRID_COLS] = {strChChoose,g_sLangTxt_IEC_ChDescription,g_sLangTxt_IEC_ChType,g_sLangTxt_IEC_ChMaps,_T("码值对应关系"),
		g_sLangTxt_IEC_ChByteLen,g_sLangTxt_IEC_InputMap,"准确级"};
	int iGridWidth[IECCFGSMVFT3InCHS_GRID_COLS]={80,200,200,250,200,150,150,150};
...
void CIecCfgSmvFT3InChsGrid::ShowData(CExBaseObject *pData, int& nRow, BOOL bInsertRow)
{
	...
	{
		pIecCfgFT3ChIn->m_strName.Format(/*_T("通道%d")*/g_sLangTxt_Native_ChnN.GetString(),nCurrChIndex+1);
	}
...
// 	}
	...
	Show_StaticString(pIecCfgFT3Ch,nRow,STT_IECCFG_FT3IN_GridIndex_CodeValue,strText);
...
void CIecCfgSmvFT3InChsGrid::EndEditCell_SmvFT3ChMapSelChangged(int nRow, int nCol, QGV_ITEM *pCell, QExBaseListGridBase *pGrid)
{
	...
	CIecCfg6044CommonChIn *pIecCfgFT3ChIn = (CIecCfg6044CommonChIn*)pVCellData->pObj;
	CString strText;
	strText = Global_GetCodeValueMapString(pIecCfgFT3ChIn);
	((CIecCfgSmvFT3InChsGrid*)pGrid)->Show_StaticString(pIecCfgFT3Ch,nRow,STT_IECCFG_FT3IN_GridIndex_CodeValue,strText);
...
void CIecCfgSmvFT3InChsGrid::slot_BinMap_Clicked( int nRow,int nCol )
{
	...
	//2024-5-23 wuxinyi 打开开入映射弹窗
	if(isBinMapEnabled && nCol == STT_IECCFG_FT3IN_GridIndex_BinMap)
	{
		emit sig_OpenBinMapDialog();
	}
