...
void CSclCtrlsGooseInGrid::InitGridTitle()
{
	...
	{
		int iGridWidth[SCLCTRLS_GOOSEIN_GRID_COLS]={40*g_dUIShowCoef/*, 140*/,80*g_dUIShowCoef, 200*g_dUIShowCoef,170*g_dUIShowCoef, 40*g_dUIShowCoef, 80*g_dUIShowCoef,
			100*g_dUIShowCoef, 100*g_dUIShowCoef, 150*g_dUIShowCoef, 150*g_dUIShowCoef, 150*g_dUIShowCoef, 200*g_dUIShowCoef,80*g_dUIShowCoef,80*g_dUIShowCoef,80*g_dUIShowCoef};
