...
//	strAccuratyLevel = tr("准确级");
	...
	int iGridWidth[IECCFGSMV92INCHS_GRID_COLS]={80,200, 150,150,150};
...
void CIecCfgSmv92InChsGrid::ShowData(CExBaseObject *pData, int& nRow, BOOL bInsertRow)
{
	...
	{
		pIecCfg92Ch->m_strName.Format(_T("通道%d"),nCurrChIndex+1);
	}

	Show_String(pData,nRow,1,&pIecCfg92Ch->m_strName);
