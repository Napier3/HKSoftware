...
#include "../../../../../Module/UI/SttStyleSheetGlobalDefine.h"
...
void CIecCfgPrimRateGrid::InitGridTitle()
{
	...
	CString astrGridTitle[IECCFGPRIMRATE_GRID_COLS] = {strType,strPrimDesc,strSecondDesc};//g_sLangTxt_Native_Type->strType，实际上是去掉了类型后边的冒号 20240506
	int iGridWidth[IECCFGPRIMRATE_GRID_COLS]={80, 170,145};//wangtao 2880X1800分辨率处理 第二个参数由145->170 20240506
