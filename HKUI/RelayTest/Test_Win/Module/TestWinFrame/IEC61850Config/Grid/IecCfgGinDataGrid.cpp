...
void CIecCfgGinDataGrid::InitGridTitle()
{
	...
	{
		int iGridWidth[IECCFGGINDATA_GRID_COLS]={50*g_dUIShowCoef, 100*g_dUIShowCoef, 200*g_dUIShowCoef, 100*g_dUIShowCoef, 100*g_dUIShowCoef, 200*g_dUIShowCoef, 
			100*g_dUIShowCoef, 150*g_dUIShowCoef, 120*g_dUIShowCoef, 260*g_dUIShowCoef, 260*g_dUIShowCoef, 240*g_dUIShowCoef, 170*g_dUIShowCoef, 310*g_dUIShowCoef};
		QExBaseListGridBase::InitGridTitle(astrGridTitle, iGridWidth, IECCFGGINDATA_GRID_COLS);

	}
	else
	{
		int iGridWidth[IECCFGGINDATA_GRID_COLS]={50, 100, 200, 100, 100,200, 100, 150, 120, 260, 260, 240, 170, 310};
	        QExBaseListGridBase::InitGridTitle(astrGridTitle, iGridWidth, IECCFGGINDATA_GRID_COLS);
