...
void CIecCfgSmvData92Grid::InitGridTitle()
{
	...
	{
		int iGridWidth[IECCFGSMVDATA92_GRID_COLS]={50*g_dUIShowCoef, 80*g_dUIShowCoef,220*g_dUIShowCoef,130*g_dUIShowCoef,110*g_dUIShowCoef,70*g_dUIShowCoef,160*g_dUIShowCoef,
			190*g_dUIShowCoef, 190*g_dUIShowCoef,  145*g_dUIShowCoef, 100*g_dUIShowCoef, 90*g_dUIShowCoef,  220*g_dUIShowCoef, 120*g_dUIShowCoef};
		QExBaseListGridBase::InitGridTitle(astrGridTitle, iGridWidth, IECCFGSMVDATA92_GRID_COLS);
	}
	else
	{
		int iGridWidth[IECCFGSMVDATA92_GRID_COLS]={50, 80,220,130,110,70,160, 190, 190,  145, 100, 90,  220, 120};
	         QExBaseListGridBase::InitGridTitle(astrGridTitle, iGridWidth, IECCFGSMVDATA92_GRID_COLS);
	}
