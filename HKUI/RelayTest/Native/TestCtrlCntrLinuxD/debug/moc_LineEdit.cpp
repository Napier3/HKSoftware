...
#include "../../../Module/UI/Module/GooseParaWidget/LineEdit.h"
...
static const char qt_meta_stringdata_CLineEdit[] = {
    "CLineEdit\0\0text\0OnTextChanged(QString)\0"
    "oldPos,newPos\0OnCursorPositionChanged(int,int)\0"
};
...
void CLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        CLineEdit *_t = static_cast<CLineEdit *>(_o);
        switch (_id) {
        case 0: _t->OnTextChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->OnCursorPositionChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
