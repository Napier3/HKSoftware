...
BOOL CSttServerTestCtrlCntr::EventProcessEx()
{
	return g_pCSttServerTestCtrlCntr->In_EventProcessEx();
}
...
BOOL CSttServerTestCtrlCntr::In_EventProcessEx()
{
	if (m_pCurrSttTest != NULL && m_pCurrSttTest->GetTestStarting())
	{
		return m_pCurrSttTest->EventProcessEx();
	}
