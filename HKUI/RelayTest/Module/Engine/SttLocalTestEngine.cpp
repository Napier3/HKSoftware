...
CSttLocalTestEngine::CSttLocalTestEngine()
{
...
// BOOL CSttLocalTestEngine::ConnectServer(const CString &strIPServer, long nPort)
// {
// 	ASSERT (m_pSttClientSocket != NULL);
// 	return m_pSttClientSocket->ConnectServer(strIPServer, nPort);
// }
// 
// long CSttLocalTestEngine::Process_Cmd_Test(CSttSocketDataBase *pClientSocket, CSttTestCmd &oTestCmd)
// {
// 	
// 	return 0;
// }
// 
// long CSttLocalTestEngine::Process_Cmd_Ats(CSttSocketDataBase *pClientSocket, CSttAtsCmd &oAtsCmd)
// {
// 	return 0;
// }
// 
// long CSttLocalTestEngine::Process_SysState(CSttSocketDataBase *pClientSocket, CSttSysState &oSysState)
// {
// 	long nValue = 0;
...
// }
// 
// long CSttLocalTestEngine::Process_SysState_Login(CSttSysState &oSysState)
// {
...
// }
// 
// long CSttLocalTestEngine::Process_SysState_Logout(CSttSysState &oSysState)
// {
// 	if (m_oClientUserMngr.UpdateUserList(oSysState))
// 	{	
// 		if (!UpdateLoginUser(&m_oCurrUser))
...
// }
// 
// long CSttLocalTestEngine::Process_SysState_Request(CSttSysState &oSysState)
// {
// 	BOOL bMatch = FALSE;
// 
...
// }
// 
// long CSttLocalTestEngine::Process_SysState_Query(CSttSysState &oSysState)
// {
// 	UpdateRegisterList(oSysState);
// 	return 1;
// }
// 
// long CSttLocalTestEngine::Process_SysState_Bind(CSttSysState &oSysState)
// {
// 	long nID_Remote = 0;
// 	
...
// }
// 
// long CSttLocalTestEngine::Process_SysState_UnRegister(CSttSysState &oSysState)
// {
// 	OnLogout();
...
// }
// 
// long CSttLocalTestEngine::Process_SysState_Authority(CSttSysState &oSysState)
// {
// 	BOOL bMatch = FALSE;
// 
// 	if (OnUpdate_Users(oSysState,bMatch))
...
// }
// 
// BOOL CSttLocalTestEngine::OnUpdate_Users(CSttSysState &oSysState,BOOL &bMatch)
// {
...
// }
// 
// void CSttLocalTestEngine::OnLogout()
// {
