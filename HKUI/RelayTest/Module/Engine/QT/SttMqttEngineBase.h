...
#include "../../MQTTClient/SttMqttClient_QT.h"
...
public:
	virtual void Connect(const CString &strIP,long nPort, const CString &strClientIDKey,const CString &strUser,const CString &strPwd,BOOL bAuthority = FALSE);
	...
	void PublicTopic(char *strTopic, char *pBuf, long nLen);
	void PublicTopic(CSttMqttTopicCmbn &oTopicCmbn);
