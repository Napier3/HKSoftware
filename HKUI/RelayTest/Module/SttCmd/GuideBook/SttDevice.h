...
public:
    ...
    virtual BOOL ExprCal_Min(CExBaseList* pListReportsForCal, const CString &strExpression, double &dValRet)
    {
#ifdef _PSX_IDE_QT_
        (void)pListReportsForCal;
        (void)strExpression;
    ...
    virtual BOOL ExprCal_Max(CExBaseList* pListReportsForCal, const CString &strExpression, double &dValRet)
    {
#ifdef _PSX_IDE_QT_
        (void)pListReportsForCal;
        (void)strExpression;
