...
CString CSttPik100Test::m_strMacroID = ("SttPik100Test");
...
void CSttPik100Test::Report_XmlSerialize(CSttXmlSerializeBase *pXmlSerialize)
{
    stt_xml_serialize(&m_oPik100Result,pXmlSerialize);
}
