#include "stdafx.h"
#include "SttLowFreqDfDtTest_Pnv.h"
...
CString CSttLowFreqDfDtPnvTest::m_strMacroName = "低周减载滑差闭锁值测试";
CString CSttLowFreqDfDtPnvTest::m_strMacroID = STT_MACRO_ID_PnvLowFreqDfdt;
CString CSttLowFreqDfDtPnvTest::m_strFilePostFix = "pnvlfd";
CString CSttLowFreqDfDtPnvTest::m_strMacroVer ="1.0";

CSttLowFreqDfDtPnvTest::CSttLowFreqDfDtPnvTest() : CSttLowFreqDfDtTest()
{
...
CSttLowFreqDfDtPnvTest::~CSttLowFreqDfDtPnvTest(void)
{

}

void CSttLowFreqDfDtPnvTest::Para_XmlSerialize(CSttXmlSerializeBase *pXmlSerialize)
{
    stt_xml_serialize_PnvLowFreqDfdt(this,pXmlSerialize);
...
void CSttLowFreqDfDtPnvTest::Report_XmlSerialize(CSttXmlSerializeBase *pXmlSerialize)
{
    stt_xml_serialize_PnvLowFreqDfdt(&m_oResults, pXmlSerialize);
}

void CSttLowFreqDfDtPnvTest::TranslateToStateParas()
{
    ...
    paraState1->m_fTimeState = fabs(m_fFnom-m_fFend)/fCurDfDt + m_fHoldTime;
	...
	for (int nIndex = 0;nIndex<3;nIndex++)
    {
        ...
        paraState2->m_uiCUR[nIndex].Harm[1].fFreq = m_fFend;
        paraState2->m_uiVOL[nIndex].Harm[1].fFreq = m_fFend;
    ...
    paraState2->m_fTimeState = fabs(m_fFnom-m_fFend)/fCurDfDt + 0.5;
