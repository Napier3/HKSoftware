...
//zhouhj 2024.4.28 增加参数区分当前故障类型是否为单跳,单相跳闸时,固定按逻辑或处理
void Global_SetStateBinFault(tmt_StatePara *pStatePara,long *pnStateBInput,long nBinSelect,bool bIsLNFaultType);//设置故障态开入
...
bool Global_IsLNFaultType(int nFaultType);//判断是否为单相接地故障类型
