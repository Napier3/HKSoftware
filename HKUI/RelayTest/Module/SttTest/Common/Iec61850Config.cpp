...
void CIec61850Config::Para_XmlSerialize(CSttXmlSerializeBase *pXmlSerialize)
{
	...
	CIEC61850CfgMngr *pIEC61850CfgMngr = (CIEC61850CfgMngr*)(CSttDeviceBase::g_pSttDeviceBase->GetIec61850CfgMngr());
	m_pIecCfgDatasMngr = (CIecCfgDatasMngr*)&pIEC61850CfgMngr->m_oIecCfgDatasMngr;
#else
	if (m_pIecCfgDatasMngr == NULL)
	{
