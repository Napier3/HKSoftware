...
//    pXmlSierialize->xml_serialize("开入防抖时间","_SureTime","s","number",&pParas->m_fStabTime);
    pBinSerialize->xml_serialize("开入A选择","_BinSelectA","","BOOL",pParas->m_oBinaryConfig.m_binIn[0].nSelect);
    pBinSerialize->xml_serialize("开入B选择","_BinSelectB","","BOOL",pParas->m_oBinaryConfig.m_binIn[1].nSelect);
    pBinSerialize->xml_serialize("开入C选择","_BinSelectC","","BOOL",pParas->m_oBinaryConfig.m_binIn[2].nSelect);
    pBinSerialize->xml_serialize("开入R选择","_BinSelectR","","BOOL",pParas->m_oBinaryConfig.m_binIn[3].nSelect);
    pBinSerialize->xml_serialize("开入a选择","_BinSelecta","","BOOL",pParas->m_oBinaryConfig.m_binIn[4].nSelect);
    pBinSerialize->xml_serialize("开入b选择","_BinSelectb","","BOOL",pParas->m_oBinaryConfig.m_binIn[5].nSelect);
    pBinSerialize->xml_serialize("开入c选择","_BinSelectc","","BOOL",pParas->m_oBinaryConfig.m_binIn[6].nSelect);
    pBinSerialize->xml_serialize("开入r选择","_BinSelectr","","BOOL",pParas->m_oBinaryConfig.m_binIn[7].nSelect);
}
...
void stt_xml_serialize_binary_out(tmt_HarmParas *pParas, CSttXmlSerializeBase *pXmlSierialize)
{
    ...
    pBoutSerialize->xml_serialize("开出1状态","_Bout1","","DOutputState",pParas->m_oBinaryConfig.m_binOut[0].nState);
    pBoutSerialize->xml_serialize("开出2状态","_Bout2","","DOutputState",pParas->m_oBinaryConfig.m_binOut[1].nState);
    pBoutSerialize->xml_serialize("开出3状态","_Bout3","","DOutputState",pParas->m_oBinaryConfig.m_binOut[2].nState);
    pBoutSerialize->xml_serialize("开出4状态","_Bout4","","DOutputState",pParas->m_oBinaryConfig.m_binOut[3].nState);
    pBoutSerialize->xml_serialize("开出5状态","_Bout5","","DOutputState",pParas->m_oBinaryConfig.m_binOut[4].nState);
    pBoutSerialize->xml_serialize("开出6状态","_Bout6","","DOutputState",pParas->m_oBinaryConfig.m_binOut[5].nState);
    pBoutSerialize->xml_serialize("开出7状态","_Bout7","","DOutputState",pParas->m_oBinaryConfig.m_binOut[6].nState);
    pBoutSerialize->xml_serialize("开出8状态","_Bout8","","DOutputState",pParas->m_oBinaryConfig.m_binOut[7].nState);
}
...
void stt_xml_serialize(tmt_HarmParas *pParas, CSttXmlSerializeBase *pXmlSierialize)
{
    ...
    for (int i=0; i<6; i++)
    {
		stt_xml_serialize(strName[i+6], strID[i+6], i, 1, pParas, pXmlSierialize);
    }
