#ifndef CSTTDEVICEPNS330_6_H
#define CSTTDEVICEPNS330_6_H
...
class CSttDevicePNS330_6 : public CSttDeviceComm, public CSttDeviceBase
{
private:
	explicit CSttDevicePNS330_6();
	~CSttDevicePNS330_6();
...
public:
    static void Create();
    static void Release();
	static CSttDevicePNS330_6 *g_pSttDevicePNS330_6;
...
private:
	...
	long m_nBatVoltAD;//电池电压AD值
	long m_nBatCurAD;//电池电流AD值
};

#endif // CSTTDEVICEPNS330_6_H
