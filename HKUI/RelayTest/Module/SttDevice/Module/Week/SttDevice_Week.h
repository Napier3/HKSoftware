...
void Manual_Week_PN_Main_Async(tmt_AsyncModule *pAnalogModule, char *pszDrv, int nHarm, int nIndex, BOOL bIsDc);
...
void Manual_Week_PIA48S(tmt_channel *pTmt_Volt, tmt_channel *pTmt_Current, char *pszDrv, int nHarm, int nIndex,
                        BOOL bIsDc, BOOL bIsModuleOutput);
void Manual_Week_PIA48S_Async(tmt_AsyncModule *pAnalogModule, char *pszDrv, int nHarm, int nIndex, BOOL bIsDc);
...
void Manual_Week_EVTECT(tmt_channel *pTmt_Volt, tmt_channel *pTmt_Current, char *pszDrv, int nHarm, int nIndex,
                        BOOL bIsDc, BOOL bIsModuleOutput);
void Manual_Week_EVTECT_Async(tmt_AsyncModule *pAnalogModule, char *pszDrv, int nHarm, int nIndex, BOOL bIsDc);
...
void State_Gradient_Week_EVTECT_Ex1(Drv_StateItem *oDrv_StateItem, tmt_StatePara  oTmt_paraState, int nIndex);
