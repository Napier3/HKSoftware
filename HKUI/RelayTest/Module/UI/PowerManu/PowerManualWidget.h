#ifndef POWERMANUALWIDGET_H
#define POWERMANUALWIDGET_H
...
public:
    QPowerManualWidget(QWidget *pParent);
    virtual ~QPowerManualWidget();
	void InitUI();
	void InitConnect();
...
public:
	void SetData(CSttTestResourceBase *pSttTestResource,tmt_PowerManuParas* pManualParas,CEventResult* pEvent);
	void UpdateData();
