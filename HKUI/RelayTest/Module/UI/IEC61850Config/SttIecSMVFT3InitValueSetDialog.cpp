...
QSttIecSMVFT3InitValueSetDialog::~QSttIecSMVFT3InitValueSetDialog()
{
...
void QSttIecSMVFT3InitValueSetDialog::InitUI()
{

	resize(440,440);

	//FT3发布参数设置
	setWindowTitle(g_sLangTxt_IEC_FT3PublishParameterSet);

	m_pOK_PushButton = new QPushButton(this);
	xlang_SetLangStrToWidget_Txt(m_pOK_PushButton, g_sLangTxt_OK, XLang_Ctrls_QPushButton);
	m_pOK_PushButton->setGeometry(QRect(90, 380, 111, 31));

	m_pCancel_PushButton = new QPushButton(this);
	xlang_SetLangStrToWidget_Txt(m_pCancel_PushButton, g_sLangTxt_Cancel, XLang_Ctrls_QPushButton);
...
void QSttIecSMVFT3InitValueSetDialog::SetIecSMVFT3InitiaValueFont()
{
...
void QSttIecSMVFT3InitValueSetDialog::SaveData()
{
...
void QSttIecSMVFT3InitValueSetDialog::ShowData()
{
	long nFlag;
	for(int nIndex = 0;nIndex<IECCFG_COMMON_FT3_BIT_NUM;nIndex++)
	{
...
void QSttIecSMVFT3InitValueSetDialog::slot_CancelClicked()
{
	close();
}

void QSttIecSMVFT3InitValueSetDialog::slot_OKClicked()
{
	SaveData();
	close();
}