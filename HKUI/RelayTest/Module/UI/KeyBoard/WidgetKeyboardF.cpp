...
WidgetKeyboardF::WidgetKeyboardF(QWidget *parent) : QDialog(0)
{
    int FontSize  = 20;
...
WidgetKeyboardF::~WidgetKeyboardF()
{
    delete m_pSignalMapper;
}

void WidgetKeyboardF::on_btn_clicked(int btn)
{
    QString strKeyId;
...
void WidgetKeyboardF::on_btnCaps_toggled(bool checked)
{
...
void WidgetKeyboardF::changeTextShift(bool isShift)
{
}

void WidgetKeyboardF::changeTextCaps(bool isCaps)
{    /*
    if (isCaps)
    {
...
bool WidgetKeyboardF::checkNotTextKey(int keyId)
{
...
void WidgetKeyboardF::showToEdit()
{
...
void WidgetKeyboardF::on_btnReturn_clicked(bool checked)
{
    QStackedWidget *stackedWidget = (QStackedWidget *)this->parentWidget()->parentWidget();
    stackedWidget->close();
    emit NotifySuccessF(6);
}

void WidgetKeyboardF::on_btnEsc_clicked(bool checked)
{
    QStackedWidget *stackedWidget = (QStackedWidget *)this->parentWidget()->parentWidget();
    stackedWidget->close();
}

void WidgetKeyboardF::on_btn123_clicked(bool checked)
{
    QStackedWidget *stackedWidget = (QStackedWidget *)this->parentWidget();
    stackedWidget->setCurrentIndex(2);
    emit NotifySuccessF(1);
}

void WidgetKeyboardF::on_btnFuhao_clicked(bool checked)
{
    QStackedWidget *stackedWidget = (QStackedWidget *)this->parentWidget();
...
void WidgetKeyboardF::keyPressEvent(QKeyEvent *event)
{
   switch(event->key())
   {
...
bool WidgetKeyboardF::eventFilter( QObject *obj, QEvent *event )
{
