...
public:
	...
	virtual void resizeEvent(QResizeEvent *event);//2024-09-14 zhouyangyong增加用于修改Tab1的大小和后面不一样
	void UpdateAxisScale();	//20240913 huangliang 
...
private:
	...
	QFrame *m_pFrame;//add wangtao 20240812 使m_pSingle和m_pBinBout显示上对齐
