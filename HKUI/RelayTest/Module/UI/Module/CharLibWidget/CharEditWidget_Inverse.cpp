...
{
	CCharacteristic* p = (CCharacteristic*)stt_Frame_Characteristics()->GetAtIndex_Char(0);
...
void QCharEditWidget_Inverse::slot_CIAddChar(CCharacteristic *pObj)
{
	...
	CCharacteristic* pCurrCharacteristic = (CCharacteristic*)stt_Frame_Characteristics()->GetAtIndex_Char(0);
	...
	{
		pCurrCharacteristic = (CCharacteristic*)stt_Frame_Characteristics()->GetAtIndex_Char(0);
...
void QCharEditWidget_Inverse::GroupDatasToChar(CDataGroup *pDatas)
{
	...
	//20240813 gongyiping 曲线编辑后初始化m_pCharElementInverse
	InitData();
...
void QCharEditWidget_Inverse::slot_btnUserClear(bool bState)
{
	...
	CCharTestObjects *pTestLines = pArea->GetCharTestObjects();
