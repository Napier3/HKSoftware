...
void QSmvAbnormalPointSet::init()
{
	...
	{
	case 1:
		name = /*_T("丢帧"*/g_sLangTxt_State_Dropframes; //lcq
		break;
	case 2:
		name = /*_T("飞点")*/g_sLangTxt_State_Flypoint; //lcq
		break; 
	case 3:
		name = /*_T("抖动")*/g_sLangTxt_State_Dithering;  //lcq
		break;
	case 4:
		name = /*_T("错序")*/g_sLangTxt_State_OutofOrder; //lcq
		break;
	default:
		break;
	}
