...
}void QStateEditDlg::accept()
{
	CExBaseList * pList = m_pEditGrid->GetDatas();
...
// 			pData->m_dwItemData = 1;
	...
	{
		CXMessageBox::information(NULL, g_sLangTxt_Message, g_sLangTxt_Gradient_MaintainatLeastOneState);
	}
}