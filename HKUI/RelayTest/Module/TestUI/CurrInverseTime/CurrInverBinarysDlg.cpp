...
#include "ui_CurrInverBinarysDlg.h"
#include "../Distance/DistanceCommonParasDlg.h"
#include "../../../../Module/API/GlobalConfigApi.h"
#include "../../UI/SttTestCntrFrameBase.h"
extern CFont *g_pSttGlobalFont;

QCurrInverBinarysDlg::QCurrInverBinarysDlg(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::QCurrInverBinarysDlg)
{
    ui->setupUi(this);
	m_pParas = NULL;
    m_nModify= 0;
...
QCurrInverBinarysDlg::~QCurrInverBinarysDlg()
{
    delete ui;
}

void QCurrInverBinarysDlg::InitUI()
{
	CString strPngPath;
#ifdef _PSX_QT_WINDOWS_
	strPngPath = _P_GetResourcePath();
	strPngPath = strPngPath + _T("images/CurrInverseTimeTest.png");
#else
	strPngPath = ":/ctrls/images/ActionTimeTest.png";
#endif
	this->setWindowIcon(QIcon(QPixmap(strPngPath)));

//    ui->tabWidget->setTabText(0, g_sLangTxt_Native_Bin/*QString::fromUtf8("开入量")*/);
//    ui->tabWidget->setTabText(1, g_sLangTxt_Native_Bout/*QString::fromUtf8("开出量")*/);
...
void QCurrInverBinarysDlg::InitLanuage()
{
...
void QCurrInverBinarysDlg::SetDatas(CExBaseList *pParas)
{
	if(pParas == NULL)
	return;
...
void QCurrInverBinarysDlg::CheckAllPresence(CExBaseList *pParas)
{
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID_AndOr);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID_A);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID_B);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID_C);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID_D);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID_E);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID_F);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID_G);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID_H);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID__B01);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID__B02);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID__B03);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID__B04);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID__B05);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID__B06);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID__B07);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID__B08);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID__B1);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID__B2);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID__B3);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID__B4);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID__B5);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID__B6);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID__B7);
	CheckForPresence(pParas,STT_MULTI_MACRO_CurrInverTime_PARAS_ID__B8);

}

void QCurrInverBinarysDlg::SetValueToPage(CSttMacroTestParaData *pData)
{
	if(pData->m_strID == STT_MULTI_MACRO_CurrInverTime_PARAS_ID_AndOr)
	{
...
//void QCurrInverBinarysDlg::UpdateCurrentBinarys(CExBaseList *pItem)
//{
...
BOOL QCurrInverBinarysDlg::CheckItemsModify(CExBaseList *pItem)
{
    if (pItem == NULL)
    {
        return FALSE;
...
void QCurrInverBinarysDlg::UpdataAllBinarys(CExBaseList *pAllParas)
{
...
void QCurrInverBinarysDlg::GetDatas(CExBaseList *pParas)
{
...
void QCurrInverBinarysDlg::GetPageToValue(CSttMacroTestParaData *pData)
{
	bool bvalue;
	if(pData->m_strID == STT_MULTI_MACRO_CurrInverTime_PARAS_ID_AndOr)
	{
...
void QCurrInverBinarysDlg::SetBinBoutName()
{
	//开入量
...
//确认按钮
void QCurrInverBinarysDlg::on_pushButton_clicked()
{
...
//取消按钮
void QCurrInverBinarysDlg::on_pushButton_2_clicked()
{
	reject();
}
