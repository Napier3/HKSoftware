#include "CurrInverResultEstimateDlg.h"
#include "ui_CurrInverResultEstimateDlg.h"
#include "../../UI/Module/CommonMethod/commonMethod.h"

extern CFont *g_pSttGlobalFont;

QCurrInverResultEstimateDlg::QCurrInverResultEstimateDlg(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::QCurrInverResultEstimateDlg)
{
    ui->setupUi(this);
...
QCurrInverResultEstimateDlg::~QCurrInverResultEstimateDlg()
{
    delete ui;
}

void QCurrInverResultEstimateDlg::InitUI()
{
	...
	ui->tableWidget->horizontalHeader()->setStyleSheet("QHeaderView::section { height: 40; }");
...
void QCurrInverResultEstimateDlg::SetDatas(CDataGroup *pParas)
{
...
void QCurrInverResultEstimateDlg::GetDatas(CDataGroup *pParas)
{
...
void QCurrInverResultEstimateDlg::on_lineEdit1_TextChanged()
{
...
void QCurrInverResultEstimateDlg::on_lineEdit2_TextChanged()
{
...
//确认
void QCurrInverResultEstimateDlg::on_pushButton_clicked()
{
...
//取消
void QCurrInverResultEstimateDlg::on_pushButton_2_clicked()
{
	reject();
}
