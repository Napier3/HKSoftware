...
//定义表格列使用的控件类型
#define STT_TESTGRID_COL_CTRL_TYPE_Item                                             "Item"//普通表格编辑控件
#define STT_TESTGRID_COL_CTRL_TYPE_CombBox                                          "CombBox"//下拉框控件
#define STT_TESTGRID_COL_CTRL_TYPE_RateItem                                         "RateItem"//包含系数处理的表格编辑控件
#define STT_TESTGRID_COL_CTRL_TYPE_ZSettingItem                                     "ZSettingItem"////特殊控件,界面显示实际阻抗值,数据对象中对应阻抗定值和对应系数
#define STT_TESTGRID_COL_CTRL_TYPE_ResultItem                                        "ResultItem"//显示测试结果的表格
#define STT_TESTGRID_COL_CTRL_TYPE_ImpedanceCustomItem                               "ImpedanceCustomItem"//自定义控件,即指定ID的控件
...
public:
	BSTR m_strCSttGdColDef_TextCombKey; //text-comb
	...
	BSTR m_strCtrl_TypeKey; //ctrl-type
	BSTR m_strRateKey; //rate
	BSTR m_strSetting_AttachKey; //setting-attach
	BSTR m_strIs_RltKey; //is-rlt
	BSTR m_strIdKey; //id
...
public:
	...
	static BSTR Ctrl_TypeKey()  {   return g_pXmlKeys->m_strCtrl_TypeKey;  }
	static BSTR RateKey()  {   return g_pXmlKeys->m_strRateKey;  }
	static BSTR Setting_AttachKey()  {   return g_pXmlKeys->m_strSetting_AttachKey;  }
	static BSTR Is_RltKey()  {   return g_pXmlKeys->m_strIs_RltKey;  }
