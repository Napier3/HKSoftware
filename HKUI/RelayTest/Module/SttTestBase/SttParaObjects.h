...
public:
    ...
    CSttParaObject* RegisterPara(const char *pszName,const char *pszID,const char *pszUnit,const char *pszDataTypeID,const char *pszDefaultValue, VAR_DOUBLE_LIST *val);
    CSttParaObject* RegisterPara(const char *pszName,const char *pszID,const char *pszUnit,const char *pszDataTypeID,const char *pszDefaultValue, VAR_FLOAT_LIST *val);
    CSttParaObject* RegisterPara(const char *pszName,const char *pszID,const char *pszUnit,const char *pszDataTypeID,const char *pszDefaultValue, VAR_INT_LIST *val);
	...
	////WriteXML
	void SetXmlElementName(const BSTR &strXmlName)	{	m_strXmlElementName = strXmlName;	}
