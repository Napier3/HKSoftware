...
#define STT_MACRO_CH_TYPE_IMP                                             2//zhouhj 2024.9.4
...
#define STT_MACRO_ID_FAULT_CH_Z 											"Zf"//故障阻抗
...
public:
	...
	CSttMacroChannel m_oZ_Fault;//故障阻抗值

	CSttMacroChannel m_oImpCh;//zhouhj 2024.9.4 记录当前阻抗的历史数据

// 	double m_dZImp;//wangtao 20240904 新增阻抗和阻抗角
// 	double m_dZAngle; 
