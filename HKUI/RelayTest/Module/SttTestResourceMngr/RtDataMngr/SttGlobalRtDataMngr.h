...
public:
	...
	//这个后续再考虑是否用这个标志
public:
	void InitSoftResource(CSttTestResourceBase *pTestRerouce, CExBaseList *pChMaps);//初始化软件资源
...
protected:
	void InitSoftResource_Sync(CSttTestResourceBase *pTestRerouce, CExBaseList *pChMaps);
	void InitSoftResource_Async(CSttTestResourceBase *pTestRerouce, CExBaseList *pChMaps);
};
