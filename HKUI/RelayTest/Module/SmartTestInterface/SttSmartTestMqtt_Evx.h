...
class CSttSmartTestMqtt_Evx : public CSttSmartTestMqttBase
{
	//DECLARE_DYNCREATE(CSttSmartTesMqtt)

public:
	static CSttSmartTestMqtt_Evx * CreateSmartTest()
	{
		CSttSmartTestMqtt_Evx *pBase = new CSttSmartTestMqtt_Evx();
...
public:
    CSttSmartTestMqtt_Evx();
    virtual ~CSttSmartTestMqtt_Evx();
