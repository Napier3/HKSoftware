...
long CIecCfgDatasSMV::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
	...
	xml_GetAttibuteValue(pXmlKeys->m_strCIecCfg92Version, oNode, m_nCfg92_Version);
	return 0;
}
...
long CIecCfgDatasSMV::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	...
	xml_SetAttributeValue(pXmlKeys->m_strCIecCfg92Version, oElement, m_nCfg92_Version);
	return 0;
}
...
BOOL CIecCfgDatasSMV::IsEqualOwn(CBaseObject* pObj)
{
	...
	if (m_nCfg92_Version != p->m_nCfg92_Version)
	{
		return FALSE;
	}
	return TRUE;
...
BOOL CIecCfgDatasSMV::CopyOwn(CBaseObject* pDest)
{
	...
	p->m_nCfg92_Version = m_nCfg92_Version;
	return TRUE;
}
