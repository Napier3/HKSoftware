...
#undef STDTIME_WIN_DBTIMESTAMP_DEFINED
#undef STDTIME_WIN_UDATE_DEFINED
#undef STDTIME_WIN_VARIANT_DEFINED
...
#ifdef __oledb_h__
typedef DBTIMESTAMP         STDTIME_WIN_DBTIMESTAMP;
#define STDTIME_WIN_DBTIMESTAMP_DEFINED
#endif /* __oledb_h__ */


#ifdef _OLEAUTO_H_
typedef UDATE               STDTIME_WIN_UDATE;
#define STDTIME_WIN_UDATE_DEFINED
#endif /* _OLEAUTO_H_ */


#ifdef __oaidl_h__
typedef VARIANT             STDTIME_WIN_VARIANT;
#define STDTIME_WIN_VARIANT_DEFINED
#endif /* __oaidl_h__ */


#ifdef __wtypes_h__
#define STDTIME_WIN_VT_DATE_DEFINED
typedef DATE                    STDTIME_WIN_DATE;
typedef VARTYPE                 STDTIME_WIN_VARTYPE;
#define STDTIME_WIN_VARENUM     VARENUM
#define STDTIME_WIN_VT_EMPTY    VT_EMPTY
#define STDTIME_WIN_VT_DATE     VT_DATE
#define STDTIME_WIN_VT_BYREF    VT_BYREF
#endif /* __wtypes_h__ */
...
/*****************************************************************************/
/* VARIANT structure - compatibility definition                              */
/*****************************************************************************/

/* workaround - solaris does not support anonymous unions */

#ifdef sun
#define STDTIME_U           u
#define STDTIME_UDOT        u.
#else
#define STDTIME_U
#define STDTIME_UDOT
#endif

#ifndef STDTIME_WIN_VARIANT_DEFINED

typedef struct
  {
  STDTIME_WIN_VARTYPE       vt;
  STDTIME_WIN_WORD          wReserved1;
  STDTIME_WIN_WORD          wReserved2;
  STDTIME_WIN_WORD          wReserved3;
  union
    {
    STDTIME_WIN_DATE        date;
    STDTIME_WIN_DATE *      pdate;
    } STDTIME_U;

  } STDTIME_WIN_VARIANT;

#endif /* STDTIME_WIN_VARIANT_DEFINED */


/*****************************************************************************/
/* DBTIMESTAMP structure - compatibility definition                          */
/*****************************************************************************/

#ifndef STDTIME_WIN_DBTIMESTAMP_DEFINED
...
#endif /* STDTIME_WIN_DBTIMESTAMP_DEFINED */


/*****************************************************************************/
/* UDATE structure - compatibility definition                                */
/*****************************************************************************/

#ifndef STDTIME_WIN_UDATE_DEFINED

typedef struct
  {
  STDTIME_WIN_SYSTEMTIME    st;
  STDTIME_WIN_USHORT        wDayOfYear;
  } STDTIME_WIN_UDATE;

#endif /* STDTIME_WIN_UDATE_DEFINED */
