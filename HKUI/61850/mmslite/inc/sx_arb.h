...
typedef struct 
  {
  ST_RET (*arrStart) (ST_VOID *usr, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*arrEnd)   (ST_VOID *usr, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*strStart) (ST_VOID *usr, RUNTIME_TYPE *rt, SD_CONST RUNTIME_TYPE *rt_head, ST_CHAR *databuf);
  ST_RET (*strEnd)   (ST_VOID *usr, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*int8)     (ST_VOID *usr, ST_INT8    *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*int16)    (ST_VOID *usr, ST_INT16   *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*int32)    (ST_VOID *usr, ST_INT32   *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
#ifdef INT64_SUPPORT
  ST_RET (*int64)    (ST_VOID *usr, ST_INT64   *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
#endif
  ST_RET (*uint8)    (ST_VOID *usr, ST_UINT8   *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*uint16)   (ST_VOID *usr, ST_UINT16  *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*uint32)   (ST_VOID *usr, ST_UINT32  *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
#ifdef INT64_SUPPORT
  ST_RET (*uint64)   (ST_VOID *usr, ST_UINT64  *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
#endif
  ST_RET (*flt)      (ST_VOID *usr, ST_FLOAT   *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*dbl)      (ST_VOID *usr, ST_DOUBLE  *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*oct)      (ST_VOID *usr, ST_UCHAR   *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*booln)    (ST_VOID *usr, ST_BOOLEAN *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*bcd1)     (ST_VOID *usr, ST_INT8    *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*bcd2)     (ST_VOID *usr, ST_INT16   *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*bcd4)     (ST_VOID *usr, ST_INT32   *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*bs)       (ST_VOID *usr, ST_UCHAR   *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*vis)      (ST_VOID *usr, ST_CHAR    *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*bt4)      (ST_VOID *usr, ST_INT32   *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*bt6)      (ST_VOID *usr, ST_INT32   *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*gt)       (ST_VOID *usr, time_t     *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*utc)      (ST_VOID *usr, MMS_UTC_TIME *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  ST_RET (*utf8)     (ST_VOID *usr, ST_UCHAR   *data_dest, RUNTIME_TYPE *rt, ST_CHAR *databuf);
  } SXD_ARB_DATA_CTRL_mydefine;
