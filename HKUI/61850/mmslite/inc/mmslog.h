...
/*********************** LLC Macros **************************************/
#define MLOG_LLC0(a) \
    SLOG_0 (mms_debug_sel & MMS_LOG_LLC,_mms_log_llc_logstr,a)
#define MLOG_LLC1(a,b) \
    SLOG_1 (mms_debug_sel & MMS_LOG_LLC,_mms_log_llc_logstr,a,b)
#define MLOG_LLC2(a,b,c) \
    SLOG_2 (mms_debug_sel & MMS_LOG_LLC,_mms_log_llc_logstr,a,b,c)
#define MLOG_LLC3(a,b,c,d) \
    SLOG_3 (mms_debug_sel & MMS_LOG_LLC,_mms_log_llc_logstr,a,b,c,d)
#define MLOG_LLC4(a,b,c,d,e) \
    SLOG_4 (mms_debug_sel & MMS_LOG_LLC,_mms_log_llc_logstr,a,b,c,d,e)
#define MLOG_LLC5(a,b,c,d,e,f) \
    SLOG_5 (mms_debug_sel & MMS_LOG_LLC,_mms_log_llc_logstr,a,b,c,d,e,f)
#define MLOG_LLC6(a,b,c,d,e,f,g) \
    SLOG_6 (mms_debug_sel & MMS_LOG_LLC,_mms_log_llc_logstr,a,b,c,d,e,f,g)
#define MLOG_LLC7(a,b,c,d,e,f,g,h) \
    SLOG_7 (mms_debug_sel & MMS_LOG_LLC,_mms_log_llc_logstr,a,b,c,d,e,f,g,h)
#define MLOG_LLC8(a,b,c,d,e,f,g,h,i) \
    SLOG_8 (mms_debug_sel & MMS_LOG_LLC,_mms_log_llc_logstr,a,b,c,d,e,f,g,h,i)

/* Continuation log macros    */
#define MLOG_CLLC0(a) \
    SLOGC_0 (mms_debug_sel & MMS_LOG_LLC,a)
#define MLOG_CLLC1(a,b) \
    SLOGC_1 (mms_debug_sel & MMS_LOG_LLC,a,b)
#define MLOG_CLLC2(a,b,c) \
    SLOGC_2 (mms_debug_sel & MMS_LOG_LLC,a,b,c)
#define MLOG_CLLC3(a,b,c,d) \
    SLOGC_3 (mms_debug_sel & MMS_LOG_LLC,a,b,c,d)
#define MLOG_CLLC4(a,b,c,d,e) \
    SLOGC_4 (mms_debug_sel & MMS_LOG_LLC,a,b,c,d,e)
#define MLOG_CLLC5(a,b,c,d,e,f) \
    SLOGC_5 (mms_debug_sel & MMS_LOG_LLC,a,b,c,d,e,f)
#define MLOG_CLLC6(a,b,c,d,e,f,g) \
    SLOGC_6 (mms_debug_sel & MMS_LOG_LLC,a,b,c,d,e,f,g)
#define MLOG_CLLC7(a,b,c,d,e,f,g,h) \
    SLOGC_7 (mms_debug_sel & MMS_LOG_LLC,a,b,c,d,e,f,g,h)
#define MLOG_CLLC8(a,b,c,d,e,f,g,h,i) \
    SLOGC_8 (mms_debug_sel & MMS_LOG_LLC,a,b,c,d,e,f,g,h,i)

/* Hex log macro    */
#define MLOG_LLCH(a,b) \
    SLOGH (mms_debug_sel & MMS_LOG_LLC,a,b) 
