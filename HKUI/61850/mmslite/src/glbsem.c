...
LOGCFGX_VALUE_MAP gsLogMaskMaps[] =
  {
    {"GS_LOG_ERR",	GS_LOG_ERR,	&gs_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "Error"},
    {"GS_LOG_NERR",	GS_LOG_NERR,	&gs_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "Notice"},
    {"GS_LOG_FLOW",	GS_LOG_FLOW,	&gs_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "Flow"},
  };
