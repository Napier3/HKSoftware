...
RUNTIME_CTRL *rt_ctrl;
  ...
  /* NOTE: this memset effectively sets rt_ctxt->nest_level=0		*/
  /*       and rt_ctxt->errcode=SD_SUCCESS.				*/
...
ST_VOID ms_rt_bld_finish (RUNTIME_BUILD_CTXT *rt_ctxt)
  ...
  /* Reallocate exactly the size we need.	*/
  rt_ctxt->rt_ctrl = chk_realloc (rt_ctxt->rt_ctrl, sizeof (RUNTIME_CTRL) +
                     rt_ctxt->rt_ctrl->rt_num * sizeof (RUNTIME_TYPE));
