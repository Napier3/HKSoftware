...
ST_CHAR buffered[6];
  ...
  SXLOG_CDEC2 ("SCL LOG: TrgOps='%u', OptFlds='%u'>",
		scl_rcb->TrgOps, scl_rcb->OptFlds);
  }
...
SCL_LN *scl_ln;
  ...
  SXLOG_DEC2 ("SCL LOG: <LDevice desc='%s' inst='%s' ldName='%s'>", 
  	       scl_ld->desc, scl_ld->inst,scl_ld->ldName);
