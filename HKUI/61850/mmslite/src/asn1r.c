...
LOGCFGX_VALUE_MAP asn1LogMaskMaps[] =
  {
    {"ASN1_LOG_ERR",	ASN1_LOG_ERR,	&asn1_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "Error"},
    {"ASN1_LOG_NERR",	ASN1_LOG_NERR,	&asn1_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "Notice"},
    {"ASN1_LOG_DEC",	ASN1_LOG_DEC,	&asn1_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "Decode"},
    {"ASN1_LOG_ENC",	ASN1_LOG_ENC,	&asn1_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "Encode"}
  };
