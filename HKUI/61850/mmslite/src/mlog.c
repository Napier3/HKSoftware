...
ST_VOID m_log_ureq_info (ST_INT chan, ST_INT op, ST_VOID *info)
  {
  MLOG_ALWAYS0 ("ISSUING MMS UNCONFIRMED REQUEST");
  MLOG_CALWAYS1 ("Channel = %d",chan);
...
ST_INT i;
  ...
  MLOG_ALWAYS0 ("ISSUING MMS REQUEST");
  MLOG_CALWAYS1 ("Channel = %d",req -> chan);
  MLOG_CALWAYS1 ("Context = %02x",req -> context);
  MLOG_CALWAYS1 ("Invoke ID = %lu",req -> id);
  MLOG_CALWAYS1 ("Opcode = %u",req -> op);
...
ST_INT i;
  ...
  MLOG_ALWAYS0 ("MMS INDICATION RECEIVED");
  MLOG_CALWAYS1 ("Channel = %d",ind -> chan);
  MLOG_CALWAYS1 ("Context = %02x",ind -> context);
  MLOG_CALWAYS1 ("Invoke ID = %lu",ind -> id);
  MLOG_CALWAYS1 ("Opcode = %u",ind -> op);
...
ST_VOID m_log_resp_info (MMSREQ_IND *resp, ST_VOID *info)
  {
  MLOG_ALWAYS0 ("ISSUING MMS RESPONSE");
  MLOG_CALWAYS1 ("Channel = %d",resp->chan);
  MLOG_CALWAYS1 ("Context = %02x",resp->context);
  MLOG_CALWAYS1 ("Invoke ID = %lu",resp->id);
  MLOG_CALWAYS1 ("Opcode = %u",resp->op);
  if (resp->cs.cs_pres)
    {
    MLOG_CALWAYS0 ("Companion Standard Information Present :");
...
ST_VOID m_log_conf_info (MMSREQ_PEND *conf)
  {
  MLOG_ALWAYS0 ("MMS CONFIRM RECEIVED");
  MLOG_CALWAYS1 ("Channel = %d",conf->chan);
  MLOG_CALWAYS1 ("Context = %02x",conf->context);
  MLOG_CALWAYS1 ("Invoke ID = %lu",conf->id);
  MLOG_CALWAYS1 ("Opcode = %u",conf->op);
  if (conf->cs.cs_pres)
    {
    MLOG_CALWAYS0 ("Companion Standard Information Present :");
...
ST_CHAR buf[100];
  ...
  MLOG_ALWAYS0 ("ISSUING MMS ERROR RESPONSE");
  MLOG_CALWAYS1 ("Channel = %d",resp->chan);
  MLOG_CALWAYS1 ("Context = %02x",resp->context);
  MLOG_CALWAYS1 ("Invoke ID = %lu",resp->id);
  MLOG_CALWAYS1 ("Opcode = %u",resp->op);
