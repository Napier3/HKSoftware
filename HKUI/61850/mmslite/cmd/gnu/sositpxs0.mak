...
#									 #
# To make the sositpxs0_ld executable:					 #
# 	make -f sositpxs0.mak    OPT=-g DFLAG=_ld  DEFS=-DDEBUG_SISCO	 #
#									 #
# MODIFICATION LOG :	       						 #
#  Date     Who   Rev			Comments			 #
# --------  ---  ------   -------------------------------------------	 #
# 03/08/07  JRB    01     Created from sositcps0.mak by replacing
