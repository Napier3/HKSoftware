...
#									 #
# To make the MVL_L.A:							 #
# 	make -f mvl.mak     	   DFLAG=_l   DEFS=-DDEBUG_SISCO	 #
# To make the MVL_N.A:							 #
# 	make -f mvl.mak     	   DFLAG=_n				 #
# To make the MVL_LD.A:							 #
# 	make -f mvl.mak     OPT=-g DFLAG=_ld  DEFS=-DDEBUG_SISCO	 #
# To make the MVL_ND.A:							 #
# 	make -f mvl.mak     OPT=-g DFLAG=_nd				 #
#								   	 #
# MODIFICATION LOG :	       						 #
...
# 07/25/05  JRB    05     Del unused include path ../../inc/mmsop_en.
