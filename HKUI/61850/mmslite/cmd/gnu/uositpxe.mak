...
#									 #
# To make the uositpxe_ld executable:					 #
# 	make -f uositpxe.mak    OPT=-g DFLAG=_ld  DEFS=-DDEBUG_SISCO	 #
#									 #
# MODIFICATION LOG :	       						 #
...
#DEBUG: for some reason, putting ositpxe first, avoids undefined reference to asn1r_get_objid.
LIBS = \
