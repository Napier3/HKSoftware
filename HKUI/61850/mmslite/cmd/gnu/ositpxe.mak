...
##########################################################################
#			       						 #                                
# MODULE NAME : ositpxe.mak                   			 	 #            
# PRODUCT(S)  : MMS-EASE-Lite						 #                
#			       						 #                
# MODULE DESCRIPTION :        						 #                
# This makefile is used by the Linux 'make' utility to build the MVL     #
...
# possible.  								 #
#									 #
# To make the 'ositpxe_l.a' library:					 #
# 	make -f ositpxe.mak         DFLAG=_l   DEFS=-DDEBUG_SISCO	 #
# To make the 'ositpxe_n.a' library:					 #
# 	make -f ositpxe.mak   	    DFLAG=_n				 #
# To make the 'ositpxe_ld.a' library:					 #
# 	make -f ositpxe.mak  OPT=-g DFLAG=_ld  DEFS=-DDEBUG_SISCO	 #
# To make the 'ositpxe_nd.a' library:					 #
# 	make -f ositpxe.mak  OPT=-g DFLAG=_nd				 #
#								   	 #
# MODIFICATION LOG :	       						 #
...
# 01/24/05  JRB    05     Add lean_var.c
# 08/04/04  EJV    04     Add AIX OS support.
# 12/10/03  JRB    03     Add LYNX OS support. Del "no-stack-check" option.
# 10/09/03  JRB    02     Chg like latest ositcpe.mak
# 03/21/03  CRM    01     Created.					 #
##########################################################################
...
INCDIR = ../../inc
ACSESRCDIR = ../../uca/acse
LEANTSRCDIR = ../../uca/leant
ADLCSRCDIR = ../../uca/adlc
GOOSESRCDIR = ../../uca/goose
PROJ  = ositpxe$(DFLAG)
OBJDIR = obj_$(PROJ)
LIST  = >> cc.lst 2>&1
VPATH = $(ACSESRCDIR) $(LEANTSRCDIR) $(ADLCSRCDIR) $(OBJDIR) \
	$(LIBDIR) $(INCDIR) $(GOOSESRCDIR)
 
ALL_CFLAGS = $(PLATFORM_CFLAGS) \
	$(OPT) -I$(INCDIR) \
	$(DEFS) -DMMS_LITE -DLEAN_T -DMOSI -DTP0_ENABLED -DTP4_ENABLED \
	$(CFLAGS)
...
$(OBJDIR)/clnp_thr.o : clnp_thr.c  $(INCLUDES)
...
$(OBJDIR)/tp0_read.o : tp0_read.c  $(INCLUDES)
