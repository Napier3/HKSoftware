...
#			       						 #
# To make the cositpxe_ld executable:					 #
# 	make -f cositpxe.mak    OPT=-g DFLAG=_ld  DEFS=-DDEBUG_SISCO	 #
#									 #
# MODIFICATION LOG :	       						 #
...
$(SRCDIR)/clntobj.c : clntobj.odf 
	$(FOUNDRYDIR)/foundry_ld -o -c$(ALIGNDIR)/align.cfg $(SRCDIR)/clntobj.odf $(SRCDIR)/clntobj.c $(LIST)

$(SRCDIR)/clntobj.h : clntobj.odf 
	$(FOUNDRYDIR)/foundry_ld -o -c$(ALIGNDIR)/align.cfg $(SRCDIR)/clntobj.odf $(SRCDIR)/clntobj.h $(LIST)
