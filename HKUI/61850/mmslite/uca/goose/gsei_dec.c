...
GSE_IEC_HDR *gseIecHdr = (GSE_IEC_HDR *) ac->usr_info[0];
  ...
  gseIecHdr->gcRef = ac->asn1r_field_ptr - 1;	/* set ptr	*/
  asn1r_get_vstr (ac, ac->asn1r_field_ptr - 1);	/* WARNING: modifies decode buffer*/
...
GSE_IEC_HDR *gseIecHdr = (GSE_IEC_HDR *) ac->usr_info[0];
  ...
  gseIecHdr->dataSetRef = ac->asn1r_field_ptr - 1;	/* set ptr	*/
  asn1r_get_vstr (ac, ac->asn1r_field_ptr - 1);	/* WARNING: modifies decode buffer*/
...
GSE_IEC_HDR *gseIecHdr = (GSE_IEC_HDR *) ac->usr_info[0];
  ...
  /* string forward one byte (overwriting the length field),		*/
  /* and adds NULL at the end of the string.		 		*/
  gseIecHdr->appID = ac->asn1r_field_ptr - 1;	/* set ptr	*/
  asn1r_get_vstr (ac, ac->asn1r_field_ptr - 1);	/* WARNING: modifies decode buffer*/
...
static ST_VOID decode_confRev (ASN1_DEC_CTXT *ac)
  {
GSE_IEC_HDR *gseIecHdr = (GSE_IEC_HDR *) ac->usr_info[0];
  asn1r_get_i32 (ac, &gseIecHdr->confRev);
...
GSE_IEC_HDR *gseIecHdr = (GSE_IEC_HDR *) ac->usr_info[0];
  ...
  if (ac->asn1r_indef_flag)			/* indefinite length encoding	*/
    asn1Len = ac->asn1r_field_ptr - startPtr - 2;	/* -2 strips 00 00*/
  else
    asn1Len = ac->asn1r_field_ptr - startPtr;
