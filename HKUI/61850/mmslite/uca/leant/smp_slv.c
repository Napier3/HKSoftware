...
LOGCFGX_VALUE_MAP smpLogMaskMaps[] =
  {
    {"SMP_LOG_ERR",	SMP_LOG_ERR,	&smp_debug_sel,	_LOGCFG_DATATYPE_UINT_MASK, "Error"},
    {"SMP_LOG_REQ",	SMP_LOG_REQ,	&smp_debug_sel,	_LOGCFG_DATATYPE_UINT_MASK, "Request"},
    {"SMP_LOG_IND",	SMP_LOG_IND,	&smp_debug_sel,	_LOGCFG_DATATYPE_UINT_MASK, "Indication"},
    {"SMP_LOG_DEB",	SMP_LOG_DEB,	&smp_debug_sel,	_LOGCFG_DATATYPE_UINT_MASK, "Debug"},
    {"SMP_LOG_HEX",	SMP_LOG_HEX,	&smp_debug_sel,	_LOGCFG_DATATYPE_UINT_MASK, "Hex"}
  };
...
ASN1_ENC_CTXT *aCtx = &localEncCtx;
  ...
  msg_len = enc_buf + sizeof (enc_buf) - msg_ptr;
