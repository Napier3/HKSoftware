...
LOGCFGX_VALUE_MAP adlcLogMaskMaps[] =
  {
    {"ADLC_MASK_LOG_ERR",	    ADLC_MASK_LOG_ERR,	         &adlc_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "Error"},
    {"ADLC_MASK_LOG_NERR",	    ADLC_MASK_LOG_NERR,	         &adlc_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "Notice"},
    {"ADLC_MASK_LOG_FLOW",	    ADLC_MASK_LOG_FLOW,	         &adlc_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "Flow"},
    {"ADLC_MASK_LOG_IO",	    ADLC_MASK_LOG_IO,	         &adlc_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "I/O"},
    {"ADLC_MASK_LOG_HEXIO",	    ADLC_MASK_LOG_HEXIO,   	 &adlc_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "Hex I/O"},
    {"ADLC_MASK_LOG_DEBUG",	    ADLC_MASK_LOG_DEBUG,	 &adlc_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "Debug"},
    {"ADLC_MASK_LOG_HEXDEBUG",	    ADLC_MASK_LOG_HEXDEBUG,	 &adlc_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "Hex Debug"},
    {"ADLC_MASK_LOG_SM",	    ADLC_MASK_LOG_SM,	         &adlc_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "SM"},
    {"ADLC_MASK_LOG_HEXSM",	    ADLC_MASK_LOG_HEXSM,	 &adlc_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "Hex SM"},
    {"ADLC_MASK_LOG_INFO_FRAME",    ADLC_MASK_LOG_INFO_FRAME,	 &adlc_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "Info Frame"},
    {"ADLC_MASK_LOG_HEXINFO_FRAME", ADLC_MASK_LOG_HEXINFO_FRAME, &adlc_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "Hex Info Frame"},
    {"ADLC_MASK_LOG_USER",	    ADLC_MASK_LOG_USER,	         &adlc_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "User"},
    {"ADLC_MASK_LOG_HEXUSER",	    ADLC_MASK_LOG_HEXUSER,	 &adlc_debug_sel, _LOGCFG_DATATYPE_UINT_MASK, "Hex User"}
  };
