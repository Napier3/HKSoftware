...
ST_INT32 infoRptCount;
ST_INT32 infoRptPeriod = 10;
...
#if 0
  adlcConfigure();	/* TRIM-7/REDUCED STACK (over ADLC)	*/
...
#else	/* else #if defined(HARD_CODED_CFG) */
...
/* Read configuration from a file */
  ...
  mvlCfg.max_msg_size = 8000;
  strcpy (mvlCfg.local_ar_name, "local1");
#endif	/* end #if !defined(MAP30_ACSE) */
...
/* File Logging Control defaults 					*/
  sLogCtrl->fc.fileName = "server.log";
