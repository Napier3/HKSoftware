...
{
	m_strCCharElementPointsKey = L"points"; //points
	m_strCCharElementPointKey = L"point"; //point
	m_strCCharTestObjectsKey = L"tests"; //tests
	m_strCCharTestLineKey = L"test";
	m_strCCharTestPointKey = L"point";
	...
	m_strCCharElementRXIDGKey = L"RXIDG"; //RXIDG
	m_strCCharElementRICurveKey = L"RICURVE"; //RICURVE
	m_strCCharElementLabIecCurveKey = L"LABIECCURVE"; //LABORELECCURVE
	m_strCCharElementITKey = L"IT"; //IT
	m_strCCharElementI2TExKey = L"I2TEx"; //I2TEx

    m_strCCharElementExprFuncKey = L"Expr"; //Expr
	...
	m_strFaultTypeKey = L"fault-type";
	m_strZoneTypeKey = L"zone-type";
	m_strTestStateKey = L"test-state";

    m_strMaxSensAng = L"max-sens-angle";
}
