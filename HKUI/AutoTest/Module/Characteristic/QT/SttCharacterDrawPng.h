...
public:
	...
	void InitCharDrawTest(const CString &strMacro_UI_ID, const CString &strCharID, long nIndex);
	void InitCharDrawTest_I(const CString &strMacro_UI_ID, const CString &strMacroID_Tester, long nFaultType);
};
