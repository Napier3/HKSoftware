...
//#endif
		...
		g_pGlobalCharAreaSrc->AddNewChild(new CCharElementRXIDG()); //zhangyq 20240620
		g_pGlobalCharAreaSrc->AddNewChild(new CCharElementRICurve());
		g_pGlobalCharAreaSrc->AddNewChild(new CCharElementLabIecCurve());
		g_pGlobalCharAreaSrc->AddNewChild(new CCharElementIT());
		g_pGlobalCharAreaSrc->AddNewChild(new CCharElementI2TEx());
	}
}
