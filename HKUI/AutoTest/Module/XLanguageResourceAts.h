...
//2024-10-23 wangsen
    ...
    extern CString g_sLangID_Xrio_LogInfo_UpdateTo;             //= _T("Xrio_LogInfo_UpdateTo")
    extern CString g_sLangTxt_Xrio_LogInfo_UpdateTo;            //= _T("更新为")
    extern CString g_sLangID_Xrio_LogInfo_NotSetImpVal;         //= _T("Xrio_LogInfo_NotSetImpVal")
    extern CString g_sLangTxt_Xrio_LogInfo_NotSetImpVal;        //= _T("无法设置导入的值")
    extern CString g_sLangID_Xrio_LogInfo_ErrParam;             //= _T("Xrio_LogInfo_ErrParam")
    extern CString g_sLangTxt_Xrio_LogInfo_ErrParam;            //= _T("错误参数")
