...
public:
	...
	void PrintToPdf(const CString strWordFileName, const CString strPdfFileName);
	BOOL GenRpt_Word();
...
public:
	...
	BOOL InsertText(const CString &strText, const CString &strFont=_T(""), long nBold=0, float fSize=10.5);
