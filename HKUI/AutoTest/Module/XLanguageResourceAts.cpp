...
void CXLanguageResourceAtsBase::RegisterLanguageResource()
{
    ...
    rs_AddString(g_sLangID_Xrio_LogInfo_UpdateTo, &g_sLangTxt_Xrio_LogInfo_UpdateTo);
    rs_AddString(g_sLangID_Xrio_LogInfo_NotSetImpVal, &g_sLangTxt_Xrio_LogInfo_NotSetImpVal);
    rs_AddString(g_sLangID_Xrio_LogInfo_ErrParam, &g_sLangTxt_Xrio_LogInfo_ErrParam);
}
...
void CXLanguageResourceAtsBase::InitLangTxt()
{
    ...
    g_sLangID_Expr               = _T("sExpr");
    g_sLangTxt_Expr              = _T("表达式（Expr）");
    ...
    g_sLangID_Xrio_LogInfo_UpdateTo = _T("Xrio_LogInfo_UpdateTo");
    g_sLangTxt_Xrio_LogInfo_UpdateTo = _T("更新为");
    g_sLangID_Xrio_LogInfo_NotSetImpVal = _T("Xrio_LogInfo_NotSetImpVal");
    g_sLangTxt_Xrio_LogInfo_NotSetImpVal = _T("无法设置导入的值");
    g_sLangID_Xrio_LogInfo_ErrParam = _T("Xrio_LogInfo_ErrParam");
    g_sLangTxt_Xrio_LogInfo_ErrParam = _T("错误参数");
}
...
CString g_sLangID_Xrio_LogInfo_UpdateTo;                //= _T("Xrio_LogInfo_UpdateTo")
CString g_sLangTxt_Xrio_LogInfo_UpdateTo;               //= _T("更新为")
CString g_sLangID_Xrio_LogInfo_NotSetImpVal;            //= _T("Xrio_LogInfo_NotSetImpVal")
CString g_sLangTxt_Xrio_LogInfo_NotSetImpVal;           //= _T("无法设置导入的值")
CString g_sLangID_Xrio_LogInfo_ErrParam;                //= _T("Xrio_LogInfo_ErrParam")
CString g_sLangTxt_Xrio_LogInfo_ErrParam;               //= _T("错误参数")
