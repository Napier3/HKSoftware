// RioSubstatioAddress.cpp: 实现文件
//

#include "stdafx.h"

#include "RioSubstatioAddress.h"

// CRioSubstatioAddress

CRioSubstatioAddress::CRioSubstatioAddress()
{
	//初始化属性
	m_strValue = _T("");
...
long CRioSubstatioAddress::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioSubstatioAddress::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioSubstatioAddress::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioSubstatioAddress::InitAfterRead()
{

}

BOOL CRioSubstatioAddress::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioSubstatioAddress *p = (CRioSubstatioAddress*)pObj;
...
BOOL CRioSubstatioAddress::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioSubstatioAddress *p = (CRioSubstatioAddress*)pDest;
...
CBaseObject* CRioSubstatioAddress::Clone()
{
	CRioSubstatioAddress *p = new CRioSubstatioAddress();
	Copy(p);
	return p;
}

BOOL CRioSubstatioAddress::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioSubstatioAddress::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioSubstatioAddress::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioSubstatioAddress::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
