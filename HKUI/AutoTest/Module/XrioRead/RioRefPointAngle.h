...
// CRefPointAngle
class CRioRefPointAngle : public CExBaseList
{
public:
    CRioRefPointAngle();
    virtual ~CRioRefPointAngle();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_REFPOINT_ANGLE;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::RefPointAngleKey();     }
