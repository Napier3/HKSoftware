...
long CRioVMaxLL::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioVMaxLL::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioVMaxLL::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioVMaxLL::InitAfterRead()
{

}

BOOL CRioVMaxLL::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
...
BOOL CRioVMaxLL::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
...
CBaseObject* CRioVMaxLL::Clone()
{
	CRioVMaxLL *p = new CRioVMaxLL();
	Copy(p);
	return p;
}

BOOL CRioVMaxLL::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioVMaxLL::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioVMaxLL::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioVMaxLL::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
