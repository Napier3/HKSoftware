...
// CRioCloseTime
class CRioCloseTime : public CExBaseList
{
public:
	CRioCloseTime();
	virtual ~CRioCloseTime();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_CLOSETIME;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::CloseTimeKey();     }
