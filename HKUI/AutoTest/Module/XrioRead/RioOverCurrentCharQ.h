...
// COverCurrentCharQ
class CRioOverCurrentCharQ : public CExBaseList
{
public:
    CRioOverCurrentCharQ();
    virtual ~CRioOverCurrentCharQ();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_OVERCURRENT_CHAR_Q;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::OverCurrentCharQKey();     }
