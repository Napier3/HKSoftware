...
// CRioDeviceType
class CRioDeviceType : public CExBaseList
{
public:
	CRioDeviceType();
	virtual ~CRioDeviceType();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_DEVICE_TYPE;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::DeviceTypeKey();     }
