...
long CRioTTRLValid::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioTTRLValid::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioTTRLValid::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioTTRLValid::InitAfterRead()
{

}

BOOL CRioTTRLValid::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioTTRLValid *p = (CRioTTRLValid*)pObj;
...
BOOL CRioTTRLValid::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioTTRLValid *p = (CRioTTRLValid*)pDest;
...
CBaseObject* CRioTTRLValid::Clone()
{
    CRioTTRLValid *p = new CRioTTRLValid();
	Copy(p);
	return p;
}

BOOL CRioTTRLValid::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioTTRLValid::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioTTRLValid::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioTTRLValid::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
