// TimeMultiplierNomval.cpp: 实现文件
//

#include "stdafx.h"

#include "RioTimeMultiplierNomval.h"

// CTimeMultiplierNomval

CRioTimeMultiplierNomval::CRioTimeMultiplierNomval()
{
	//初始化属性
	m_strValue = _T("");
...
long CRioTimeMultiplierNomval::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioTimeMultiplierNomval::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioTimeMultiplierNomval::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioTimeMultiplierNomval::InitAfterRead()
{

}

BOOL CRioTimeMultiplierNomval::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioTimeMultiplierNomval *p = (CRioTimeMultiplierNomval*)pObj;
...
BOOL CRioTimeMultiplierNomval::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioTimeMultiplierNomval *p = (CRioTimeMultiplierNomval*)pDest;
...
CBaseObject* CRioTimeMultiplierNomval::Clone()
{
	CRioTimeMultiplierNomval *p = new CRioTimeMultiplierNomval();
	Copy(p);
	return p;
}

BOOL CRioTimeMultiplierNomval::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioTimeMultiplierNomval::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioTimeMultiplierNomval::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioTimeMultiplierNomval::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
