...
// CGenricShape
class CRioGenricShape: public CExBaseList
{
public:
    CRioGenricShape();
    virtual ~CRioGenricShape();
        CString m_strType;
        CString m_strBlockType;
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_GENERICSHAPE;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::GenricShapeKey();     }
