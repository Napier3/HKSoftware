...
class CRioTimeMultiplierNomval : public CExBaseList
{
public:
    CRioTimeMultiplierNomval();
    virtual ~CRioTimeMultiplierNomval();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_TIMEMULTIPLIER_NOMVAL;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::NomvalKey();     }
