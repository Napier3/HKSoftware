...
// COverCurrentCharK2
class CRioOverCurrentCharK2 : public CExBaseList
{
public:
    CRioOverCurrentCharK2();
    virtual ~CRioOverCurrentCharK2();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_OVERCURRENT_CHAR_K2;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::OverCurrentCharK2Key();     }
