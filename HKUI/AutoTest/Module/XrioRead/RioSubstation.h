...
// CRioSubstation
class CRioSubstation : public CExBaseList
{
public:
	CRioSubstation();
	virtual ~CRioSubstation();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_SUBSTATION;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::SubstationKey();     }
