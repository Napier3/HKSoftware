...
// CParameterD
class CRioParameterD : public CExBaseList
{
public:
    CRioParameterD();
    virtual ~CRioParameterD();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_PARAMETERD;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::ParameterDKey();     }
