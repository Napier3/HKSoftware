...
// CRioZTOLRel
class CRioZTOLRel : public CExBaseList
{
public:
    CRioZTOLRel();
    virtual ~CRioZTOLRel();
	...
	//???????
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_ZTOLREL;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::ZTOLRelKey();     }
