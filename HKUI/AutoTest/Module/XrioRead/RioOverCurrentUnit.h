...
// COverCurrentUnit
class CRioOverCurrentUnit: public CExBaseList
{
public:
    CRioOverCurrentUnit();
    virtual ~CRioOverCurrentUnit();
        CString m_strType;
        CString m_strBlockType;
	//���غ���
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_OVERCURRENT_UNIT;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::OverCurrentUnitKey();     }
