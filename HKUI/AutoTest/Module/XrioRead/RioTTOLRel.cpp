...
long CRioTTOLRel::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioTTOLRel::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioTTOLRel::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioTTOLRel::InitAfterRead()
{

}

BOOL CRioTTOLRel::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioTTOLRel *p = (CRioTTOLRel*)pObj;
...
BOOL CRioTTOLRel::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioTTOLRel *p = (CRioTTOLRel*)pDest;
...
CBaseObject* CRioTTOLRel::Clone()
{
    CRioTTOLRel *p = new CRioTTOLRel();
	Copy(p);
	return p;
}

BOOL CRioTTOLRel::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioTTOLRel::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioTTOLRel::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioTTOLRel::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
