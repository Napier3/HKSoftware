...
CRioStandardCurveName::CRioStandardCurveName()
{
	//初始化属性
	m_strValue = _T("");
...
long CRioStandardCurveName::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioStandardCurveName::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioStandardCurveName::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioStandardCurveName::InitAfterRead()
{

}

BOOL CRioStandardCurveName::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioStandardCurveName *p = (CRioStandardCurveName*)pObj;
...
BOOL CRioStandardCurveName::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioStandardCurveName *p = (CRioStandardCurveName*)pDest;
...
CBaseObject* CRioStandardCurveName::Clone()
{
	CRioStandardCurveName *p = new CRioStandardCurveName();
	Copy(p);
	return p;
}

BOOL CRioStandardCurveName::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioStandardCurveName::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioStandardCurveName::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioStandardCurveName::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
