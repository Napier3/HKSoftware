...
long CRioZTRLValid::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioZTRLValid::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioZTRLValid::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioZTRLValid::InitAfterRead()
{

}

BOOL CRioZTRLValid::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioZTRLValid *p = (CRioZTRLValid*)pObj;
...
BOOL CRioZTRLValid::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioZTRLValid *p = (CRioZTRLValid*)pDest;
...
CBaseObject* CRioZTRLValid::Clone()
{
    CRioZTRLValid *p = new CRioZTRLValid();
	Copy(p);
	return p;
}

BOOL CRioZTRLValid::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioZTRLValid::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioZTRLValid::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioZTRLValid::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
