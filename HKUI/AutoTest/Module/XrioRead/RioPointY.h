...
// CPointY
class CRioPointY : public CExBaseList
{
public:
    CRioPointY();
    virtual ~CRioPointY();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_POINT_Y;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::PointYKey();     }
