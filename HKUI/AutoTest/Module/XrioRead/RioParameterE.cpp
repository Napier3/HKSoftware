...
long CRioParameterE::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioParameterE::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioParameterE::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioParameterE::InitAfterRead()
{

}

BOOL CRioParameterE::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioParameterE *p = (CRioParameterE*)pObj;
...
BOOL CRioParameterE::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioParameterE *p = (CRioParameterE*)pDest;
...
CBaseObject* CRioParameterE::Clone()
{
	CRioParameterE *p = new CRioParameterE();
	Copy(p);
	return p;
}

BOOL CRioParameterE::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioParameterE::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioParameterE::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioParameterE::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
