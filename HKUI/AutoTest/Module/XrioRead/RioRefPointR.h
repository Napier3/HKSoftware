...
// CRefPointR
class CRioRefPointR : public CExBaseList
{
public:
    CRioRefPointR();
    virtual ~CRioRefPointR();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_REFPOINT_R;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::RefPointRKey();     }
