...
#include "RioAutoClose.h"

// CRioAutoClose

CRioAutoClose::CRioAutoClose()
{
	//初始化属性
	m_strValue = _T("");
...
long CRioAutoClose::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioAutoClose::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioAutoClose::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioAutoClose::InitAfterRead()
{

}

BOOL CRioAutoClose::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioAutoClose *p = (CRioAutoClose*)pObj;
...
BOOL CRioAutoClose::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioAutoClose *p = (CRioAutoClose*)pDest;
...
CBaseObject* CRioAutoClose::Clone()
{
    CRioAutoClose *p = new CRioAutoClose();
	Copy(p);
	return p;
}

BOOL CRioAutoClose::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioAutoClose::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioAutoClose::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioAutoClose::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
