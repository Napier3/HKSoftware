...
// CRioTTRLValid
class CRioTTRLValid : public CExBaseList
{
public:
    CRioTTRLValid();
    virtual ~CRioTTRLValid();
	...
	//???????
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_TTRL_VALID;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::TTRLValidKey();     }
