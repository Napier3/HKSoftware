...
// CRioParameterF
class CRioParameterF : public CExBaseList
{
public:
    CRioParameterF();
    virtual ~CRioParameterF();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_PARAMETERF;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::ParameterFKey();     }
