...
// CRadius
class CRioRadius : public CExBaseList
{
public:
    CRioRadius();
    virtual ~CRioRadius();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_REFPOINT_RADIUS;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::RadiusKey();     }
