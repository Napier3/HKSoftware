...
// CRioVPrimLL
class CRioVPrimLL : public CExBaseList
{
public:
	CRioVPrimLL();
	virtual ~CRioVPrimLL();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_VPRIM_LL;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::VPrimLLKey();     }
