...
// CDiffBias
class CRioDiffBias: public CExBaseList
{
public:
    CRioDiffBias();
    virtual ~CRioDiffBias();
        CString m_strType;
        CString m_strBlockType;
	//���غ���
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_DIFFBIAS;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::DiffBiasKey();     }
