...
long CRioMhoOffset::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioMhoOffset::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioMhoOffset::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioMhoOffset::InitAfterRead()
{

}

BOOL CRioMhoOffset::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioMhoOffset *p = (CRioMhoOffset*)pObj;
...
BOOL CRioMhoOffset::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioMhoOffset *p = (CRioMhoOffset*)pDest;
...
CBaseObject* CRioMhoOffset::Clone()
{
    CRioMhoOffset *p = new CRioMhoOffset();
	Copy(p);
	return p;
}

BOOL CRioMhoOffset::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioMhoOffset::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioMhoOffset::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioMhoOffset::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
