...
long CRioTTMIValid::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioTTMIValid::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioTTMIValid::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioTTMIValid::InitAfterRead()
{

}

BOOL CRioTTMIValid::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioTTMIValid *p = (CRioTTMIValid*)pObj;
...
BOOL CRioTTMIValid::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioTTMIValid *p = (CRioTTMIValid*)pDest;
...
CBaseObject* CRioTTMIValid::Clone()
{
    CRioTTMIValid *p = new CRioTTMIValid();
	Copy(p);
	return p;
}

BOOL CRioTTMIValid::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioTTMIValid::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioTTMIValid::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioTTMIValid::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
