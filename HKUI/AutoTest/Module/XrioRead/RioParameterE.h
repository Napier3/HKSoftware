...
// CParameterE
class CRioParameterE : public CExBaseList
{
public:
    CRioParameterE();
    virtual ~CRioParameterE();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_PARAMETERE;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::ParameterEKey();     }
