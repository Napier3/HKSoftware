...
CRioOverCurrentCharK2::CRioOverCurrentCharK2()
{
	//初始化属性
	m_strValue = _T("");
...
long CRioOverCurrentCharK2::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioOverCurrentCharK2::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioOverCurrentCharK2::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioOverCurrentCharK2::InitAfterRead()
{

}

BOOL CRioOverCurrentCharK2::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioOverCurrentCharK2 *p = (CRioOverCurrentCharK2*)pObj;
...
BOOL CRioOverCurrentCharK2::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioOverCurrentCharK2 *p = (CRioOverCurrentCharK2*)pDest;
...
CBaseObject* CRioOverCurrentCharK2::Clone()
{
    CRioOverCurrentCharK2 *p = new CRioOverCurrentCharK2();
	Copy(p);
	return p;
}

BOOL CRioOverCurrentCharK2::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioOverCurrentCharK2::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioOverCurrentCharK2::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioOverCurrentCharK2::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
