...
long CRioSerialnr::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioSerialnr::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioSerialnr::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioSerialnr::InitAfterRead()
{

}

BOOL CRioSerialnr::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioSerialnr *p = (CRioSerialnr*)pObj;
...
BOOL CRioSerialnr::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioSerialnr *p = (CRioSerialnr*)pDest;
...
CBaseObject* CRioSerialnr::Clone()
{
	CRioSerialnr *p = new CRioSerialnr();
	Copy(p);
	return p;
}

BOOL CRioSerialnr::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioSerialnr::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioSerialnr::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioSerialnr::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
