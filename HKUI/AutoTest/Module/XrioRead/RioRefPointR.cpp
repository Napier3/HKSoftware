...
long CRioRefPointR::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioRefPointR::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioRefPointR::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioRefPointR::InitAfterRead()
{

}

BOOL CRioRefPointR::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioRefPointR *p = (CRioRefPointR*)pObj;
...
BOOL CRioRefPointR::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioRefPointR *p = (CRioRefPointR*)pDest;
...
CBaseObject* CRioRefPointR::Clone()
{
	CRioRefPointR *p = new CRioRefPointR();
	Copy(p);
	return p;
}

BOOL CRioRefPointR::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioRefPointR::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioRefPointR::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioRefPointR::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
