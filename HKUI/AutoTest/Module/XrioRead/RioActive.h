...
// CActive
class CRioActive : public CExBaseList
{
public:
    CRioActive();
    virtual ~CRioActive();
	...
	//���غ���
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_ACTIVE;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::ActiveKey();     }
