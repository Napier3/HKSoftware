...
long CRioTTPLValid::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioTTPLValid::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioTTPLValid::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioTTPLValid::InitAfterRead()
{

}

BOOL CRioTTPLValid::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioTTPLValid *p = (CRioTTPLValid*)pObj;
...
BOOL CRioTTPLValid::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioTTPLValid *p = (CRioTTPLValid*)pDest;
...
CBaseObject* CRioTTPLValid::Clone()
{
    CRioTTPLValid *p = new CRioTTPLValid();
	Copy(p);
	return p;
}

BOOL CRioTTPLValid::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioTTPLValid::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioTTPLValid::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioTTPLValid::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
