...
// CRefPointMag
class CRioRefPointMag : public CExBaseList
{
public:
    CRioRefPointMag();
    virtual ~CRioRefPointMag();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_REFPOINT_MAG;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::RefPointMagKey();     }
