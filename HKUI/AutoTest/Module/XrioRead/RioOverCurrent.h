...
// CRioOverCurrent
class CRioOverCurrent: public CExBaseList
{
public:
	CRioOverCurrent();
	virtual ~CRioOverCurrent();
        CString m_strType;
        CString m_strBlockType;
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_OVERCURRENT;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::OverCurrentKey();     }
