...
// CRioSerialnr
class CRioSerialnr : public CExBaseList
{
public:
	CRioSerialnr();
	virtual ~CRioSerialnr();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_SERIALNR;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::SerialnrKey();     }
