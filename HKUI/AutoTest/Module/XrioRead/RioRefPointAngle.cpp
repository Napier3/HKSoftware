...
CRioRefPointAngle::CRioRefPointAngle()
{
	//初始化属性
	m_strValue = _T("");
...
long CRioRefPointAngle::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioRefPointAngle::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioRefPointAngle::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioRefPointAngle::InitAfterRead()
{

}

BOOL CRioRefPointAngle::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioRefPointAngle *p = (CRioRefPointAngle*)pObj;
...
BOOL CRioRefPointAngle::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioRefPointAngle *p = (CRioRefPointAngle*)pDest;
...
CBaseObject* CRioRefPointAngle::Clone()
{
	CRioRefPointAngle *p = new CRioRefPointAngle();
	Copy(p);
	return p;
}

BOOL CRioRefPointAngle::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioRefPointAngle::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioRefPointAngle::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioRefPointAngle::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
