...
long CRioZTABValid::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioZTABValid::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioZTABValid::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioZTABValid::InitAfterRead()
{

}

BOOL CRioZTABValid::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioZTABValid *p = (CRioZTABValid*)pObj;
...
BOOL CRioZTABValid::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioZTABValid *p = (CRioZTABValid*)pDest;
...
CBaseObject* CRioZTABValid::Clone()
{
    CRioZTABValid *p = new CRioZTABValid();
	Copy(p);
	return p;
}

BOOL CRioZTABValid::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioZTABValid::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioZTABValid::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioZTABValid::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
