// InverseParameterCurveName.cpp: 实现文件
//
...
// CInverseParameterCurveName

CRioInverseParameterCurveName::CRioInverseParameterCurveName()
{
	//初始化属性
	m_strValue = _T("");
...
long CRioInverseParameterCurveName::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioInverseParameterCurveName::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioInverseParameterCurveName::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioInverseParameterCurveName::InitAfterRead()
{

}

BOOL CRioInverseParameterCurveName::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioInverseParameterCurveName *p = (CRioInverseParameterCurveName*)pObj;
...
BOOL CRioInverseParameterCurveName::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioInverseParameterCurveName *p = (CRioInverseParameterCurveName*)pDest;
...
CBaseObject* CRioInverseParameterCurveName::Clone()
{
    CRioInverseParameterCurveName *p = new CRioInverseParameterCurveName();
	Copy(p);
	return p;
}

BOOL CRioInverseParameterCurveName::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioInverseParameterCurveName::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioInverseParameterCurveName::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioInverseParameterCurveName::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
