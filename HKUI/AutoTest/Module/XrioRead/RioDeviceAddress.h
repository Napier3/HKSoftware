...
// CRioDeviceAddress
class CRioDeviceAddress : public CExBaseList
{
public:
	CRioDeviceAddress();
	virtual ~CRioDeviceAddress();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_DEVICE_ADDRESS;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::DeviceAddressKey();     }
