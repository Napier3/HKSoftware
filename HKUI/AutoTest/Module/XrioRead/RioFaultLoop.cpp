...
long CRioFaultLoop::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioFaultLoop::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioFaultLoop::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioFaultLoop::InitAfterRead()
{

}

BOOL CRioFaultLoop::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioFaultLoop *p = (CRioFaultLoop*)pObj;
...
BOOL CRioFaultLoop::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioFaultLoop *p = (CRioFaultLoop*)pDest;
...
CBaseObject* CRioFaultLoop::Clone()
{
    CRioFaultLoop *p = new CRioFaultLoop();
	Copy(p);
	return p;
}

BOOL CRioFaultLoop::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioFaultLoop::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioFaultLoop::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioFaultLoop::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
