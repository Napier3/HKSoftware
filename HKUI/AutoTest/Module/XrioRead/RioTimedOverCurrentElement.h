...
class CRioTimedOverCurrentElement: public CExBaseList
{
public:
    CRioTimedOverCurrentElement();
    virtual ~CRioTimedOverCurrentElement();
        CString m_strType;
        CString m_strBlockType;
        CString m_strEnabled;
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_TIMEDOVERCURRENTELEMENT;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::TimedOverCurrentElementKey();     }
