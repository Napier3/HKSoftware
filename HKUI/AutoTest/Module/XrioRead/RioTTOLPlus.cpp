...
long CRioTTOLPlus::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioTTOLPlus::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioTTOLPlus::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioTTOLPlus::InitAfterRead()
{

}

BOOL CRioTTOLPlus::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioTTOLPlus *p = (CRioTTOLPlus*)pObj;
...
BOOL CRioTTOLPlus::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioTTOLPlus *p = (CRioTTOLPlus*)pDest;
...
CBaseObject* CRioTTOLPlus::Clone()
{
    CRioTTOLPlus *p = new CRioTTOLPlus();
	Copy(p);
	return p;
}

BOOL CRioTTOLPlus::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioTTOLPlus::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioTTOLPlus::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioTTOLPlus::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
