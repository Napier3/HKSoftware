...
// CInside
class CRioInside : public CExBaseList
{
public:
    CRioInside();
    virtual ~CRioInside();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_INSIDE;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::InsideKey();     }
