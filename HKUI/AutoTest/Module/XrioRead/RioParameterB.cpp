...
long CRioParameterB::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioParameterB::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioParameterB::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioParameterB::InitAfterRead()
{

}

BOOL CRioParameterB::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioParameterB *p = (CRioParameterB*)pObj;
...
BOOL CRioParameterB::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioParameterB *p = (CRioParameterB*)pDest;
...
CBaseObject* CRioParameterB::Clone()
{
	CRioParameterB *p = new CRioParameterB();
	Copy(p);
	return p;
}

BOOL CRioParameterB::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioParameterB::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioParameterB::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioParameterB::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
