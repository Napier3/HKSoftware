...
long CRioParameterF::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioParameterF::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioParameterF::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioParameterF::InitAfterRead()
{

}

BOOL CRioParameterF::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioParameterF *p = (CRioParameterF*)pObj;
...
BOOL CRioParameterF::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioParameterF *p = (CRioParameterF*)pDest;
...
CBaseObject* CRioParameterF::Clone()
{
	CRioParameterF *p = new CRioParameterF();
	Copy(p);
	return p;
}

BOOL CRioParameterF::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioParameterF::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioParameterF::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioParameterF::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
