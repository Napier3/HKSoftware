...
// CStandardCurve
class CRioStandardCurve: public CExBaseList
{
public:
    CRioStandardCurve();
    virtual ~CRioStandardCurve();
        CString m_strType;
        CString m_strBlockType;
	CString m_strEnabled;
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_STANDARDCURVE;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::StandardCurveKey();     }
