...
// CRioININOM
class CRioININOM : public CExBaseList
{
public:
	CRioININOM();
	virtual ~CRioININOM();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_ININOM;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::ININOMKey();     }
