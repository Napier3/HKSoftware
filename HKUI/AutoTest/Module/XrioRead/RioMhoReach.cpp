...
long CRioMhoReach::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioMhoReach::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioMhoReach::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioMhoReach::InitAfterRead()
{

}

BOOL CRioMhoReach::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioMhoReach *p = (CRioMhoReach*)pObj;
...
BOOL CRioMhoReach::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioMhoReach *p = (CRioMhoReach*)pDest;
...
CBaseObject* CRioMhoReach::Clone()
{
    CRioMhoReach *p = new CRioMhoReach();
	Copy(p);
	return p;
}

BOOL CRioMhoReach::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioMhoReach::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioMhoReach::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioMhoReach::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
