// RioProtectedObjectName.cpp: 实现文件
//

#include "stdafx.h"

#include "RioProtectedObjectName.h"

// CRioProtectedObjectName

CRioProtectedObjectName::CRioProtectedObjectName()
{
	//初始化属性
	m_strValue = _T("");
...
long CRioProtectedObjectName::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioProtectedObjectName::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioProtectedObjectName::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioProtectedObjectName::InitAfterRead()
{

}

BOOL CRioProtectedObjectName::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioProtectedObjectName *p = (CRioProtectedObjectName*)pObj;
...
BOOL CRioProtectedObjectName::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioProtectedObjectName *p = (CRioProtectedObjectName*)pDest;
...
CBaseObject* CRioProtectedObjectName::Clone()
{
	CRioProtectedObjectName *p = new CRioProtectedObjectName();
	Copy(p);
	return p;
}

BOOL CRioProtectedObjectName::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioProtectedObjectName::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioProtectedObjectName::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioProtectedObjectName::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
