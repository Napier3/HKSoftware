...
// COverCurrentCharP
class CRioOverCurrentCharP : public CExBaseList
{
public:
    CRioOverCurrentCharP();
    virtual ~CRioOverCurrentCharP();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_OVERCURRENT_CHAR_P;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::OverCurrentCharPKey();     }
