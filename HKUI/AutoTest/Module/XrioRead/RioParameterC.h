...
// CParameterC
class CRioParameterC : public CExBaseList
{
public:
    CRioParameterC();
    virtual ~CRioParameterC();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_PARAMETERC;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::ParameterCKey();     }
