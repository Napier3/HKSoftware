...
CRioOverCurrentCharQ::CRioOverCurrentCharQ()
{
	//初始化属性
	m_strValue = _T("");
...
long CRioOverCurrentCharQ::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioOverCurrentCharQ::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioOverCurrentCharQ::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioOverCurrentCharQ::InitAfterRead()
{

}

BOOL CRioOverCurrentCharQ::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioOverCurrentCharQ *p = (CRioOverCurrentCharQ*)pObj;
...
BOOL CRioOverCurrentCharQ::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioOverCurrentCharQ *p = (CRioOverCurrentCharQ*)pDest;
...
CBaseObject* CRioOverCurrentCharQ::Clone()
{
	CRioOverCurrentCharQ *p = new CRioOverCurrentCharQ();
	Copy(p);
	return p;
}

BOOL CRioOverCurrentCharQ::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioOverCurrentCharQ::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioOverCurrentCharQ::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioOverCurrentCharQ::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
