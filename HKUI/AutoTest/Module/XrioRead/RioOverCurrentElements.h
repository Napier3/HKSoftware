...
class CRioOverCurrentElements: public CExBaseList
{
public:
    CRioOverCurrentElements();
    virtual ~CRioOverCurrentElements();
        CString m_strType;
        CString m_strBlockType;
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_OVERCURRENTELEMENTS;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::OverCurrentElementsKey();     }
