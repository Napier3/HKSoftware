...
// CRioTTOLPlus
class CRioTTOLPlus : public CExBaseList
{
public:
    CRioTTOLPlus();
    virtual ~CRioTTOLPlus();
	...
	//???????
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_TTOLPLUS;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::TTOLPlusKey();     }
