...
// CStandardCurveName
class CRioStandardCurveName : public CExBaseList
{
public:
    CRioStandardCurveName();
    virtual ~CRioStandardCurveName();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_STANDARDCURVE_NAME;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::StandardCurveNameKey();     }
