...
long CRioParameterA::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioParameterA::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioParameterA::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioParameterA::InitAfterRead()
{

}

BOOL CRioParameterA::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioParameterA *p = (CRioParameterA*)pObj;
...
BOOL CRioParameterA::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioParameterA *p = (CRioParameterA*)pDest;
...
CBaseObject* CRioParameterA::Clone()
{
	CRioParameterA *p = new CRioParameterA();
	Copy(p);
	return p;
}

BOOL CRioParameterA::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioParameterA::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioParameterA::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioParameterA::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
