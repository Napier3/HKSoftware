...
// CRioZTOLAbs
class CRioZTOLAbs : public CExBaseList
{
public:
    CRioZTOLAbs();
    virtual ~CRioZTOLAbs();
	...
	//???????
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_ZTOLABS;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::ZTOLAbsKey();     }
