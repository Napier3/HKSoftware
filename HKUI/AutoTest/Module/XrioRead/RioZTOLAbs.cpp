...
long CRioZTOLAbs::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioZTOLAbs::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioZTOLAbs::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioZTOLAbs::InitAfterRead()
{

}

BOOL CRioZTOLAbs::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioZTOLAbs *p = (CRioZTOLAbs*)pObj;
...
BOOL CRioZTOLAbs::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioZTOLAbs *p = (CRioZTOLAbs*)pDest;
...
CBaseObject* CRioZTOLAbs::Clone()
{
    CRioZTOLAbs *p = new CRioZTOLAbs();
	Copy(p);
	return p;
}

BOOL CRioZTOLAbs::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioZTOLAbs::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioZTOLAbs::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioZTOLAbs::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
