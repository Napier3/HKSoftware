...
// COverCurrentGroup
class CRioOverCurrentGroup: public CExBaseList
{
public:
    CRioOverCurrentGroup();
    virtual ~CRioOverCurrentGroup();
        CString m_strType;
        CString m_strBlockType;
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_OVERCURRENT_GROUP;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::OverCurrentGroupKey();     }
