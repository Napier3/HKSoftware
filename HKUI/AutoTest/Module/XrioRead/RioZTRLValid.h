...
// CRioZTRLValid
class CRioZTRLValid : public CExBaseList
{
public:
    CRioZTRLValid();
    virtual ~CRioZTRLValid();
	...
	//???????
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_ZTRL_VALID;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::ZTRLValidKey();     }
