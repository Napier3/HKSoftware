...
long CRioDeviceMode::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioDeviceMode::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioDeviceMode::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioDeviceMode::InitAfterRead()
{

}

BOOL CRioDeviceMode::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioDeviceMode *p = (CRioDeviceMode*)pObj;
...
BOOL CRioDeviceMode::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioDeviceMode *p = (CRioDeviceMode*)pDest;
...
CBaseObject* CRioDeviceMode::Clone()
{
	CRioDeviceMode *p = new CRioDeviceMode();
	Copy(p);
	return p;
}

BOOL CRioDeviceMode::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioDeviceMode::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioDeviceMode::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioDeviceMode::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
