...
// CRioTTMIValid
class CRioTTMIValid : public CExBaseList
{
public:
    CRioTTMIValid();
    virtual ~CRioTTMIValid();
	...
	//???????
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_TTMI_VALID;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::TTMIValidKey();     }
