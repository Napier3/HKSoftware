...
// CRioDistance
class CRioDistance: public CExBaseList
{
public:
	CRioDistance();
	virtual ~CRioDistance();
        CString m_strType;
        CString m_strBlockType;
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_DISTANCE;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::DistanceKey();     }
