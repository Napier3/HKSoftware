...
// CPointX
class CRioPointX : public CExBaseList
{
public:
    CRioPointX();
    virtual ~CRioPointX();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_POINT_X;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::PointXKey();     }
