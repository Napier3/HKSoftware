// RioBayAddress.cpp: 实现文件
//

#include "stdafx.h"

#include "RioBayAddress.h"

// CRioBayAddress

CRioBayAddress::CRioBayAddress()
{
	//初始化属性
	m_strValue = _T("");
...
long CRioBayAddress::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioBayAddress::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioBayAddress::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioBayAddress::InitAfterRead()
{

}

BOOL CRioBayAddress::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioBayAddress *p = (CRioBayAddress*)pObj;
...
BOOL CRioBayAddress::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioBayAddress *p = (CRioBayAddress*)pDest;
...
CBaseObject* CRioBayAddress::Clone()
{
	CRioBayAddress *p = new CRioBayAddress();
	Copy(p);
	return p;
}

BOOL CRioBayAddress::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioBayAddress::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioBayAddress::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioBayAddress::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
