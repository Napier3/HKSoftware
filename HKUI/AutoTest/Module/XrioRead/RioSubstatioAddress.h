...
class CRioSubstatioAddress : public CExBaseList
{
public:
	CRioSubstatioAddress();
	virtual ~CRioSubstatioAddress();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_SUBSTATION_ADDRESS;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::SubstationAddressKey();     }
