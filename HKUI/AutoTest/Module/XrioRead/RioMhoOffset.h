...
// CMhoOffset
class CRioMhoOffset : public CExBaseList
{
public:
    CRioMhoOffset();
    virtual ~CRioMhoOffset();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_OFFSET;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::OffsetKey();     }
