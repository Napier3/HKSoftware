...
// CRioPhases
class CRioPhases : public CExBaseList
{
public:
	CRioPhases();
	virtual ~CRioPhases();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_PHASES;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::PhasesKey();     }
