...
#include "../Characteristic/CharacteristicLib.h"
...
//过流相关
#define RIO_KEY_GROUP   _T("GROUP")
#define RIO_KEY_UNIT   _T("UNIT")
//差动相关
//#define RIO_KEY_TRIPCHAR   _T("TRIPCHAR")
#define RIO_KEY_OBJECT_TYPE  _T("OBJECT-TYPE")
//绘图元素
...
//过流相关
#define RIO_KEY_ACTIVE   _T("ACTIVE")
#define RIO_KEY_IPICKUP   _T("IPICKUP")
#define RIO_KEY_TINDEX   _T("TINDEX")
#define RIO_KEY_PREDEFCHAR   _T("PREDEFCHAR")
#define RIO_KEY_CHAR   _T("CHAR")
...
public:
    ...
    //增加特性曲线解析后适用的RIO文件解析
    BOOL ImportCharsFromRioFile(const CString &strRioFile,CDvmDevice *pDvmDevice, CCharacteristicLib *pCharacteristicLib);

protected:
    //增加特性曲线解析后适用的RIO文件解析
    void ParseGroup(CXrioGroup *pGroup, CDvmLogicDevice *pSrcLogicDevice,CCharacteristicLib *pCharacteristicLib);
    void AddDvm_Device(CXrioGroup *pGroup, CDvmDataset *pCDvmDataset);
    void AddDvm_Value(CExBaseObject *p,CDvmDataset *pCDvmDataset,const CString& strDataID);

    void InitChar_DiffBiasAttrs(CXrioData *pData, CCharacteristic *pChar, CDvmData *pCharAttrs);
    void AddChar_DiffBias_Group(CXrioGroup *pGroup, CCharacteristic *pChar);

    void InitChar_Overcurrent(CXrioGroup *pGroup, CCharacterFolder *pNewFolder);
    void AddChar_Overcurrent_Group(CXrioGroup *pGroup, CCharacterFolder *pNewFolder);
    void AddChar_Overcurrent_Unit(CXrioGroup *pGroup, CCharacteristic *pChar);
    CCharElement* AddChar_Element_Invers(CString m_sTIndex, CCharacterArea *pArea);
    CCharElement* AddChar_Element_DefTime(CString m_sTIndex, CCharacterArea *pArea);
    CCharElement* AddChar_Element_Invers(CString m_sTIndex,CXrioData *pData, CCharacterArea *pArea);
