...
// CDir
class CRioDir : public CExBaseList
{
public:
    CRioDir();
    virtual ~CRioDir();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_REFPOINT_DIR;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::DirKey();     }
