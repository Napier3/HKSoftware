...
long CRioEndAngle::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioEndAngle::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioEndAngle::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioEndAngle::InitAfterRead()
{

}

BOOL CRioEndAngle::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioEndAngle *p = (CRioEndAngle*)pObj;
...
BOOL CRioEndAngle::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioEndAngle *p = (CRioEndAngle*)pDest;
...
CBaseObject* CRioEndAngle::Clone()
{
    CRioEndAngle *p = new CRioEndAngle();
	Copy(p);
	return p;
}

BOOL CRioEndAngle::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioEndAngle::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioEndAngle::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioEndAngle::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
