...
// CRioNominalValues
class CRioNominalValues: public CExBaseList
{
public:
	CRioNominalValues();
	virtual ~CRioNominalValues();
        CString m_strType;
        CString m_strBlockType;
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_NOMINALVALUES;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::NominalValuesKey();     }
