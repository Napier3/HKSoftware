...
// CRioDeGlitchTime
class CRioDeGlitchTime : public CExBaseList
{
public:
	CRioDeGlitchTime();
	virtual ~CRioDeGlitchTime();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_DEGLITCHTIME;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::DeGlitchTimeKey();     }
