...
// CTimeMultiplier
class CRioTimeMultiplier: public CExBaseList
{
public:
    CRioTimeMultiplier();
    virtual ~CRioTimeMultiplier();
        CString m_strType;
        CString m_strBlockType;
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_TIMEMULTIPLIER;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::TimeMultiplierKey();     }
