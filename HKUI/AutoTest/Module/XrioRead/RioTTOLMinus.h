...
// CRioTTOLMinus
class CRioTTOLMinus : public CExBaseList
{
public:
    CRioTTOLMinus();
    virtual ~CRioTTOLMinus();
	...
	//???????
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_TTOLMINUS;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::TTOLMinusKey();     }
