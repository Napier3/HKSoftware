...
// CMhoReach
class CRioMhoReach : public CExBaseList
{
public:
    CRioMhoReach();
    virtual ~CRioMhoReach();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_REACH;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::ReachKey();     }
