...
// CRioDeviceMode
class CRioDeviceMode : public CExBaseList
{
public:
	CRioDeviceMode();
	virtual ~CRioDeviceMode();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_DEVICE_MODEL;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::DeviceModelKey();     }
