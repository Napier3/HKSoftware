...
long CRioZTOLRel::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioZTOLRel::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioZTOLRel::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioZTOLRel::InitAfterRead()
{

}

BOOL CRioZTOLRel::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioZTOLRel *p = (CRioZTOLRel*)pObj;
...
BOOL CRioZTOLRel::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioZTOLRel *p = (CRioZTOLRel*)pDest;
...
CBaseObject* CRioZTOLRel::Clone()
{
    CRioZTOLRel *p = new CRioZTOLRel();
	Copy(p);
	return p;
}

BOOL CRioZTOLRel::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioZTOLRel::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioZTOLRel::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioZTOLRel::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
