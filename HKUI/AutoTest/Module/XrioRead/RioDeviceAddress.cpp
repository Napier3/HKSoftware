// RioDeviceAddress.cpp: 实现文件
//

#include "stdafx.h"

#include "RioDeviceAddress.h"

// CRioDeviceAddress

CRioDeviceAddress::CRioDeviceAddress()
{
	//初始化属性
	m_strValue = _T("");
...
long CRioDeviceAddress::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioDeviceAddress::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioDeviceAddress::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioDeviceAddress::InitAfterRead()
{

}

BOOL CRioDeviceAddress::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioDeviceAddress *p = (CRioDeviceAddress*)pObj;
...
BOOL CRioDeviceAddress::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioDeviceAddress *p = (CRioDeviceAddress*)pDest;
...
CBaseObject* CRioDeviceAddress::Clone()
{
	CRioDeviceAddress *p = new CRioDeviceAddress();
	Copy(p);
	return p;
}

BOOL CRioDeviceAddress::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioDeviceAddress::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioDeviceAddress::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioDeviceAddress::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
