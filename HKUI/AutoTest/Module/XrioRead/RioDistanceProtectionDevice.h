...
class CRioDistanceProtectionDevice: public CExBaseList
{
public:
    CRioDistanceProtectionDevice();
    virtual ~CRioDistanceProtectionDevice();
        CString m_strType;
        CString m_strBlockType;
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_PROTECTIONDEVICE;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::ProtectionDeviceKey();     }
