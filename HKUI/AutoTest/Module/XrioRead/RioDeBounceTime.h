...
// CRioDeBounceTime
class CRioDeBounceTime : public CExBaseList
{
public:
	CRioDeBounceTime();
	virtual ~CRioDeBounceTime();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_DEBOUNCETIME;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::DeBounceTimeKey();     }
