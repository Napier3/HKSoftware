...
// CParameterB
class CRioParameterB : public CExBaseList
{
public:
    CRioParameterB();
    virtual ~CRioParameterB();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_PARAMETERB;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::ParameterBKey();     }
