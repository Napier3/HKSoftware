...
long CRioTTOLMinus::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioTTOLMinus::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioTTOLMinus::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioTTOLMinus::InitAfterRead()
{

}

BOOL CRioTTOLMinus::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioTTOLMinus *p = (CRioTTOLMinus*)pObj;
...
BOOL CRioTTOLMinus::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioTTOLMinus *p = (CRioTTOLMinus*)pDest;
...
CBaseObject* CRioTTOLMinus::Clone()
{
    CRioTTOLMinus *p = new CRioTTOLMinus();
	Copy(p);
	return p;
}

BOOL CRioTTOLMinus::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioTTOLMinus::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioTTOLMinus::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioTTOLMinus::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
