...
CRioRefPointMag::CRioRefPointMag()
{
	//初始化属性
	m_strValue = _T("");
...
long CRioRefPointMag::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioRefPointMag::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioRefPointMag::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioRefPointMag::InitAfterRead()
{

}

BOOL CRioRefPointMag::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioRefPointMag *p = (CRioRefPointMag*)pObj;
...
BOOL CRioRefPointMag::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioRefPointMag *p = (CRioRefPointMag*)pDest;
...
CBaseObject* CRioRefPointMag::Clone()
{
	CRioRefPointMag *p = new CRioRefPointMag();
	Copy(p);
	return p;
}

BOOL CRioRefPointMag::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioRefPointMag::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioRefPointMag::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioRefPointMag::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
