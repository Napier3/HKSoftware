...
long CRioParameterD::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioParameterD::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioParameterD::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioParameterD::InitAfterRead()
{

}

BOOL CRioParameterD::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioParameterD *p = (CRioParameterD*)pObj;
...
BOOL CRioParameterD::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioParameterD *p = (CRioParameterD*)pDest;
...
CBaseObject* CRioParameterD::Clone()
{
	CRioParameterD *p = new CRioParameterD();
	Copy(p);
	return p;
}

BOOL CRioParameterD::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioParameterD::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioParameterD::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioParameterD::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
