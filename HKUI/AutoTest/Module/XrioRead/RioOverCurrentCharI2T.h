...
// COverCurrentCharI2T
class CRioOverCurrentCharI2T: public CExBaseList
{
public:
    CRioOverCurrentCharI2T();
    virtual ~CRioOverCurrentCharI2T();
        CString m_strType;
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_OVERCURRENT_CHARI2T;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::OverCurrentCharI2TKey();     }
