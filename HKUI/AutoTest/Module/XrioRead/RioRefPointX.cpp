...
long CRioRefPointX::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioRefPointX::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioRefPointX::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioRefPointX::InitAfterRead()
{

}

BOOL CRioRefPointX::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioRefPointX *p = (CRioRefPointX*)pObj;
...
BOOL CRioRefPointX::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioRefPointX *p = (CRioRefPointX*)pDest;
...
CBaseObject* CRioRefPointX::Clone()
{
	CRioRefPointX *p = new CRioRefPointX();
	Copy(p);
	return p;
}

BOOL CRioRefPointX::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioRefPointX::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioRefPointX::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioRefPointX::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
