...
// COverCurrentCharA
class CRioOverCurrentCharA : public CExBaseList
{
public:
    CRioOverCurrentCharA();
    virtual ~CRioOverCurrentCharA();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_OVERCURRENT_CHAR_A;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::OverCurrentCharAKey();     }
