...
// CRioZTABValid
class CRioZTABValid : public CExBaseList
{
public:
    CRioZTABValid();
    virtual ~CRioZTABValid();
	...
	//???????
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_ZTAB_VALID;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::ZTABValidKey();     }
