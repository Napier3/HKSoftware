...
long CRioDeviceType::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioDeviceType::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioDeviceType::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioDeviceType::InitAfterRead()
{

}

BOOL CRioDeviceType::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioDeviceType *p = (CRioDeviceType*)pObj;
...
BOOL CRioDeviceType::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioDeviceType *p = (CRioDeviceType*)pDest;
...
CBaseObject* CRioDeviceType::Clone()
{
	CRioDeviceType *p = new CRioDeviceType();
	Copy(p);
	return p;
}

BOOL CRioDeviceType::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioDeviceType::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioDeviceType::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioDeviceType::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
