...
// CRioAdditionalINF02
class CRioAdditionalINF02 : public CExBaseList
{
public:
	CRioAdditionalINF02();
	virtual ~CRioAdditionalINF02();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_ADDITIONAL_INFO2;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::AdditionalINF02Key();     }
