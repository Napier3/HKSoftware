...
CRioOverCurrentCharA::CRioOverCurrentCharA()
{
	//初始化属性
	m_strValue = _T("");
...
long CRioOverCurrentCharA::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioOverCurrentCharA::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioOverCurrentCharA::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioOverCurrentCharA::InitAfterRead()
{

}

BOOL CRioOverCurrentCharA::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioOverCurrentCharA *p = (CRioOverCurrentCharA*)pObj;
...
BOOL CRioOverCurrentCharA::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioOverCurrentCharA *p = (CRioOverCurrentCharA*)pDest;
...
CBaseObject* CRioOverCurrentCharA::Clone()
{
    CRioOverCurrentCharA *p = new CRioOverCurrentCharA();
	Copy(p);
	return p;
}

BOOL CRioOverCurrentCharA::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioOverCurrentCharA::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioOverCurrentCharA::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioOverCurrentCharA::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
