...
CRioOverCurrentCharB::CRioOverCurrentCharB()
{
	//初始化属性
	m_strValue = _T("");
...
long CRioOverCurrentCharB::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioOverCurrentCharB::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioOverCurrentCharB::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioOverCurrentCharB::InitAfterRead()
{

}

BOOL CRioOverCurrentCharB::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
    ...
    CRioOverCurrentCharB *p = (CRioOverCurrentCharB*)pObj;
...
BOOL CRioOverCurrentCharB::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
    ...
    CRioOverCurrentCharB *p = (CRioOverCurrentCharB*)pDest;
...
CBaseObject* CRioOverCurrentCharB::Clone()
{
    CRioOverCurrentCharB *p = new CRioOverCurrentCharB();
	Copy(p);
	return p;
}

BOOL CRioOverCurrentCharB::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioOverCurrentCharB::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioOverCurrentCharB::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioOverCurrentCharB::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
