...
// CRioTripTime
class CRioTripTime : public CExBaseList
{
public:
	CRioTripTime();
	virtual ~CRioTripTime();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_TRIPTIME;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::TripTimeKey();     }
