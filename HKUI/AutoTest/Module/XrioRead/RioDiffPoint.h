...
// CDiffPoint
class CRioDiffPoint: public CExBaseList
{
public:
    CRioDiffPoint();
    virtual ~CRioDiffPoint();
        CString m_strType;
        CString m_strBlockType;
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_POINT;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::PointKey();     }
