...
// CCustomCurve
class CRioCustomCurve: public CExBaseList
{
public:
    CRioCustomCurve();
    virtual ~CRioCustomCurve();
        CString m_strType;
        CString m_strBlockType;
	CString m_strEnabled;
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_CUSTOMCURVE;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::CustomCurveKey();     }
