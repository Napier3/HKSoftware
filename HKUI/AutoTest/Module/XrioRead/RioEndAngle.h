...
// CEndAngle
class CRioEndAngle : public CExBaseList
{
public:
    CRioEndAngle();
    virtual ~CRioEndAngle();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_REFPOINT_ENDANGLE;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::EndAngleKey();     }
