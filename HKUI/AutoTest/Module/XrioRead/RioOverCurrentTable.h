...
// COverCurrentTable
class CRioOverCurrentTable: public CExBaseList
{
public:
    CRioOverCurrentTable();
    virtual ~CRioOverCurrentTable();
        CString m_strType;
        CString m_strBlockType;
        CString m_strEnabled;
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_OVERCURRENT_TABLE;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::OverCurrentTableKey();     }
