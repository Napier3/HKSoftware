...
// CParameterA
class CRioParameterA : public CExBaseList
{
public:
    CRioParameterA();
    virtual ~CRioParameterA();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_PARAMETERA;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::ParameterAKey();     }
