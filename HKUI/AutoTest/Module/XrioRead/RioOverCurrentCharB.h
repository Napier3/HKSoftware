...
// COverCurrentCharB
class CRioOverCurrentCharB : public CExBaseList
{
public:
    CRioOverCurrentCharB();
    virtual ~CRioOverCurrentCharB();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_OVERCURRENT_CHAR_B;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::OverCurrentCharBKey();     }
