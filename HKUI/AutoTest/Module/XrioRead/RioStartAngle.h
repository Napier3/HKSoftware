...
// CStartAngle
class CRioStartAngle : public CExBaseList
{
public:
    CRioStartAngle();
    virtual ~CRioStartAngle();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_REFPOINT_STARTANGLE;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::StartAngleKey();     }
