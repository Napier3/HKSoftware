...
long CRioVLNVN::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioVLNVN::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioVLNVN::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioVLNVN::InitAfterRead()
{

}

BOOL CRioVLNVN::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
...
BOOL CRioVLNVN::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
...
CBaseObject* CRioVLNVN::Clone()
{
	CRioVLNVN *p = new CRioVLNVN();
	Copy(p);
	return p;
}

BOOL CRioVLNVN::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioVLNVN::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioVLNVN::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioVLNVN::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
