...
// CRioBayAddress
class CRioBayAddress : public CExBaseList
{
public:
	CRioBayAddress();
	virtual ~CRioBayAddress();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_BAY_ADDRESS;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::BayAddressKey();     }
