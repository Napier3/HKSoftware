...
long CRioStartAngle::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioStartAngle::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioStartAngle::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioStartAngle::InitAfterRead()
{

}

BOOL CRioStartAngle::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioStartAngle *p = (CRioStartAngle*)pObj;
...
BOOL CRioStartAngle::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioStartAngle *p = (CRioStartAngle*)pDest;
...
CBaseObject* CRioStartAngle::Clone()
{
	CRioStartAngle *p = new CRioStartAngle();
	Copy(p);
	return p;
}

BOOL CRioStartAngle::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioStartAngle::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioStartAngle::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioStartAngle::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
