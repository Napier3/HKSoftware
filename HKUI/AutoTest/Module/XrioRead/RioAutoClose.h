...
// CRioAutoClose
class CRioAutoClose : public CExBaseList
{
public:
    CRioAutoClose();
    virtual ~CRioAutoClose();
	...
	//���غ���
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_AUTOCLOSE;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::AutoCloseKey();     }
