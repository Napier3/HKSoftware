...
class CRioProtectedObjectName : public CExBaseList
{
public:
	CRioProtectedObjectName();
	virtual ~CRioProtectedObjectName();
	...
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_PROTECTED_OBJECT_NAME;   }
	virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::ProtectedObjectNameKey();     }
