...
// CRioResidualFactors
class CRioResidualFactors: public CExBaseList
{
public:
	CRioResidualFactors();
	virtual ~CRioResidualFactors();
        CString m_strType;
        CString m_strBlockType;
	//÷ÿ‘ÿ∫Ø ˝
public:
	virtual UINT GetClassID() {    return XRIOCLASSID_RESIDUALFACTORS;   }
    virtual BSTR GetXmlElementKey()  {      return CXrioCfgMngrXmlRWKeys::ResidualFactorsKey();     }
