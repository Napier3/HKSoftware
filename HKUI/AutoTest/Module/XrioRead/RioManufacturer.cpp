...
CRioManufacturer::CRioManufacturer()
{
	//初始化属性
	m_strValue = _T("");
...
long CRioManufacturer::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioManufacturer::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioManufacturer::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioManufacturer::InitAfterRead()
{

}

BOOL CRioManufacturer::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioManufacturer *p = (CRioManufacturer*)pObj;
...
BOOL CRioManufacturer::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioManufacturer *p = (CRioManufacturer*)pDest;
...
CBaseObject* CRioManufacturer::Clone()
{
	CRioManufacturer *p = new CRioManufacturer();
	Copy(p);
	return p;
}

BOOL CRioManufacturer::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioManufacturer::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioManufacturer::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioManufacturer::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
