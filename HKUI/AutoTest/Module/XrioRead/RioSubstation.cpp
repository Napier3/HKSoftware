// RioSubstation.cpp: 实现文件
//

#include "stdafx.h"

#include "RioSubstation.h"

// CRioSubstation

CRioSubstation::CRioSubstation()
{
	//初始化属性
	m_strValue = _T("");
...
long CRioSubstation::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioSubstation::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioSubstation::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioSubstation::InitAfterRead()
{

}

BOOL CRioSubstation::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioSubstation *p = (CRioSubstation*)pObj;
...
BOOL CRioSubstation::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioSubstation *p = (CRioSubstation*)pDest;
...
CBaseObject* CRioSubstation::Clone()
{
	CRioSubstation *p = new CRioSubstation();
	Copy(p);
	return p;
}

BOOL CRioSubstation::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioSubstation::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioSubstation::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioSubstation::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
