...
CRioAdditionalINF02::CRioAdditionalINF02()
{
	//初始化属性
	m_strValue = _T("");
...
long CRioAdditionalINF02::XmlReadOwn(CXmlRWNodeBase &oNode, CXmlRWKeys *pXmlRWKeys)
{
...
long CRioAdditionalINF02::XmlWriteOwn(CXmlRWDocBase &oXMLDoc, CXmlRWElementBase &oElement, CXmlRWKeys *pXmlRWKeys)
{
	CXrioCfgMngrXmlRWKeys *pXmlKeys = (CXrioCfgMngrXmlRWKeys*)pXmlRWKeys;
...
long CRioAdditionalINF02::SerializeOwn(CBinarySerialBuffer &oBinaryBuffer)
{
...
void CRioAdditionalINF02::InitAfterRead()
{

}

BOOL CRioAdditionalINF02::IsEqualOwn(CBaseObject* pObj)
{
	if(this == pObj)
	{
		return TRUE;
	...
	CRioAdditionalINF02 *p = (CRioAdditionalINF02*)pObj;
...
BOOL CRioAdditionalINF02::CopyOwn(CBaseObject* pDest)
{
	if(this == pDest)
	{
		return TRUE;
	...
	CRioAdditionalINF02 *p = (CRioAdditionalINF02*)pDest;
...
CBaseObject* CRioAdditionalINF02::Clone()
{
	CRioAdditionalINF02 *p = new CRioAdditionalINF02();
	Copy(p);
	return p;
}

BOOL CRioAdditionalINF02::CanPaste(UINT nClassID)
{
...
CExBaseObject* CRioAdditionalINF02::CreateNewChild(const CString &strClassID, BOOL &bAddToTail, CXmlRWKeys *pXmlRWKeys)
{
...
CExBaseObject* CRioAdditionalINF02::CreateNewChild(long nClassID/*, BOOL &bAddToTail*/)
{
	CExBaseObject *pNew  = NULL;
...
void CRioAdditionalINF02::InsertOwnTreeCtrl(CTreeCtrl *pTreeCtrl, HTREEITEM htiParent, DWORD dwParam)
{
