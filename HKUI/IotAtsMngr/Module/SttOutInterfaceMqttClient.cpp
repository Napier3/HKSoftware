...
void CSttOutInterfaceMqttClient::OnMqttMsgRecieve(char *strTopic,char *pBuf,long nLen)
{
	CLogPrint::LogString(XLOGLEVEL_TRACE, strTopic);
	CMqttMsgInterface::OnMqttMsgRecieve(strTopic, pBuf, nLen);
}
